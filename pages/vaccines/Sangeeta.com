feed Sangeeta
  ...
  ref 'Badgujar_et_al_07_21_2020
    head = This review discuss (i) existing information (from 2003 to present) about the type of vaccine, antigen, immunogenic response, animal model, route of administration, adjuvants and current scenario for designing of coronavirus vaccine (ii) potential factors and challenges related to rapid development of COVID-19 vaccine.
  ...
  doi: https://doi.org/10.1099/vir.0.81579-0
  ref 'See_et_al_03_06_2006
    head = A whole killed (inactivated by β-propiolactone) SARS-CoV vaccine and a combination of two adenovirus-based vectors, one expressing the nucleocapsid (N) and the other expressing the spike (S) protein (collectively designated Ad S/N), were evaluated for the induction of serum neutralizing antibodies and cellular immune responses and their ability to protect against pulmonary SARS-CoV replication (to reduce viral load in the murine respiratory tract)./ for their ability to induce immunogenicity and to reduce viral load in the murine respiratory tract.
    ...
    / March, 2006 - Journal of General Virology
    quote !a = The whole killed virus (WKV) vaccine given subcutaneously to 129S6/SvEv mice was more effective than the Ad S/N vaccine administered either intranasally or intramuscularly in inhibiting SARS-CoV replication in the murine respiratory tract. This protective ability of the WKV vaccine correlated with the induction of high serum neutralizing-antibody titres, but not with cellular immune responses as measured by gamma interferon secretion by mouse splenocytes.

    / March, 2006 - Journal of General Virology
    quote !b = Our findings showed that vaccination with WKV in mice induced much higher levels of serum neutralizing antibodies than Ad S/N given intramuscularly or intranasally.

    / March, 2006 - Journal of General Virology
    quote !c = We showed that protection from SARS-CoV infection by the WKV vaccine is associated with the induction of both an IgG1 and IgG2a immune response. The addition of alum to the WKV vaccine preparation did not increase the serum virus-neutralizing activity significantly. The addition of alum, which selectively stimulates IgG1 immune responses, only increased serum SARS-CoV-specific IgG1 but not IgG2a responses.

    # / March, 2006 - Journal of General Virology
    # quote !d = The addition of alum to the WKV vaccine preparation did not increase the serum virus-neutralizing activity significantly.

    / March, 2006 - Journal of General Virology
    quote !d = Our results suggest that humoral immunity, but not cellular immune responses, correlates well with the ability of WKV to protect against pulmonary SARS-CoV replication.

    / March, 2006 - Journal of General Virology
    quote !e = Titres of serum neutralizing antibodies induced by the Ad S/N vaccine administered intranasally or intramuscularly were significantly lower than those induced by the WKV vaccine. However, Ad S/N administered intranasally, but not intramuscularly, significantly limited SARS-CoV replication in the lungs.

    # / March, 2006 - Journal of General Virology
    # quote !a = Recipients of the Ad S/N IN vaccine also demonstrated significantly reduced levels of SARS-CoV replication in the lungs, although protection was not as effective as the WKV vaccine. In contrast, the intramuscular route of the Ad S/N vaccine had only a limited effect in reducing pulmonary SARS-CoV replication, despite demonstrating high serum neutralizing-antibody titres prior to SARS-CoV challenge and the ability to induce a robust cellular immune response.

    / March, 2006 - Journal of General Virology
    quote !f = Expression of the S protein from the Ad S/N construct may be lower than that of WKV. This was evident, where sera from WKV-vaccinated mice showed a much stronger immunoreactivity towards the S protein than sera from Ad S/N-immunized animals.

    / March, 2006 - Journal of General Virology
    quote !g = Among the vaccine groups, SARS-CoV-specific IgA was found only in the sera of mice immunized intranasally with Ad S/N, suggesting that mucosal immunity may play a role in protection for the intranasal Ad S/N delivery system.

    / March, 2006 - Journal of General Virology
    quote !h = The sera of vaccinated mice contained antibodies to S, further suggesting a role for this protein in conferring protective immunity against SARS-CoV infection.

    / March, 2006 - Journal of General Virology
    quote !i = Ad S/N IM induced the highest cellular immune response among the tested vaccines, as measured by IFN-γ secretion by splenocytes of vaccinated mice following in vitro stimulation with recombinant N protein. The number of IFN-γ-secreting splenocytes in Ad S/N IM-immunized mice was significantly higher (1·5–2·5-fold) than those of mice vaccinated with Ad S/N IN, WKV alone or WKV plus alum.


    / March, 2006 - Journal of General Virology
    quote !j = In our study, the two intramuscular injections of the Ad S/N vaccine produced a strong SARS-CoV-specific IgG1 and IgG2a antibody response in mice, with IgG2a titres significantly higher than IgG1. The serum neutralizing-antibody levels in Ad S/N IN-vaccinated mice were lower than in animals immunized with Ad S/N IM. This result suggests that other factors, such as mucosal immunity (e.g. secretory IgA and/or mucosal T cells), may play an important role in limiting lung virus replication by the Ad S/N IN vaccine.

    / March, 2006 - Journal of General Virology
    quote !k = The detection of serum SARS-CoV-specific IgA in mice vaccinated with Ad S/N IN, but not with Ad S/N IM or Ad-Ctrl, suggests that mucosal SARS-CoV-specific IgA does play an important role in conferring protection against SARS-CoV pulmonary replication. Moreover, the IFN-γ-secreting response observed in splenocytes of Ad S/N IN-vaccinated mice was more than twofold lower than that found in mice immunized with Ad S/N IM, indicating that cellular immune responses do not contribute to protection against SARS-CoV challenge as strongly as an antibody response. Our result points to a potential approach whereby SARS-CoV infection could potentially be blocked at the primary site of entry (e.g. respiratory tract) by using an intranasal adenovirus-based vaccine.

    / March, 2006 - Journal of General Virology
    quote !l = Unlike the Ad S/N vaccine, which contains only genes that encode the N and S proteins, the WKV vaccine contains the complete complement of viral proteins present in the natural virion conformation and thus may induce a broader immune response.

    / March, 2006 - Journal of General Virology
    quote !m = In our study, total serum SARS-CoV-specific IgG and neutralizing-antibody levels were not enhanced by the addition of alum to the WKV vaccine preparation and protection from virus replication was not improved discernibly. In contrast, the immunoreactivity of pooled mouse sera towards both the full-length N protein and the S protein fragment was enhanced when the WKV vaccine formulation contained alum.

    / March, 2006 - Journal of General Virology
    quote !n = These results suggest that the inclusion of alum in the WKV vaccine may lead to enhanced production of antibody to denatured protein. Interestingly, the S protein domain (aa 318–510) recognized by the sera of WKV-vaccinated mice in our studies is known to bind to the SARS-CoV functional receptor, ACE2. Antibodies present against this S domain may explain why sera from our WKV-vaccinated mice were able to block SARS-CoV-mediated CPE in Vero E6 cells.
  ...
  ref 'Zhang_et_al_01_21_2005
    ...
    / January, 2005 - Vaccine
    quote !a = The strong neutralizing capacity exhibited in micro-cytopathic effect neutralization tests indicated the specific antibodies are protective.

    / January, 2005 - Vaccine
    quote !b = Titers of specific IgG antibodies in three test groups all peaked in the sixth week after first vaccination, but significant differences existed in the kinetics of specific IgG antibody levels.

    / January, 2005 - Vaccine
    quote !c = Western blot assay further demonstrated the specificity of the induced serum antibodies.



  #
  // Intranasal immunization with inactivated SARS-CoV (SARS-associated coronavirus) induced local and serum antibodies in mice
  doi: https://doi.org/10.1016/j.vaccine.2004.07.031
  ref 'Qu_et_al_08_27_2004
    head = SARS-CoV (severe acute respiratory syndrome-associated coronavirus) strain GZ50 was partially purified and inactivated with 1:2000 formaldehyde. Inactivated GZ50 was used to immunize mice intranasally either alone, or after precipitation with polyethylene glycol (PEG), or with CpG, or CTB as an adjuvant.


    > Abstract
      SARS-CoV (severe acute respiratory syndrome-associated coronavirus) strain GZ50 was partially purified and inactivated with 1:2000 formaldehyde. In cell culture the inactivated virus blocked the replication of live virus by decreasing the TCID 5.0 of the live virus 103.6 to 104.6 times. Inactivated GZ50 was used to immunize mice intranasally either alone, or after precipitation with polyethylene glycol (PEG), or with CpG, or CTB as an adjuvant. The titer of serum neutralizing antibodies was up to 1:640. In mice immunized with adjuvants or PEG precipitated GZ50, specific IgA was detected in tracheal-lung wash fluid by immunofluorescence. Though serum antibodies were detected, no anti-SARS-IgA could be detected in mice immunized only with inactivated GZ50. The roles of adjuvants in intranasal immunization with inactivated. SARS-CoV is discussed.
    ...
    / August, 2004 - Vaccine
    quote !a = In cell culture the inactivated virus blocked the replication of live virus by decreasing the TCID5.0 of the live virus 103.6 to 104.6 times.

    / August, 2004 - Vaccine
    quote !b = The titer of serum neutralizing antibodies was up to 1:640.

    / August, 2004 - Vaccine
    quote !c = In mice immunized with adjuvants or PEG precipitated GZ50, specific IgA was detected in tracheal-lung wash fluid by immunofluorescence.

    # / August, 2004 - Vaccine
    # quote !a = Though serum antibodies were detected, no anti-SARS-IgA could be detected in mice immunized only with inactivated GZ50.

    / August, 2004 - Vaccine
    quote !d = After four intranasal doses of the inactivated virus, serum anti-SARS-CoV neutralizing antibodies were detected, but no anti-SARS IgA was found in the tracheal-lung wash fluid.

    / August, 2004 - Vaccine
    quote !e = When the inactivated virus was co-administered intranasally with adjuvant (either CPG or CTB), both serum anti-SARSCoV neutralizing antibodies and specific IgA in tracheal-lung wash fluid were detected. These results indicate that local IgA antibodies could only be induced by combining the inactivated virus and adjuvant.

    / August, 2004 - Vaccine
    quote !f = In mice immunized subcutaneously, with inactivated virus, aside from high titer of serum neutralizing antibodies, specific anti-SARS-IgG also could be detected in tracheal lung wash fluid. However, no anti-SARS-IgA was detected, which indicated that the antibodies detected in the tracheal lung fluid was not produced locally, but derived from serum antibodies.

    / August, 2004 - Vaccine
    quote !g = Given that CTB was reported more or less toxic in hosts, only modified CTB shown to be nontoxic to humans could be expected to be approved for human use in the future. CpG-ODN is non-toxic and induces effective humoral and cellular immune responses in hosts. It is thus a promising adjuvant to be used with SARS-CoV for intranasal immunization.

    / August, 2004 - Vaccine
    quote !h = Compared to the dosage being used with CPG. As the adjuvant, only half the dosage of inactivated virus was necessary to induce both local and serum specific antibodies by using PEG precipitate as the adjuvant. This precipitated inactivated virus is therefore also a good candidate for development of intranasal SARS-CoV inactivated vaccine.



  #
  // Inactivated SARS-CoV Vaccine Prepared from Whole Virus Induces a High Level of Neutralizing Antibodies in BALB/c Mice
  doi: http://doi.org/10.1089/104454904323145272
  ref 'Tang_et_al_07_06_2004
    head = We tested the ability of inactivated SARS-CoV vaccine to induce neutralizing antibodies in BALB/c mice. The inactivated vaccine was prepared by SARS-CoV virus propagation in Vero cells, with subsequent β-propiolactone inactivation and Sepharose 4FF column chromatography purification. One hundred forty BALB/c female mice were divided into seven groups of 20 mice each.
    ...
    / July, 2004 - DNA and Cell Biology
    quote !a = The results can be summarized as follows: (1) higher dosages of vaccine induced higher levels of neutralizing antibody titer; (2) the level of neutralizing antibodies induced by the inoculation with aluminum hydroxide adjuvant was slightly higher than that without adjuvant, but the difference was not statistically significant.
  ...
  doi: https://doi.org/10.1016/j.bbrc.2004.10.052
  ref 'He_et_al_10_28_2004
    head = We demonstrated that SARS-CoV inactivated by β-propiolactone elicited high titers of antibodies in the immunized mice and rabbits that recognize the spike (S) protein, especially the receptor-binding domain (RBD) in the S1 region.
    ...
    quote !a = With a sensitive and quantitative single-cycle infection assay using pseudovirus bearing the SARS-CoV S protein, we demonstrated that mouse and rabbit antisera significantly inhibited S protein-mediated virus entry with mean 50% inhibitory titers of 1:7393 and 1:2060, respectively.

    / October, 2004 - Biochemical and Biophysical Research Communications
    quote !b = The antisera from the immunized animals efficiently bound to the RBD and blocked binding of RBD to angiotensin-converting enzyme 2, the functional receptor on the susceptible cells for SARS-CoV.

    / October, 2004 - Biochemical and Biophysical Research Communications
    quote !c = These data suggest that the RBD of S protein is a major neutralization determinant in the inactivated SARS vaccine which can induce potent neutralizing antibodies to block SARS-CoV entry.

    / October, 2004 - Biochemical and Biophysical Research Communications
    quote !d = Caution should be taken in using the inactivated SARS-CoV as a vaccine since it may also cause harmful immune and/or inflammatory responses.
  ...
  doi: https://doi.org/xyz
  ref 'Xiong_et_al_08_01_2004
    head = To create a novel trial vaccine and evaluate its potency, we attempted to generate a SARS inactivated vaccine using SARS coronavirus (SARS-CoV) strain F69 treated with formaldehyde and mixed with Al(OH)3. Three doses of the vaccine were used to challenge three groups of BALB/c mice.
    ...
    / August, 2004 - Immunology Letters
    quote !a = The findings suggest that the inactivated SARS-CoV could preserve its antigenicity and the inactivated vaccine can stimulate mice to produce high levels of antibodies with neutralization activity. Results also suggest that polypeptides originating from protein N or S might be a potential target/ subunit for the generation of a recombinant SARS vaccine.

    / August, 2004 - Immunology Letters
    quote !b = In comparison with convalescent SARS patients, the Ab levels and neutralization activity of immunized mice were about 10 times higher. The curve of IgG Ab in mice indicates that the specific Abs remained at a high level for a long period. These results confirmed the feasibility and efficacy of SARS inactivated vaccine.

    / August, 2004 - Immunology Letters
    quote !c = We also performed the similar experiments using other species such as rats, rabbits, horses and monkeys which also confirmed the effect of this vaccine

    / August, 2004 - Immunology Letters
    quote !d = Neutralization assay demonstrated that the antisera could protect Vero-E6 cells from SARS-CoV's infection.

    / August, 2004 - Immunology Letters
    quote !e = Analysis of the antibody specificity revealed that the mouse antisera contained a mixture of antibodies specifically against the structure proteins of SARS-CoV.

    / August, 2004 - Immunology Letters
    quote !f = The mouse antisera conferred higher amount of antibodies against protein N, polypeptide S4 and S2 than those of proteins M and 3CL.

    / August, 2004 - Immunology Letters
    quote !g =  We found that the mice exhibited specific IgM on day 4 and IgG on day 8. The peak titers of IgG were at day 47 in low-dose group (1:19,200) and high-dose group (1:38,400) whereas in middle-dose group (1:19,200), the peak was at day 40. On day 63, the IgG levels reached a plateau.

    / August, 2004 - Immunology Letters
    quote !h =  We also observed that there were no significant changes of CD4, CD8 subset of T lymphocyte in vaccine-challenged mice.


  #
  // SARS vaccines: where are we?
  doi: https://doi.org/10.1586/erv.09.43
  ref 'Roper_et_al_01_09_2014
    head = In this review, the current state of vaccine development against human severe acute respiratory syndrome (SARS) coronavirus, focusing on recently published data is assessed. We discuss which strategies have been assessed immunologically and which have been evaluated in SARS coronavirus challenge models. We discuss inactivated vaccines, virally and bacterially vectored vaccines, recombinant protein and DNA vaccines, as well as the use of attenuated vaccines.
    ...
    quote !a = Immunogenicity has been widely demonstrated, but identification of correlates of protection, and generation of immune responses that protect from clinical signs and lung damage remain elusive.

    # / January, 2014 - Expert Review of Vaccines
    # quote !a = Results suggest that a protective SARS vaccine should be possible; however, protection in mammals that are susceptible to severe disease (e.g., ferrets and humans) may be more difficult than the mouse models suggest.
    #
    # / January, 2014 - Expert Review of Vaccines
    # quote !a = While there is much evidence that various vaccine strategies (Inactivated virus, viral vector, bacterial vector, subunit and DNA vaccines)against SARS are safe and immunogenic, vaccinated animals still display significant disease upon challenge.
    # These data provide a cautionary note about SARS rodent models, and indicate that the induction of strong neutralizing antibodies does not equate with protective efficacy in a relevant animal model where clinical signs are apparent and significant lung damage is seen.
    #
    # / January, 2014 - Expert Review of Vaccines
    # quote !b = Current data suggest that intranasal vaccination may be crucial and that new or combination strategies (Combinations of heterologous vaccines in prime–boost regimens or attenuated SARS-CoV vaccines) may be required for good protective efficacy against SARS in humans.
    #
    # / January, 2014 - Expert Review of Vaccines
    # quote !b = Given the incomplete protection of current vaccines, it seems unwise to discount T-cell responses, which have not been adequately evaluated, or the protection that might be afforded by the inclusion of additional viral proteins (especially those displayed on the virion and on the surface of infected cells) in SARS-CoV vaccine development.
    #
    #
    # / January, 2014 - Expert Review of Vaccines
    # quote !a = The accumulated data indicate that WKV vaccines are safe and they induce SARS-CoV neutralizing antibodies and can even activate T lymphocytes; however, compelling evidence of protective efficacy is scant or absent.
    #
    # / January, 2014 - Expert Review of Vaccines
    # quote !a = These data provide a cautionary note about SARS rodent models, and indicate that the induction of strong neutralizing antibodies does not equate with protective efficacy in a relevant animal model where clinical signs are apparent and significant lung damage is seen. The ability of an antibody to neutralize virus infection is the easiest activity to measure, but it is not the only important function of antibody in antiviral defense. An important lesson may be drawn from the field of poxvirology where one of the most protective antigens (A33R) generates protective antibodies that are not neutralizing
    #
    #
    # / January, 2014 - Expert Review of Vaccines
    # quote !a = Several reports have indicated that intranasal vaccination may provide superior protection compared to other routes. A protollin-formulated SARS S protein delivered intranasally protected mice from SARS-CoV replication in the lung better than the same vaccine delivered intramuscularly, despite comparable serum levels of neutralizing anti-SARS IgG
    #
    #
    # / January, 2014 - Expert Review of Vaccines
    # quote !a = Intranasal administration increases protection, despite greatly reduced serum antibody responses. These data underscore the importance of mucosal immunity.
    #
    #
    # / January, 2014 - Expert Review of Vaccines
    # quote !a =
