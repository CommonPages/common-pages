...
revision feed Revisions
  ...
  revision July_07
    ...
    # One study showed that India’s Covid-19 mortality rate is above that of Brazil or the USA. Only one out 7 Covid-19 deaths appear to be registered in India.
    -
  ...
  revision July_06
    ...
    # Delta variant may possess immune evasion in patients that received the Pfizer BNT162b2, Moderna mRNA-1273, and Covaxin BBV152.
    -
      Variants.B1617.!Weddingdelta

    # SARS-CoV-2 variants (B.1.1.7, B.1.351, P.1, and CAL.20C lineages) do not majorly disrupt the total SARS-CoV-2 T cell reactivity
    -
  ...
  revision July_03
    ...
    # Patients with severe COVID-19 receiving organ support, tocilizumab and sarilumab are similarly effective at improving survival and reducing duration of organ support.
    -
