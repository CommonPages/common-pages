feed Sangeeta
  ...
  ref 'Silverstein_et_al_02_13_2020
    head = A 56-year-old man presented to our Emergency Department in Toronto, ON, Canada, with fever and non-productive cough, 1 day after returning from a 3-month visit to Wuhan, China. We believe this is the first confirmed case of 2019-nCoV in Canada. This case highlights the milder spectrum of pneumonia caused by 2019-nCoV.
    ...
    quote !a = The presentation with fever, cough, and bilateral pneumonia is typical of most cases described so far.

    / February, 2020 - The Lancet
    quote !b = Only a minority of previously reported cases had thrombocytopenia—and this was a worrying feature in our patient. Yet despite significant radiographic abnormalities, our patient remained well and did not require intubation or supplemental oxygen—unlike many cases with similar x-ray findings reported so far.

    / February, 2020 - The Lancet
    quote !c = It suggests that the identification of individuals—like our patient—who could be managed by being isolated at home, rather than in hospital, might be an important strategy for containing this outbreak.
  ...
  ref 'Hertzberg_et_al_2016
    ...
    quote !a = There is a ∼ 6% risk to passengers seated within the 2-rows of infected individual(s) and there is ∼ 2% risk to passengers seated beyond 2-rows from the infectious individual.

    / 2016 - Annals of Global Health
    quote !b = Infection at a distance from the index case indicates other factors, such as airflow, movement of passenger/crew members, fomites and contacts between passengers in the departure gate before boarding, or after deplaning, are involved.

    / 2016 - Annals of Global Health
    quote !c = These inflight transmissions highlight how air travel serves as a conduit for rapid spread of newly emerging infections with potential to start pandemics, and how there must be 1 or more other factors affecting transmission other than seating.

    / 2016 - Annals of Global Health
    quote !d = Contact tracing limited to passengers within 2 rows of the infectious individual may lead to failure to determine other cases, which may have important, potentially dire consequences for spread of infectious diseases. We speculate that infection at a distance from the index case is due to factors such as cabin airflow and movements of passengers and flight attendants. Public health officers investigating suspected disease transmission on an airplane should prioritize passengers seated within 2 rows of the index case for surveillance but should not neglect other passengers for follow-up.
  ...
  ref 'Speake_et_al_2020
    head = This study documents transmission of SARS-CoV-2 associated with a medium-duration domestic flight within Australia. It also demonstrates the value of WGS for determining SARS-CoV-2 transmission.
    ...
    / December, 2020 - Emerg Infect Dis.
    quote !d = We report several other findings. First, 3 of the 11 persons with secondary infections were outside the usual parameters used to identify close contacts of an infectious passenger on an airplane (2 rows in front and behind). On the flight described, passengers with flight-associated infection spanned 9 rows and were on opposite sides of the airplane. Discussion with airline representatives indicated that no air handling maintenance issues were logged for this flight and no illnesses were reported among the crew. The spatial distribution of secondary cases on this flight suggests that the current public health practice for contact tracing of passengers exposed to SARS-CoV-2 while aboard aircraft may benefit from additional study.
    ...
    / December, 2020 - Emerg Infect Dis.
    quote !h = We cannot exclude the possibility that the 3 passengers with possibly flight-associated infection might have been exposed before or after their journey; however, the very low levels of community transmission in Australia at the time, combined with the known proximity of these travelers to infectious persons on the airplane, suggest that this possibility is unlikely.

    / December, 2020 - Emerg Infect Dis.
    quote !i = We cannot rule out the possibility that the 7 passengers with primary cases who had disembarked from a cruise ship with known SARS-CoV-2 illnesses on board but in whom symptoms developed >48 hours after the flight acquired their infection aboard the airplane; however, given the balance of probabilities, it is more likely that they acquired their infections on the ship.

    / December, 2020 - Emerg Infect Dis.
    quote !j = Lack of detailed information for all passenger movements within the airport, at the boarding gate, and aboard the aircraft also limits our ability to determine with specificity where flight-associated exposures occurred. However, the spatial clustering of all secondary cases within the mid cabin suggests that transmission most likely occurred aboard the airplane. If persons had been exposed principally at the airport, one might expect the 11 secondary cases to have been distributed beyond the mid cabin.On this flight, all passengers were invited to board at the same time, rather than by rows.

    / December, 2020 - Emerg Infect Dis.
    quote !k = Categorizing cases as primary or secondary was predicated on the passenger’s self-reported date of symptom onset, which may have been subject to recall errors.

    / December, 2020 - Emerg Infect Dis.
    quote !l = Case ascertainment bias is possible because although all passengers were informed of their potential exposure, passengers who had disembarked from a cruise ship that subsequently had a widely publicized outbreak or the close contacts of a primary case who were actively monitored for 14 days may have been more likely to seek testing if they became ill.

    / December, 2020 - Emerg Infect Dis.
    quote !m = We cannot be certain that we captured all SARS-CoV-2 infections among persons who traveled on this flight because PCR testing was limited to passengers who reported symptoms and testing is not 100% sensitive

    / December, 2020 - Emerg Infect Dis.
    quote !n = Given that flight-associated transmission of SARS-CoV-2 from asymptomatic persons has been reported, it is possible that some persons with secondary infections were exposed to passengers other than the infectious cases we identified on the flight; thus, our findings on the spatial distribution of primary and secondary cases should be interpreted with caution. Attempts to identify additional primary and secondary cases by using SARS-CoV-2 serologic testing are ongoing.
  ...
  ref 'Choi_et_al_09_18_2020
    ...
    / September, 2020 - Emerg Infect Dis.
    quote !c = The near full-length viral genomes from all 4 patients were 100% identical and phylogenetically grouped to clade G.

    / September, 2020 - Emerg Infect Dis.
    quote !d = Passengers and cabin crew do not generally go through the same check-in process at airports before boarding. Although we cannot completely rule out the possibility that patients C and D were infected before boarding, the unique virus sequence and 100% identity across the whole virus genome from the 4 patients makes this scenario highly unlikely.

    / September, 2020 - Emerg Infect Dis.
    quote !e = We were unable to quantify the virus attack rate on this flight because not all passengers were tested.
  ...
  ref 'Munnink_et_al_09_01_2020
    ...
    / September, 2020 - bioRxiv
    quote !a = No specific mutations were found in all mink samples, making increased virulence less likely.

    / September, 2020 - bioRxiv
    quote !b = After the detection of SARS-CoV-2 on mink farms, 68% of the tested farm workers and/or relatives or contacts were shown to be infected with SARS CoV-2, indicating that contact with SARS-CoV-2 infected mink is a risk factor for contracting COVID-19.

    / September, 2020 - bioRxiv
    quote !c = Mutation (D614G) was present in farm clusters A, C and E, but no obvious differences in clinical presentation, disease severity, or rate of transmission to humans was observed.
  ...
  ref 'Nissen_et_al_11_11_2020
    head = We investigated ventilation openings in one COVID-19 ward and central ducts that expel indoor air from three COVID-19 wards. We present evidence for SARS-CoV-2 ability to disperse from patients to ward vent openings as well as detection of viral RNA in ventilation exhaust filters located at least 50 m from patient room vent openings.
  ...
  doi: https://doi.org/10.1172/jci.insight.142386
  ref 'McAndrews_et_al_08_14_2020
    head = Our study demonstrates ELISA-based detection of antibodies for S-RBD and N-protein in the serum of patients infected with SARS-CoV-2. Our findings, obtained from the analysis of 138 serial serum samples from 30 SARS-CoV-2 RT-PCR–positive patients with severe disease, and 464 control serum samples collected between June 2017 and June 2020, show that detection of N-protein–binding antibodies does not always correlate with presence of S-RBD–neutralizing antibodies or possessing neutralizing capacity and caution against the extensive use of N-protein–based serology testing for determination of potential COVID-19 immunity.
    ...
    quote !a = The neutralizing capacity was higher in patients with antibodies against the S1-RBD compared to N protein.

    / August, 2020 - JCI Insight
    quote !b = The rate of healthy individuals positive for antibodies against the N protein was higher compared with the S1-RBD (3% versus 1%). Overall, this indicates that antibodies against the N protein portrays prior exposure to the SARS-CoV-2 or related viruses, and not necessarily is an indicator of presence of neutralizing antibodies.



  # 11/23 relapse
  // Assessment of SARS-CoV-2 RNA Test Results Among Patients Who Recovered From COVID-19 With Prior Negative Results
  doi: https://doi.org/10.1001/jamainternmed.2020.7570
  ref 'Liotti_et_al_11_12_2020
    head = Out of the 176 recovered patients with COVID-19, 18% of patients in our institution (Rome, Italy) became RT-PCR positive for SARS-CoV-2 RNA after clinical recovery and previous negative results. This study highlights that many patients who recovered from COVID-19 may be still positive (albeit at lower levels) for SARS-CoV-2 RNA, but only a minority of the patients may carry a replicating SARS-CoV-2 in the respiratory tract.


    / November, 2020 - JAMA Intern Med.
    quote !a =
  ...
  doi: http://dx.doi.org/10.15585/mmwr.mm6933a3
  ref 'Hagan_et_al_08_21_2020
    head = Mass testing in 16 U.S. prisons and jails found SARS-CoV-2 prevalence ranging from 0%–86.8%, a median 12.1-fold increase over the number of cases identified by earlier symptom-based testing alone. Median prevalence was three times higher in dormitory-based than in cell-based housing.

    / August, 2020 - MMWR Morb Mortal Wkly
    quote !a =
  ...
  doi: https://doi.org/10.21203/rs.3.rs-63027/v1
  ref 'Voeten_et_al_02_20_2020
    head = An outbreak of COVID-19 in a nursing home in the Netherlands, following an on-site church service held on March 8, 2020, triggered an investigation to unravel sources and chain(s) of transmission.

    > Background
      An outbreak of COVID-19 in a nursing home in the Netherlands, following an on-site church service held on March 8, 2020, triggered an investigation to unravel sources and chain(s) of transmission.

    > Methods
      Epidemiological data were collected from registries and through a questionnaire among church visitors. Symptomatic residents and healthcare workers (HCWs) were tested for SARS-CoV-2 by RT-PCR and subjected to whole genome sequencing (WGS). Sequences from a selection of people from the same area were included as community reference.

    > Results
      After the church service, 30 of 39 visitors (77%) developed symptoms; 14 were tested and were positive for COVID-19 (11 residents and 3 non-residents). In the following five weeks, 62 of 300 residents (21%) and 30 of 640 HCWs (5%) tested positive for COVID-19; 21 of 62 residents (34%) died. The outbreak was controlled through a cascade of measures. WGS of samples from residents and HCWs identified a diversity of sequence types, grouped into eight clusters. Seven resident church visitors all were infected with distinct viruses, four of which belonged to two larger clusters in the nursing home.
    ...
    / February, 2020 - bioRxiv
    quote !a = Our findings underscore the importance of careful outbreak investigations to understand how SARS-CoV-2 transmits, to develop evidence-based mitigation measures. Whole genome sequencing can make an essential contribution in this, by revealing transmission patterns that would otherwise remain concealed. Without whole genome sequencing, epidemiological data can easily be misinterpreted, resulting in jumping to conclusions.
  ...
  ref 'Wang_et_al_05_28_2020
    ...
    / May, 2020 - BMJ Glob Health
    quote !b = Face mask use by the primary case and family contacts before the primary case developed symptoms was 79% effective in reducing transmission.

    / May, 2020 - BMJ Glob Health
    quote !c = Daily use of chlorine or ethanol based disinfectant in households was 77% effective.

    / May, 2020 - BMJ Glob Health
    quote !d = The findings inform universal face mask use and social distancing, not just in public spaces, but inside the household with members at risk of getting infected.

    / May, 2020 - BMJ Glob Health
    quote !e = Wearing a mask after illness onset of the primary case was not significantly protective.
  ...
  ref 'Cevik_et_al_11_19_2020
    ...
    / November, 2020 - The Lancet Microbe
    quote !d = SARS-CoV-2 viral load in the upper respiratory tract appeared to peak in the first week of illness, whereas that of SARS-CoV peaked at days 10–14 and that of MERS-CoV peaked at days 7–10.
  ...
  ref 'Cao_et_al_11_20_2020
    ...
    quote !a = The prevalence of SARS-CoV-2 infection in Wuhan was therefore very low five to eight weeks after the end of lockdown.
  ...
  ref 'Wu_et_al_07_01_2020
    ...
    quote !a = Among the 74 pediatric case patients, 68 had a definite exposure history, and 65 were household contacts of adults whose symptoms developed earlier.

    / July, 2020 - Pediatrics
    quote !b = Only one-third of the 74 pediatric case patients had abnormal leukocyte and/or lymphocyte counts, among whom 19 had increased and 4  had a decreased number of leukocytes; 6 had elevated lymphocytes, and 4 had reduced lymphocytes.
  ...
  ref 'Zachary_et_al_08_01_2020
    ...
    / August, 2020 - medRxiv
    quote !a = Results suggest that household and family contacts are at higher risk than other types of contacts.

    / August, 2020 - medRxiv
    quote !b = We observed that household SARs were significantly higher from symptomatic index cases than asymptomatic index cases, to adult contacts than children contacts, to spouses than other family contacts, and in households with one contact than households with three or more contacts.
  ...
  ref 'Asadi_et_al_01_27_2020
    ...
    quote !a = Our measurements showed that particle emission rates were positively correlated with the vowel content of a phrase; conversely, particle emission decreased during phrases with a high fraction of voiceless fricatives. Our particle emission data is broadly consistent with prior measurements of the egressive airflow rate associated with the vocalization of various phones that differ in voicing and articulation.

    / January, 2020 - PLOS ONE
    quote !b = We found that certain phones are associated with significantly higher particle production; for example, the vowel /i/ (“need,” “sea”) produces more particles than /ɑ/ (“saw,” “hot”) or /u/ (“blue,” “mood”), while disyllabic words including voiced plosive consonants (e.g., /d/, /b/, /g/) yield more particles than words with voiceless fricatives (e.g., /s/, /h/, /f/).
  ...
  ref 'Schuit_et_al_06_11_2020
    head = This study examined effect of simulated sunlight, relative humidity, and suspension matrix on stability of SARS-CoV-2 in aerosols. Simulated sunlight and matrix significantly affected decay rate of the virus. Relative humidity alone did not affect the decay rate; however, minor interactions between relative humidity and other factors were observed. These results suggest that the potential for aerosol transmission of SARS-CoV-2 may be dependent on environmental conditions, particularly sunlight.
    ...
    quote !a = Mean decay rates (± SD) in simulated saliva, under simulated sunlight levels representative of late winter/early fall and summer were 0.121 ± 0.017 min−1 (90% loss, 19 minutes) and 0.306 ± 0.097 min−1 (90% loss, 8 minutes), respectively.

    / June, 2020 - The Journal of Infectious Diseases
    quote !b = Mean decay rate without simulated sunlight across all relative humidity levels was 0.008 ± 0.011 min−1 (90% loss, 286 minutes).

    / June, 2020 - The Journal of Infectious Diseases
    quote !c = Simulated sunlight and matrix significantly affected decay rate of the virus. Relative humidity alone did not affect the decay rate; however, minor interactions between relative humidity and other factors were observed.
  ...
  ref 'Smither_et_al_06_22_2020
    head = The ability of SARS-CoV-2 to survive in the dark, at two different relative humidity values and within artificial saliva, a clinically relevant matrix, was investigated. SARS-CoV-2 was found to be stable, in the dark, in a dynamic small particle aerosol under the four experimental conditions we tested and viable virus could still be detected after 90 minutes.
    ...
    quote !a = The decay rate and half-life was determined and decay rates ranged from 0.4 to 2.27 % per minute and the half lives ranged from 30 to 177 minutes for the different conditions.
  ...
  ref 'Perera_et_al_08_04_2020
    head = We investigated 68 respiratory specimens from 35 coronavirus disease patients in Hong Kong, of whom 32 had mild disease.

    - quotes
      !a

    / August, 2020 - Emerging Infectious Diseases
    quote !a = We found that severe acute respiratory syndrome coronavirus 2 and subgenomic RNA were rarely detectable beyond 8 days after onset of illness. However, virus RNA was detectable for many weeks by reverse transcription PCR.
  ...
  ref 'Kam_et_al_02_28_2020
    head = A well 6-month-old infant with coronavirus disease 2019 (COVID-19) had persistently positive nasopharyngeal swabs up to day 16 of admission. This case highlights the difficulties in establishing the true incidence of COVID-19, as asymptomatic individuals can excrete the virus.
    ...
    quote !a = Apart from a single transient temperature of 38.5°C, the infant had no clinical signs or symptoms. We detected a high viral load from the nasopharynx of our infant from the day of admission and it  continued to remain positive up to day 16 of admission.
  ...
  ref 'Liu_et_al_03_19_2020
    ...
    quote !a = Our data indicate that, similar to SARS in 2002–03, 6 patients with severe COVID-19 tend to have a high viral load and a long virus-shedding period. This finding suggests that the viral load of SARS-CoV-2 might be a useful marker for assessing disease severity and prognosis.
  ...
  ref 'WangTo_et_al_03_23_2020
    head = We obtained samples of blood, urine, posterior oropharyngeal saliva, and rectal swabs. Serial viral load was ascertained by RT-qPCR. Antibody levels against the SARS-CoV-2 were measured using EIA. Whole-genome sequencing was done to identify possible mutations arising during infection.
    ...
    / March, 2020 - The Lancet Infectious Diseases
    quote !a = For most patients, the viral load of SARS-CoV-2 was very high at presentation and declined steadily. Despite development of antibodies against surface and internal proteins of SARS-CoV-2, viral RNA could still be detected in posterior oropharyngeal (deep throat) saliva samples from a third of patients for 20 days or longer.

    / March, 2020 - The Lancet Infectious Diseases
    quote !b = The median viral load was 1 log10 higher in severe cases than in mild cases, and the difference was not significant. But, older age was associated with a higher peak viral load.

    / March, 2020 - The Lancet Infectious Diseases
    quote !c = SARS-CoV-2 RNA could be detected for 20 days or longer in a third of patients who survived in our cohort, and one patient had SARS-CoV-2 RNA detected for 25 days. Prolonged detection of viral RNA of 20 days or longer was also commonly seen for patients with MERS-CoV or SARS-CoV infections

    / March, 2020 - The Lancet Infectious Diseases
    quote !d = Serum IgG amounts can rise at the same time or earlier than those of IgM against SARS-CoV-2. Higher proportion of patients in the current study also had earlier IgG than IgM seroconversion.
  ...
  ref 'Li_et_al_04_29_2020
    head = We studied the clinical characteristics of 36 confirmed COVID‐19 patients who continued to shed viral RNA for longer than 30 days.

    / April, 2020 - Journal of Medical Virology
    quote !a = Prolonged viral RNA shedding even after symptomatic relief was not rare, and the median duration of viral RNA shedding was 53.5 days. The longest duration of viral RNA shedding could be 83 days.
  ...
  ref 'Zhou_et_al_04_17_2020
    head = We analyzed the duration of viral shedding and the total time from illness onset to discharge in groups.
  ...
  ref 'Gupta_et_al_05_17_2020
    head = The primary aim of this review was to establish the incidence and timing of positive faecal samples for SARS‐CoV‐2 in patients with COVID‐19.
    ...
    quote !a = The duration of faecal viral shedding ranged from 1 to 33 days after a negative nasopharyngeal swab with one result remaining positive 47 days after onset of symptoms. There is insufficient evidence to suggest that COVID‐19 is transmitted via faecally shed virus.
  ...
  ref 'Chen_et_al_04_03_2020
    head = We aimed to investigate SARS‐CoV‐2 shedding in the excreta of COVID‐19 patients.
  ...
  ref 'Kampen_et_al_06_09_2020
    ...
    / June, 2020 - MedRxiv
    quote !a = The median duration of shedding was 8 days post onset of symptoms (IQR 5-11) and the probability of detecting infectious virus dropped below 5% after 15,2 days post onset of symptoms (95% confidence interval (CI) 13,4-17,2).
  ...
  ref 'Li_et_al_05_26_2005
    ...
    quote !a = Microclimate temperature, humidity and skin temperature inside the facemask increased with the start of step exercise, which led to the different perceptions of humidity, heat and high breathing resistance among the subjects wearing the facemasks. High breathing resistance made it difficult for the subject to breathe and take in sufficient oxygen. Shortage of oxygen stimulates the sympathetic nervous system and increases heart rate.

    / May, 2005 - Int Arch Occup Environ Health
    quote !b = Mean heart rate, microclimate temperature, humidity and skin temperature inside the facemask, together with perceived humidity, heat, breathing resistance in the facemask, and itchiness, fatigue and overall discomfort, were significantly (P<0.01) higher for N95 masks than for surgical masks.

    / May, 2005 - Int Arch Occup Environ Health
    quote !c = The surface temperature outside the facemask was lower, and the temperature in the facemask microclimate was significantly higher, for the N95 masks than for the surgical masks indicating that the heat loss from the respiratory tract is more difficult to endure in N95 masks, inducing higher heat stress and perception of discomfort.

    / May, 2005 - Int Arch Occup Environ Health
    quote !d = During the simulation wear trials, in vivo filtration efficiency of N95 facemasks was 96%, in comparison with 95% for surgical facemasks.

    / May, 2005 - Int Arch Occup Environ Health
    quote !e = The surgical facemasks with significantly higher moisture permeability and air-permeability were thinner than the N95 facemasks, indicating that surgical facemasks should be more breathable and less humid and hot, which agrees with the in vivo measurements of temperature and humidity inside and outside the masks and the subjects’ perception of breathing resistance and discomfort.

    / May, 2005 - Int Arch Occup Environ Health
    quote !f = No significant difference was found between nano-treated and untreated facemasks for physiological measurements and subjective perceptions, even though nano-treated surgical and N95 facemasks were perceived to be slightly less uncomfortable. On the other hand, subjective preferences for the nano-treated surgical masks were significantly higher than those for the untreated surgical facemasks. This indicates that the nano-functional treatment of surgical and N95 facemasks does not have significant negative effects on the thermophysiological responses and subjective perceptions of discomfort.
  ...
  ref 'Tillett_et_al_10_12_2020
    ...
    # / October, 2020 - The Lancet Infectious Diseases
    # quote !a = A 25-year-old man from the US state of Nevada, who had no known immune disorders (not taking any immunosuppressive drugs), had PCR-confirmed SARS-CoV-2 infection in April, 2020 (cycle threshold [Ct] value 35·24; specimen A). He recovered in quarantine, testing negative by RT-PCR at two consecutive timepoints thereafter. However, 48 days after the initial test, the patient tested positive again by RT-PCR (Ct value 35·31; specimen B).

    / October, 2020 - The Lancet Infectious Diseases
    quote !b = Specimens A and B were both in clade 20C, which was the predominant major clade seen in northern Nevada at the time samples were obtained.

    / October, 2020 - The Lancet Infectious Diseases
    quote !c = SARS-CoV-2 reinfection resulted in worse disease than did the first infection, requiring oxygen support and hospitalisation.

    / October, 2020 - The Lancet Infectious Diseases
    quote !d = The patient had positive antibodies after the reinfection, but whether he had pre-existing antibody after the first infection is unknown.
  ...
  ref 'Iwasaki_et_al_10_12_2020
    ...
    # / October, 2020 - The Lancet Infectious Diseases
    # quote !a = The first confirmed case of SARS-CoV-2 reinfection in the USA. A 25-year-old man from the US state of Nevada, who had no known immune disorders, had PCR-confirmed SARS-CoV-2 infection in April, 2020 (cycle threshold [Ct] value 35·24; specimen A). However, 48 days after the initial test, the patient tested positive again by RT-PCR (Ct value 35·31; specimen B). Viral genome sequencing showed that both specimens A and B belonged to clade 20C, a predominant clade seen in northern Nevada. However, the genome sequences of isolates from the first infection (specimen A) and reinfection (specimen B) differed significantly, making the chance of the virus being from the same infection small. SARS-CoV-2 reinfection resulted in worse disease than did the first infection, requiring oxygen support and hospitalisation. The patient had positive antibodies after the reinfection, but whether he had pre-existing antibody after the first infection is unknown

    / October, 2020 - The Lancet Infectious Diseases
    quote !b = Of the four reinfection cases reported to date, none of the individuals had known immune deficiencies. Currently, only two individuals had serological data from the first infection and one had pre-existing antibody (IgM) against SARS-CoV-2.

    / October, 2020 - The Lancet Infectious Diseases
    quote !c = Antibody reactivity to nucleocapsid protein indicates previous exposure to SARS-CoV-2 but not whether antibodies that can block infection (anti-spike) are present. Also, antibody levels are highly dependent on the timing after exposure. The key goal for the future is to ascertain the level and specificity of antibody to spike protein at the time of reinfection, to determine immune correlate of protection.

    / October, 2020 - The Lancet Infectious Diseases
    quote !d = There is currently no evidence that a SARS-CoV-2 variant has emerged as a result of immune evasion. For now, one vaccine will be sufficient to confer protection against all circulating variants. Furthermore, reinfection by a distinct viral variant from the original virus does not imply immune escape.

    / October, 2020 - The Lancet Infectious Diseases
    quote !e = While differences in the viral genome sequence of the various isolates are a great way to know if an individual is reinfected (ruling out reactivation of lingering virus infection), it does not indicate that the second infection was due to immune evasion. There is currently no evidence that a SARS-CoV-2 variant has emerged as a result of immune evasion. For now, one vaccine will be sufficient to confer protection against all circulating variants. Furthermore, reinfection by a distinct viral variant from the original virus does not imply immune escape.

    / October, 2020 - The Lancet Infectious Diseases
    quote !f = The Ct value of PCR correlates with viral load, and low Ct values (high viral load) might indicate infectiousness of the individual. Although Ct values can vary substantially between various tests and laboratories. A good proxy for infectiousness can be obtained through viral plaque assays that measure the infectious virus. However, these assays require biosafety level 3 facilities and are labour intensive, and the assays are not routinely done in clinical laboratories.

    / October, 2020 - The Lancet Infectious Diseases
    quote !g = Patients from Nevada and Ecuador had worse disease outcomes at reinfection than at first infection. The reinfection cases in general are being picked up because of symptoms and are biased towards detection of symptomatic cases. Due to the paucity of broad testing and surveillance, we do not know how frequently reinfection occurs among individuals who recovered from their first infection. Asymptomatic reinfection cases can only be picked up by routine community testing or at an airport, for example, and we are probably severely underestimating the number of asymptomatic reinfections.
  ...
  ref 'Vogels_et_al_07_10_2020
    ...
    # quote !a = Our findings show a high similarity in the analytical sensitivities for SARS-CoV-2 detection, which indicates that outcomes of different assays are comparable. The primary exception to this is the RdRp-SARSr (Charité) primer–probe set, which had the lowest sensitivity, probably stemming from a mismatch in the reverse primer.

    / July, 2020 - Nature Microbiology
    quote !b = In the United States, we recommend using the US CDC SARS-CoV-2 assay because: (1) we found similar analytical sensitivity as compared to the other three assays (China CDC, Charité and HKU); (2) we detected a low rate of inconclusive results with low-virus clinical samples; (3) it includes a human RNase P primer–probe set (RP) that allows for quality control of RNA extraction methods; and (4) its widespread use in the United States makes it easier to compare results. In other regions of the world, however, a different test may be preferable based on existing usage.
  ...
  ref 'Kudo_et_al_10_07_2020
    ...
    quote !a = In single RT-qPCR, the CDC N2 primer set has a lower detection capability than the CDC N1 primers [3]. Our multiplex RT-qPCR assay also showed that N1 and N2 primer–probe sets had detection rates of 60% and 25%, respectively, at 50 virus copies per reaction

    # / October, 2020 - PLOS Biology
    # quote !b = While the analytical sensitivity is important to define for a given diagnostic test, very low viral copy numbers are unlikely to reflect infectious viral load.
  ...
  ref 'Service_et_al_10_02_2020
    ...
    # quote !a = CT values could help doctors flag patients at high risk for serious disease. Recent findings also suggest the numbers could help officials determine who is infectious and should therefore be isolated and have their contacts tracked down.

    / October, 2020 - Science
    quote !b = But the same sample can give different CT values on different testing machines, and different swabs from the same person can give different results.

    / October, 2020 - Science
    quote !c = Early studies showed that patients in the first days of infection have CT values below 30, and often below 20, indicating a high level of virus; as the body clears the coronavirus, CT values rise gradually. More recent studies have shown that a higher viral load can profoundly impact a person's contagiousness and reflect the severity of disease.

    / October, 2020 - Science
    quote !d = In a study published this week in Clinical Infectious Diseases, researchers led by Bernard La Scola, examined 3790 positive samples with known CT values to see whether they harbored viable virus, indicating the patients were likely infectious. La Scola and his colleagues found that 70% of samples with CT values of 25 or below could be cultured, compared with less than 3% of the cases with CT values above 35.

    / October, 2020 - Science
    quote !e = Conversely, people often test positive for weeks or even months after they recover but have high CT values, suggesting the PCR has identified genetic material from noninfectious viral debris.

    / October, 2020 - Science
    quote !f = Broad access to CT values could also help epidemiologists track outbreaks. If researchers see many low CT values, they could conclude an outbreak is expanding. But if nearly all CT values are high, an outbreak is likely waning.

    / October, 2020 - Science
    quote !g = CT values could also help clinicians flag patients most at risk for severe disease and death. A report in June from researchers at Weill Cornell Medicine found that among 678 hospitalized patients, 35% of those with a CT value of 25 or less died, compared with 17.6% with a CT value of 25 to 30 and 6.2% with a CT value above 30. In August, researchers in Brazil found that among 875 patients, those with a CT value of 25 or below were more likely to have severe disease or die.

    # / October, 2020 - Science
    # quote !h = A high viral load doesn't necessarily lead to disease; some 40% of people who contract SARS-CoV-2 stay healthy even though they have a similar amount of virus to patients who fall ill.
  ...
  ref 'Wu_et_al_04_20_2020b
    ...
    / April, 2020 - medRxiv
    quote !a = Elderly and middle-age patients had significantly higher plasma NAb titers (P<0.0001) and spike-binding antibodies (P=0.0003) than young patients.

    / April, 2020 - medRxiv
    quote !b = The NAb titers were positive correlated with plasma CRP levels but negative correlated with the lymphocyte counts of patients at the time of admission, indicating an association between humoral response and cellular immune response.
  ...
  ref 'Schunemann_et_al_08_03_2020
    ...
    quote !a = In highly populated areas that have high infection rates—eg, USA, India, Brazil, or South Africa — the use of masks will probably outweigh any potential downsides.
  ...
  ref 'Wu_et_al_04_02_2020
    ...
    quote !a = The risk of asymptomatic transmission and facemask shortages should be carefully evaluated before introducing a universal facemask wearing policy in high-risk regions.

    / April, 2020 - EClinical Medicine
    quote !b = Public health measures aimed at improving hand hygiene and effective public communication should be considered along with the facemask policy.
  ...
  ref 'McDonald_et_al_10_31_2019
    ...
    quote !a = We argue that clarity around decision-making by agencies, after using this framework, may help increase trust about the intervention and solidarity within and between populations affected by these disasters and the agencies who support public health or provide assistance during disasters.
  ...
  ref 'Hossain_et_al_09_08_2020
    ...
    quote !a =  A major factor contributing to the filtration efficiency of N95 masks is the presence of an intermediate layer of charged polypropylene electret fibers that trap particles through electrostatic or electrophoretic effects. This charge can degrade when the mask is used. Moreover, simple decontamination procedures (e.g., use of alcohol) can degrade any remaining charge from the polypropylene, thus severely impacting the filtration efficiency post-decontamination. In this report, we summarize our results on the development of a simple laboratory setup allowing measurement of charge and filtration efficiency in N95 masks. In particular, we propose and show that it is possible to recharge the masks post-decontamination and recover filtration efficiency.
  ...
  ref 'Rowan_et_al_09_10_2020
    ...
    quote !a = Efficacy of face coverings are influenced by the appropriate wearing to cover the nose and mouth, type of material used, number of layers, duration of wearing, and potentially superior use of ties over ear loops. Insertion of a nose clip into cloth coverings may help with maintaining fit.

    / September, 2020 - Science of the Total Environment
    quote !b = Risk of virus infiltration in improvised face coverings is potentially increased by duration of wearing due to humidity, liquid diffusion and virus retention.

    / Hydrogen peroxide for reuse of N95
    quote !c = Hydrogen peroxide in vapour (VH2OH), used alone or combined with ozone, has been used for high-throughput decontamination and reuse of complex PPE such as important filtering facepiece respirators (FFRs), such as the popular N95 respirator.

    / UV may not be efective for mask reuse
    quote !d = Ultraviolet (UV) light procedures, particularly using UVC wavelength, have also been reported as potentially appropriate decontamination technology for PPE, but this technology is unlikely to inactivate SARS-CoV-2 if this virus penetrates lower layers of material of FFRs where they would be hidden from the UV.

    / Heating for mask reuse
    quote !e = Moist heating at 60°C to 70°C combined with high humidity for 60 min is also a promising decontaminating procedure for PPE as it would also enable scalability and high-throughput processing.

    / September, 2020 - Science of the Total Environment
    quote !f = Use of microwave generated steam would not provide scale for PPE decontamination. Physical irradiation technologies, such as gamma and electron beam, along with ethylene oxide, are not suitable for PPE reprocessing.

    / September, 2020 - Science of the Total Environment
    quote !g = SARS-CoV-2 will tolerated cold weather, such as 4°C (refrigeration), better and survival beyond 14 days on materials, which has implications for environmental wearing of masks and face cloths as we enter the winder flu season.
  ...
  ref 'Murray_et_al_04_07_2020
    ...
    -
     ...
     quote !a = Several commercially available respirators contain ferromagnetic components, and are thus regarded as “MRI unsafe”. Surgical masks offer a WHO approved safe alternative for MR staff in an MRI environment.
  ...
  ref 'CDC_08_07_2020
    ...
    quote !a = A face shield is primarily used for eye protection for the person wearing it. At this time, it is not known what level of protection a face shield provides to people nearby from the spray of respiratory droplets from the wearer. There is currently not enough evidence to support the effectiveness of face shields for source control. Therefore, CDC does not currently recommend use of face shields as a substitute for masks.

    / Recommendation: Faceshields design and usage
    quote !b = Face shields that wrap around the sides of the wearer’s face and extend below the chin. Hooded face shields.

    / Recommendation: Faceshields reused
    quote !c = Reusable face shields should be cleaned and disinfected after each use according to manufacturer instructions or by following
  ...
  ref 'Gandhi_et_al_07_31_2020
    ...
    quote !a = A report from a pediatric hemodialysis unit in Indiana, where all patients and staff were masked, demonstrated that staff rapidly developed antibodies to SARS-CoV-2 after exposure to a single symptomatic patient with COVID-19. In the setting of masking, however, none of the new infections was symptomatic.

    / July, 2020 - Journal of General Internal Medicine
    quote !b = In a recent outbreak in a seafood processing plant in Oregon where all workers were issued masks each day at work, the rate of asymptomatic infection among the 124 infected was 95%.

    / July, 2020 - Journal of General Internal Medicine
    quote !c = An outbreak in a Tyson chicken plant in Arkansas with masking also showed a 95% asymptomatic rate of infection.

    / July, 2020 - Journal of General Internal Medicine
    quote !d = Countries accustomed to masking since the 2003 SARS-CoV pandemic, including Japan, Hong Kong, Taiwan, Thailand, South Korea, and Singapore, and those who newly embraced masking early on in the COVID-19 pandemic, such as the Czech Republic, have fared well in terms of rates of severe illness and death.

    / July, 2020 - Journal of General Internal Medicine
    quote !e = When cases have resurged in these areas with population-based masking upon re-opening (e.g., South Korea, Singapore, Hong Kong, Taiwan), the case-fatality rate has remained low, which is suggestive of this viral inoculum theory.
    / Mask wearing reduces initial viral loads
    quote !f = Our theory is based on the likelihood of masking reducing the viral inoculum to which the mask-wearer is exposed, leading to higher rates of mild or asymptomatic infection with COVID-19. This could lead to greater community-level immunity and slower spread as we await a vaccine.
  ...
  ref 'Gormley_et_al_03_23_2020
    ...
    # quote !a = The interconnectedness of the wastewater plumbing network, the sensitivity of the system to factors such as overuse, underuse, high temperatures, and high concentrations of infected people raise concerns over the practice of self isolation and the use of hospital wards as quarantine areas.

    / March, 2020 - The Lancet Global Health
    quote !a = High concentrations of infected people contribute to a higher viral load in the system, thus leading to a higher risk of disease spread. Self-isolation can lead to a greater number of infected people in a building and potential system overuse. The use of hospital wards as quarantine areas is also a concern because of the interconnectedness of the whole system.

    / March, 2020 - The Lancet Global Health
    quote !b = Do not ignore unexplained foul smells in bathrooms, kitchens, or wash areas.

    / March, 2020 - The Lancet Global Health
    quote !c = Make sure that all water appliances in bathrooms and kitchens are fitted with a functioning U-blends.

    / March, 2020 - The Lancet Global Health
    quote !d = To prevent the loss of the water trap seal within a U-bend, open a tap on all water appliances for at least 5 s twice a day (morning and evening) paying special attention to floor drains in bathrooms and wet rooms.

    / March, 2020 - The Lancet Global Health
    quote !e = If the wastewater pipework from an appliance appears to be disconnected or open, seal it immediately (ie, use an elastic rubber glove to cover the end; a plastic bag and some tape will suffice, ensuring the bag has no holes).

    / March, 2020 - The Lancet Global Health
    quote !f = If there appears to be any crack or leak in pipework, seal with tape or glue. Continuously monitor whole system performance (for large or tall buildings).
  ...
  ref 'Lei_et_al_12_15_2017
    ...
    quote !a = Different transmission routes of infection led to different spatial patterns of secondary cases, so passengers within 2 rows of the index case in the influenza A H1N1 outbreak and passengers in aisle seats in the in‐flight norovirus outbreak had a significantly higher infection risk than others.

    / December, 2017 - Indoor Air
    quote !b =  For influenza A H1N1, due to the high inactivation rate on environmental surfaces and hands, in most cases, the total infection risk via fomite route is much lower than that via airborne route and close contact route.

    / December, 2017 - Indoor Air
    quote !c = The study by Teunis et al indicated that the infection probability of the droplet route (ie, close contact) and the aerosol route (ie, the airborne route) in a poorly ventilated room is approximately equal.

    / December, 2017 - Indoor Air
    quote !d = The air change rate and efficiency of the HEPA filter are relatively high in the aircraft ventilation system than other typical indoor environments, so that the airborne pathogens can be removed effectively. In most reported in‐flight influenza A H1N1 outbreaks, the attack rate is low (1%‐5%), but in the seasonal influenza A outbreak in March 1977, when the air conditioning system of a commercial airliner was shut down due to a malfunctioning engine, the attack rate reached 72%

    / December, 2017 - Indoor Air
    quote !e = SARS CoV has a much lower inactivation rate on environmental surfaces and skin, which is probably why the fomite route is more important in SARS CoV transmission than that in influenza A H1N1 transmission.
  ...
  ref 'Dyal_et_al_05_08_2020
    ...
    / May, 2020 - MMWR Morb Mortal Wkly Rep.
    quote !a = Solutions to structural and operational challenges that some facilities adopted included adjusting start and stop times of shifts and breaks to increase physical distance between workers. Outdoor break areas were added at some facilities to decrease contact between workers. Some facilities installed physical (e.g., plexiglass) barriers between workers; however, this was not practical for all worker functions. Symptom and temperature screening of workers was newly instituted in some facilities and improved in others.

    / May, 2020 - MMWR Morb Mortal Wkly Rep.
    quote !b = Changing transportation to and from the facilities to increase the number of vehicles and reduce the number of passengers per vehicle helped maintain physical distancing in some facilities.
  ...
  ref 'Li_et_al_04_22_2020
    ...
    > Background
      The role of aerosols in the transmission of SARS-CoV-2 remains debated. We analysed an outbreak involving three non-associated families in Restaurant X in Guangzhou, China, and assessed the possibility of aerosol transmission of SARS-CoV-2 and characterize the associated environmental conditions.
  ...
  ref 'Setti_et_al_04_17_2020
    ...
    > Methods
      To assess environmental factors related to the spread of the COVID-19 in Italy from February 24th to March 13th (the date when the lockdown has been imposed over Italy), official daily data relevant to ambient PM10 levels were collected from all Italian Provinces between February 9th and February 29th , taking into account the average time (estimated in 17 days) elapsed between the initial infection and the recorded COVID positivity. In addition to the number of exceedances of PM10 daily limit value, we considered also population data and daily travelling information per each Province.

    > Results
      PM10 daily limit value exceedances appear to be a significant predictor (p <0.001) of infection in univariate analyses. Less polluted Provinces had a median of 0.03 infection cases over 1000 residents, while most polluted Provinces had a median of 0.26 cases over 1000 residents. Thirty-nine out of 41 Northern Italian Provinces resulted in the category with highest PM10 levels, while 62 out of 66 Southern Provinces presented low PM10 concentrations (p<0.001). In Milan, the average growth rate before the lockdown was significantly higher than Rome (0.34 vs. 0.27 per day, with a doubling time of 2.0 days vs. 2.6), suggesting a basic reproductive number R0>6.0, comparable with the highest values estimated for China.
  ...
  ref 'Bourouiba_et_al_03_26_2020
    ...
    / March, 2020 - JAMA
    quote !d = The degree and rate of evaporation depend strongly on ambient temperature and humidity conditions, but also on the inner dynamics of the turbulent puff cloud coupled with the composition of the liquid exhaled by the patient.

    / March, 2020 - JAMA
    quote !e = The locally moist and warm atmosphere within the turbulent gas cloud allows the contained droplets to evade evaporation for much longer than occurs with isolated droplets. Under these conditions, the lifetime of a droplet could be considerably extended by a factor of up to 1000, from a fraction of a second to minutes.
  ...
  ref 'Lewis_et_al_08_16_2020
    ...
    / August, 2020 - Clinical Infectious Diseases
    quote !a =
  ...
  ref 'Wei_et_al_09_02_2016
    ...
    / September, 2016 - American Journal of Infection Control
    quote !a = Displacement ventilation may not be applicable to hospital rooms where respiratory infection is a concern.

    / September, 2016 - American Journal of Infection Control
    quote !b = Direct exposure to the expired fine droplets or droplet nuclei results in short-range airborne transmission.

    / September, 2016 - American Journal of Infection Control
    quote !c = Deposition of droplets and direct personal exposure to expired large droplets can lead to the fomite route and the droplet-borne route, respectively.
  ...
  ref 'Gaffney_et_al_08_21_2020
    ...
    quote !a = Among teachers, 39.8% had definite and 50.6% had definite or possible risk factors for severe COVID-19 illness.

    / August, 2020 - Annals of Internal Medicine
    quote !b = The prevalence of risk factors was similar among adults living with younger versus older children

    / August, 2020 - Annals of Internal Medicine
    quote !c = Adults living with children in low-income households were more likely to be at risk than those in higher-income households, as were those residing with Black children; adults living with Asian children or children of other races/ethnicities were at lowest risk.

    / August, 2020 - Annals of Internal Medicine
    quote !d = The prevalence of most risk factors was similar among nonteacher workers, although more were smokers; 41.4% had any definite risk factors, and 55.8% had definite or possible risk factors.
  ...
  ref 'Bean_et_al_07_01_2020
    ...
    / July, 2020 - J Infect Dis.
    quote !a = Measurable quantities of influenza A virus were transferred from stainless steel surfaces to hands for 24 hr and from tissues to hands for up to 15 min.

    / July, 2020 - J Infect Dis.
    quote !b = Virus survived on hands for up to 5 min after transfer from the environmental surfaces.
  ...
  ref 'Chen_et_al_08_01_2020
    ...
    / August, 2020 - Building and Environment
    quote !a = Short-range airborne transmission is dominant beyond 0.2 m for talking and 0.5 m for coughing. Within the 2-m interpersonal distance, the shortest distance is travelled by droplets of approximately 112.5–225 μm in size for talking and 175–225 μm for coughing.

    / August, 2020 - Building and Environment
    quote !b = The smaller droplets follow the indoor air stream, whilst the larger droplets are dominated by their inertia and travel a longer distance.

    / August, 2020 - Building and Environment
    quote !c = The large droplet route only dominates when the droplets are larger than 100 μm, within 0.2 m for talking and 0.5 m for coughing.

    / August, 2020 - Building and Environment
    quote !d = For the direct face-to-face configuration, exhaled air streams begin to cover the nostrils of the susceptible person from 0.2 to 0.3 m and the eyes from 0.4 to 0.5 m. While talking, more droplets are deposited on the eyes at long distances due to a larger jet trajectory curvature. Exposure decreases as the interpersonal distance increases for both large droplet and short-range airborne sub-routes

    / August, 2020 - Building and Environment
    quote !e = The large droplet route contributes less than 10% of exposure when the droplets are smaller than 50 μm and when the subjects are more than 0.3 m apart, even while coughing.
  ...
  ref 'Fontanet_et_al_04_23_2020
    ...
    / April, 2020 - MedRxiv
    quote !a = Smokers had a lower IAR compared to non-smokers. The protection associated with smoking in our study was very substantial (75% decrease in risk of infection).
  ...
  ref 'Shim_et_al_03_17_2020
    ...
    quote !a = The first case in South Korea was identified on Jan 20, 2020, followed by the detection of one or two cases on average in the subsequent days. However, the number of confirmed cases of SARS-CoV-2 infection started to increase rapidly on Feb 19, 2020, with a total of 6284 confirmed COVID-19 cases including 42 deaths reported as of Mar 6, 2020.

    / March, 2020 - International Journal of Infectious Diseases
    quote !a = The imported cases contribute little to secondary disease transmission in Korea, as a majority of these cases occurred in the early phase of the epidemic, with the most recent imported case reported on Feb 9, 2020.

    / March, 2020 - International Journal of Infectious Diseases
    quote !b = The crude case fatality rate is higher among males (1.1%) compared to females (0.4%) and increases with older age.
  ...
  ref 'Chaw_et_al_07_10_2020
    ...
    / July, 2020 - MedRxiv
    quote !a = Highest non-primary attack rates(ARs) were observed at a subsequent local religious gathering (14.8%) and in the household (10.6%).

    / July, 2020 - MedRxiv
    quote !b = Attack rates in households where the infectors were symptomatic (14.4%) were higher than those who were asymptomatic (4.4%) or presymptomatic (6.1%).

    / July, 2020 - MedRxiv
    quote !c = Low ARs (<1%) were observed for workplace and social settings.

    / July, 2020 - MedRxiv
    quote !d = When compared to social contacts, spouses of positive cases had the highest adjusted risk ratio of getting the infection (45.20), followed by the local religious gathering attendees (15.60), and their children (14.09).
  ...
  ref 'Li_et_al_04_17_2020
    ...
    / April, 2020 - Clinical Infectious Diseases
    quote !b = Spouses who were the husbands or wives of index cases demonstrates that the secondary attack rate of SARS-CoV-2 to spouses was significantly higher than that to other family members.
  ...
  ref 'Kokane_et_al_06_16_2020
    ...
    / June, 2020 - MedRxiv
    quote !a = 50% of police personnel are mentally disturbed due to fear of COVID-19 and faces challenges at the workplace.
  ...
  ref 'Carlisle_et_al_02_20_2020
    ...
    quote !a = The length of time spent exercising is another very important factor. Ultra-marathon runners and others participating in long endurance events—for example, walking and cycling—are likely to be most at risk from the negative and harmful effects of pollution exacerbated by exercise.

    / February, 2020 - British Journal of Sports Medicine
    quote !b = CO is detrimental to athletic performance. NO2 is of concern to human health, but outdoor levels are low. O3 poses a potentially serious risk to exercising athletes. Decrements in lung function result from exposure, and there is evidence that athletic performance may be affected.

    / February, 2020 - British Journal of Sports Medicine
    quote !c = Detrimental effects may occur at low ambient levels, but there is no scientific consensus on this matter. Blood lead accumulation during exercise indicates that personal exposure to toxic compounds associated with PM10 may be magnified.

    / February, 2020 - British Journal of Sports Medicine
    quote !d = Generally, outdoor ambient levels of SO2 are too low to cause a problem to the athlete, except the asthmatic athlete.

    / February, 2020 - British Journal of Sports Medicine
    quote !e = The findings of two studies indicate that personal exposure to PM10 of people exercising at the roadside in the city is higher than that of the sedentary person and those exercising in rural locations. Although this is unlikely to affect athletic performance, it has potentially significant effects on health.

    / February, 2020 - British Journal of Sports Medicine
    quote !f = Advice to those exercising is of course to stay away from traffic. There is an exponential decline in concentrations of many air pollutants with increasing distance from the busy road. It is advisable to exercise whenever possible in open rural or park land.

    / February, 2020 - British Journal of Sports Medicine
    quote !g = High momentary peaks can occur in the levels of any of the pollutants. Try to avoid the rush hour when NOx, CO, and VOCs are likely to accumulate.

    / February, 2020 - British Journal of Sports Medicine
    quote !h = If it is cold and smoggy, exercise indoors. Windy weather tends to dilute and disperse the pollutants.

    / February, 2020 - British Journal of Sports Medicine
    quote !i = Athletes should keep away from smoky environments and avoid car journeys in congested traffic before competition and training, as the temporarily accumulated CO may reach levels that will have detrimental effects on athletic performance.
  ...
  ref 'Morawska_et_al_04_10_2020
    ...
    quote !a = Adequate control measures be implemented to prevent further spread of the SARS-CoV-2 virus, in particularly removal of the virus-laden droplets from indoor air by ventilation.
  ...
  ref 'Dominski_et_al_07_17_2020
    ...
    quote !a = The guidance based on research and official guidelines is to avoid exercise in indoor environments with higher occupancy, and if performing outdoor exercise (walking, running, or cycling), there is a need to keep larger social distances or adopt a side-by-side arrangement.

    / July, 2020 - Sport Sciences for Health
    quote !b = The literature suggests that indoor environments have the greatest risk of infection, due to the larger density of people, the possible buildup of airborne virus-carrying droplets, and the likely higher stability of the virus in indoor air.

    / July, 2020 - Sport Sciences for Health
    quote !c = The risk of infection for individuals exercising indoors increases during the peak of occupancy when the ventilation required by those training is greater.

    / July, 2020 - Sport Sciences for Health
    quote !d = Relevant physiological changes occur during exercise, such as increased ventilation demand and respiratory frequency (from 15 to 20 up to 50 breaths per min), enhanced volume of exhaled air and airflow velocity, and inhalation of air through the mouth rather than through nasal filtering mechanisms; these changes vary according to exercise intensity. These are important factors that should be considered in this analysis for both indoor and outdoor exercise.

    / July, 2020 - Sport Sciences for Health
    quote !e = Exercise stress is associated with an increased risk of upper respiratory tract infection. In the meantime, moderate exercise has been associated with a decreased risk. There is a growing body of evidence showing that severe exercise can increase susceptibility to upper respiratory tract infection
  ...
  ref 'Liu_et_al_03_10_2020
    ...
    / April, 2020 - Nature
    quote !a = The concentration of SARS-CoV-2 RNA in aerosols that was detected in isolation wards and ventilated patient rooms was very low, but it was higher in the toilet areas used by the patients.

    / April, 2020 - Nature
    quote !b = The virus aerosol deposition on protective apparel or floor surface and their subsequent resuspension is a potential transmission pathway and effective sanitization is critical in minimizing aerosol transmission of SARS-CoV-2.

    / April, 2020 - Nature
    quote !c = This study also recorded an elevated airborne SARS-CoV-2 concentration inside the patient mobile toilet of Fangcang Hospital. This may come from either the patient's breath or the aerosolization of the virus-laden aerosol from patient’s faeces or urine during use.

    / April, 2020 - Nature
    quote !d = The results showed overall low risks in the public venues but do reinforce the importance of avoiding crowded gatherings and implementing early identification and diagnosis of asymptomatic carriers for early quarantine or treatment. Personal protection equipment such as wearing masks in public places or while in transit may reduce aerosol exposure and transmission.

    / April, 2020 - Nature
    quote !e = Levels of airborne SARS-CoV-2 RNA in the most public areas was undetectable, except in two areas that were prone to crowding; this increase was possibly due to individuals infected with SARS-CoV-2 in the crowd.
  ...
  ref 'Setti_et_al_04_23_2020
    ...
    quote !a = The available information on the SARS-COV-2 spreading supports the hypothesis of airborne diffusion of infected droplets from person to person at a distance greater than two meters (6 feet). The inter-personal distance of 2 m can be reasonably considered as an effective protection only if everybody wears face masks.
  ...
  ref 'Yang_et_al_03_08_2020
    ...
    quote !a = There were 297 family clusters (79%), case median was 4; 39 clusters of dining (10%), case median was 5; 23 clusters of shopping malls or supermarkets (6%), case median was 13; 12 clusters of work units (3%), case median was 6, and 6 clusters of transportation

    / March, 2020 - Chinese Journal of Epidemiology
    quote !b = The analysis of the epidemic situation in a department store in China indicated that there was a possibility of patients as the source of infection during the incubation period of the epidemic.

    / March, 2020 - Chinese Journal of Epidemiology
    quote !c = From February 5 to 21, 2020, 634 persons were infected on the Diamond Princess Liner.
  ...
  ref 'Qian_et_al_03_17_2020
    ...
    quote !a = Our study provided further evidence that rapid human-to-human transmission of SARS-CoV-2 outside Wuhan had occurred. None of the patient in this study had direct contact with wildlife or from Huanan Seafood Wholesale Market.
  ...
  ref 'Levinson_et_al_07_29_2020
    ...
    / July, 2020 - nature
    quote !a = Covid-19 outbreaks in high schools in France, Israel, and New Zealand did not extend to nearby elementary schools, which suggests that susceptibility, infectiousness, or both are lower among younger children.
  ...
  ref 'Thuan-Hoang_et_al_08_28_2018
    ...
    quote !a = In the context of Hajj, one of the largest religious MGs at Mecca, Saudi Arabia, respiratory tract infections are the leading cause of infectious diseases in pilgrims with a prevalence of 50–93%.
