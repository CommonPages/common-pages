...
feed November2020
  ...
  ref 'Zuo_et_al_11_02_2020
    head =  We analysed the magnitude and phenotype of the SARS-CoV-2 cellular immune response in 100 donors at six months following primary infection. Our data are reassuring that functional SARS-CoV-2-specific T-cell responses are retained at six months following infection although the magnitude of this response is related to the clinical features of primary infection.
  ...
  ref 'Gaebler_et_al_11_05_2020
    head = We report on the humoral memory response in a cohort of 87 individuals assessed at 1.3 and 6.2 months after infection. Memory B cell response to SARS-CoV-2 evolves between 1.3 and 6.2 months after infection in a manner that is consistent with antigen persistence.
  ...
  ref 'Weisberg_et_al_11_05_2020
    head =  We show distinct antibody responses in children and adults after SARS-CoV-2 infection. Adult COVID-19 cohorts had anti-spike (S) IgG, IgM and IgA antibodies, as well as anti-nucleocapsid (N) IgG antibody, while children with and without MIS-C had reduced breadth of anti-SARS-CoV-2-specific antibodies, predominantly generating IgG antibodies specific for the S protein but not the N protein. Moreover, children with and without MIS-C had reduced neutralizing activity as compared to both adult COVID-19 cohorts, indicating a reduced protective serological response.
