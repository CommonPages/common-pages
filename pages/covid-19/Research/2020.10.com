...
feed October2020
  ...
  ref 'Kowitdamrong_et_al_10_09_2020
    head = The serological test for SARS-CoV-2 has a high sensitivity more than two weeks after the onset of illness. Additionally, the serological response differs among patients based on sex as well as the severity of infection.
  ...
  ref 'Seow_et_al_10_26_2020
    head = Using sequential samples from SARS-CoV-2-infected individuals collected up to 94 d POS, we demonstrate a typical antibody response after an acute viral infection where a peak response was detected 3–4 weeks post-infection, which then wanes.
  ...
  ref 'Ueki_et_al_10_2020
    ...
    / Any type of masks has protective effect
    quote !a = We developed an airborne transmission simulator of infectious SARS-CoV-2-containing droplets/aerosols produced by human respiration and coughs and assessed the transmissibility of the infectious droplets/aerosols and the ability of various types of face masks to block the transmission. We found that cotton masks, surgical masks, and N95 masks all have a protective effect with respect to the transmission of infective droplets/aerosols of SARS-CoV-2 and that the protective efficiency was higher when masks were worn by a virus spreader.
