...
feed February2020
  ...
  ref 'Letko_et_al_02_24_2020
    ...
    # quote !a = We infected baby hamster kidney (BHK) cells expressing the receptor for SARS-CoV or empty vector and observed that only clade 1, which includes SARS-CoV, could enter cells transfected with human ACE2.

    # / February, 2020 - Nature Microbiology
    # quote !b = In the absence of exogenous protease, only clade 1 infected cells from African green monkey kidney, human gastrointestinal tract, human liver and porcine kidney, in agreement with previous studies. Surprisingly, exogenous protease enhanced entry of a subset of clade 2 spike chimeras in nonhuman primate, bat and human cells. Importantly, VSV-G-pseudotyped particles were able to produce luciferase signal in all cell lines tested in this study.

    / February, 2020 - Nature Microbiology
    quote !c = Protease treatment only enhanced entry of clade 1 RBDs on cells expressing human ACE2, but not human DPP4 or APN. No entry was observed with clade 2 or 3 spikes, regardless of receptor or protease addition. In the absence of receptor, no entry was observed for any of the pseudotypes, suggesting that protease-mediated entry is receptor dependent.

    # / February, 2020 - Nature Microbiology
    # quote !d = The chimeric SARS–SARS-CoV-2 spike protein expressed was incorporated into particles similarly to other clade 1 chimeric spikes and was capable of entering cells expressing human ACE2, but not any of the other receptors tested.
  ...
  ref 'Xiao_et_al_02_20_2020
    ...
    quote !a = In this study, one coronavirus isolated from Malayan pangolins showed 100%, 98.2%, 96.7% and 90.4% amino acid identity with 2019-nCoV in the E, M, N and S genes, respectively.

    / February, 2020 - bioRxiv
    quote !b = In a Simplot analysis of whole genome sequences, the Pangolin-CoV genome was highly similar throughout the genome to 2019-nCoV and Bat SARSr-CoV RaTG13, with sequence identity between 80 and 98%, except for the S gene.

    / February, 2020 - bioRxiv
    quote !c = In particular, the receptor-binding domain of the S protein of the Pangolin-CoV is virtually identical to that of 2019-nCoV, with one amino acid difference.

    / February, 2020 - bioRxiv
    quote !d = Comparison of available genomes suggests 2019-nCoV might have originated from the recombination of a Pangolin-CoV-like virus with a Bat-CoV-RaTG13-like virus. Further comparative analysis of the S gene sequences suggests that there were recombination events among some of the SARSr-CoV analyzed. In the region of nucleotides 1-914, Pangolin-CoV is more similar to Bat SARSr-CoV ZXC21 and Bat SARSr-CoV ZC45, while in remaining part of the gene, Pangolin-CoV is more similar to 2019-nCoV-like and Bat-CoV-RaTG13.

    / February, 2020 - bioRxiv
    quote !e = Infected pangolins showed clinical signs and histopathological changes, and the circulating antibodies reacted with the S protein of 2019-nCoV.

    # / February, 2020 - bioRxiv
    # quote !f = We obtained the lung tissues from four Chinese pangolins (Manis pentadactyla) and 25 Malayan pangolins (Manis javanica) that were collected from a wildlife rescue center during March-December 2019, and analyzed for SARSr-CoV using RT-PCR with primers targeting a conservative region of β CoV. RNA from 17 of the 25 Malayan pangolins generated the expected PCR product, while RNA from the Chinese pangolins failed to amplify.

    / February, 2020 - bioRxiv
    quote !g = In the analysis of plasma samples from eight of the Malayan pangolins using a double-antigen sandwich ELISA designed for the detection of IgG and IgM antibodies against with 2019-nCoV, one sample reacted strongly with an OD450 value of 2.12 (cutoff value: 0.11). The plasma remained positive at the dilution of 1:80, suggesting that the pangolin was naturally infected a 2019-nCoV-like virus.

    / February, 2020 - bioRxiv
    quote !h = RT-PCR analysis of the viral culture using five sets of primers targeting the spike (S) and RdRp genes produced the expected PCR products in three of them. The PCR products had ~84.5% and 92.2% nucleotide sequence identity to the partial S and RdRp genes of 2019-nCoV, respectively.

    # / February, 2020 - bioRxiv
    # quote !i = The topologies mostly showed clustering of Pangolin-CoV with 2019-nCoV and Bat SARSr-CoV RaTG13, with 2019-nCoV and Bat SARSr-CoV RaTG13 forming a subclade within the cluster. In the phylogenetic analysis of RBD region of the S gene, however, Pangolin-CoV and 2019-nCoV grouped together.

    # / February, 2020 - bioRxiv
    # quote !j = The RBD of the S protein of SARS-CoV binds ACE2 from humans and civets efficiently. In addition, it appears to be capable of binding ACE2 of pangolins. This is also the case for the Bat-CoV-RaTG13. In contrast, the S proteins of 2019-nCoV and Pangolin-CoV can potentially recognize ACE2 of only humans and pangolins. Therefore, ACE2 proteins of humans and pangolins can probably recognize the S proteins of all four SARSr-CoV viruses, while the ACE2 of civets can probably only recognize the S proteins of SARS-CoV and Bat-CoV-RaTG13.

    # / February, 2020 - bioRxiv
    # quote !k = Pangolins and bats are both nocturnal animals, eat insects, and share overlapping ecological niches, which make pangolins the ideal intermediate host for some SARSr-CoV. Therefore, more systematic and long-term monitoring of other SARSr-CoV in pangolins and other related animals should be implemented to identify the potential animal source of 2019-nCoV in the current outbreak.

    / February, 2020 - bioRxiv
    quote !l = The SARSr-CoV virus identified in pangolins in the present study is genetically related to 2019-nCoV, but is unlikely directly linked to the outbreak because of the substantial sequence differences between 2019-nCoV and Pangolin-CoV.
  ...
  ref 'Kim_et_al_2020b
    ...
    quote !a = In Patient 1, we observed one example of moderate disease (shortness of breath and oxygen requirement up to 10 L/min) with corresponding radiograph findings and viral loads.

    / February, 2020 - J Korean Med Sci.
    quote !b = First, unlike SARS-CoV infection,8 we found that viral load was highest during the early phase of the illness (3–5 days from first symptom onset, fever and myalgia were the only symptoms in Patient 1) and continued to decrease until the end of the second week. While she developed cough as well as shortness of breath and infiltration appeared on CXR at the end of first week of illness, the viral load already started to decrease at this phase.
    ...
    / February, 2020 - J Korean Med Sci.
    quote !d = Third, unlike in MERS-CoV revealing higher concentration of virus in LRT specimens, viral loads were similar in both URT and LRT specimens.

    / February, 2020 - J Korean Med Sci.
    quote !e = Fourth, low concentration of genetic materials, especially E gene, was detected in urine and stool from the end of the first week until the patient recovered from the infection. However, rRT-PCR results did not meet the criteria for SARS-CoV-2 positivity. Further studies need to be performed in non-respiratory specimens such as urine and stool samples.

    / February, 2020 - J Korean Med Sci.
    quote !f = In Patient 2, we observed one example of mild disease with corresponding radiograph findings and viral loads. First, even in a patient with mild disease (sore throat only), visible infiltration on CXR was observed at the end of second week. Second, even in a patient with mild disease, if visible infiltration on CXR is observed, virus is still detected in both URT and LRT specimens even at the end of second week after symptom onset. Viral loads of URT were similar with and sometimes higher than LRT specimens, and virus was detectable for longer period in URT specimen. This could be also probably because the patient did not have significant cough and had little amount of spontaneous sputum insufficient for testing.

    / February, 2020 - J Korean Med Sci.
    quote !g = In patient 2, the initial test was performed on day 14 of symptom onset and SARS-CoV-2 was detected in both URT and LRT specimens. However, the initial viral loads were relatively lower (49,047 copies/mL for URT and 391,243 copies/mL for LRT) than those of Patient 1 (46,971,053 copies/mL for URT and 9,171,220 copies/mL for LRT) in whom the test was performed on day 2 of symptom onset. SARS-CoV-2 was detected a few more times during hospitalization from both URT and LRT specimens at low levels.

    / February, 2020 - J Korean Med Sci.
    quote !h = From D18 (URT specimen) and D20 (LRT specimen), rRT-PCR became undetectable for two consecutive days, respectively. On day 25, RdRp (Ct value of 36.69) and E (Ct value of 33.18) genes was detected again from the URT sample of day 25, it was interpreted as negative due to high Ct value of RdRp gene.

    / February, 2020 - J Korean Med Sci.
    quote !i = From his plasma and stool specimens, only E genes were once detected on day 17 and it was also interpreted as negative result. His CXR improved from day 19 and he was discharged on day 27 (February 5, 2020).

    / February, 2020 - J Korean Med Sci.
    quote !j = Lopinavir/ritonavir was used in both patients on day 5 and day 17 from symptom onset, but its role cannot be determined in viral load reduction or clinical improvement. In addition, since they received Lopinavir/ritonavir which can also cause diarrhea, how much of gastrointestinal tract symptom was in fact related to SARS-CoV-2 or drug side effect.
  ...
  ref 'Lan_et_al_2020
    ...
    # / February, 2020 - JAMA Network
    # quote !b = Antiviral treatment (75 mg of oseltamivir taken orally every 12 hours) was provided for the 4 patients. For 3 of the patients, all clinical symptoms and CT imaging abnormalities had resolved. The CT imaging for the fourth patient showed delicate patches of ground-glass opacity. All 4 patients had 2 consecutive negative RT-PCR test results. The time from symptom onset to recovery ranged from 12 to 32 days.

    # / February, 2020 - JAMA Network
    # quote !c = After hospital discharge or discontinuation of quarantine, the patients were asked to continue the quarantine protocol at home for 5 days. The RT-PCR tests were repeated 5 to 13 days later and all were positive. All patients had 3 repeat RT-PCR tests performed over the next 4 to 5 days and all were positive. An additional RT-PCR test was performed using a kit from a different manufacturer and the results were also positive for all patients.

    # / February, 2020 - JAMA Network
    # quote !d = The patients continued to be asymptomatic by clinician examination and chest CT findings showed no change from previous images. They did not report contact with any person with respiratory symptoms. No family member was infected.
  ...
  ref 'Liu_et_al_2020g
    ...
    / Feb, 2020 - Lancet
    quote !a = Drawing on data from nine recent reports of secondary transmission associated with a specific event such as a meal or holiday visit, we estimated 48 secondary infections occurred among 137 attendees. Assuming that all these secondary infections were generated by a single primary case, which is probable given the short-term nature of the exposure events, would imply a SAR among close contacts of 35% (95% CI 27–44).
  ...
  ref 'Liu_et_al_2020e
    ...
    quote !a = The two studies using stochastic methods to estimate R0, reported a range of 2.2–2.68 with an average of 2.44.

    / Feb, 2020 - Journal of Travel Medicine
    quote !b = The six studies using mathematical methods to estimate R0 produced a range from 1.5 to 6.49, with an average of 4.2

    / Feb, 2020 - Journal of Travel Medicine
    quote !c = The three studies using statistical methods such as exponential growth estimated an R0 ranging from 2.2 to 3.58, with an average of 2.67.

    / Feb, 2020 - Journal of Travel Medicine
    quote !d =  In more recent studies, R0 seems to have stabilized at around 2–3. R0 estimations produced at later stages can be expected to be more reliable, as they build upon more case data and include the effect of awareness and intervention. It is worthy to note that the WHO point estimates are consistently below all published estimates, although the higher end of the WHO range includes the lower end of the estimates reviewed here.

    / Feb, 2020 - Journal of Travel Medicine
    quote !e = These estimates of R0 depend on the estimation method used as well as the validity of the underlying assumptions. Due to insufficient data and short onset time, current estimates of R0 for COVID-19 are possibly biased. However, as more data are accumulated, estimation error can be expected to decrease and a clearer picture should form.

    / Feb, 2020 - Journal of Travel Medicine
    quote !f = R0 estimates for SARS have been reported to range between 2 and 5, which is within the range of the mean R0 for COVID-19 found in this review. Due to similarities of both pathogen and region of exposure, this is expected.

    / Feb, 2020 - Journal of Travel Medicine
    quote !g = On the other hand, despite the heightened public awareness and impressively strong interventional response, the COVID-19 is already more widespread than SARS, indicating it may be more transmissible
  ...
  ref 'Ling_et_al_2020
    ...
    quote !a = Suspected or confirmed cases should ideally be isolated in a negative pressure airborne infection isolation room (AIIR) with sufficient air changes (> 12/h) and personnel trained to use personal protective equipment (PPE) for airborne precautions.

    / Use of facemasks with other PPE does not increase the risk of infections in medical professionals in ICU
    quote !b = Within the ICU, and with HCW protected by high-level PPE (including an N95 mask), non-invasive ventilation (NIV) and HFNO use during SARS-CoV and 2009 influenza epidemic was not clearly associated with an increased risk in HCW.

    / Feb, 2020 - Anesthesia critical care & Pain Medicine
    quote !c = Some additional measures to reduce transmission risk include intubation in an AIIR, and limiting non-essential staff to reduced exposure time. Placing bacterial/viral filters in circuits and between the mask and bag valve mask (BVM) resuscitator during manual mask ventilation may serve to reduce viral particle dispersion into the atsmopshere.

    / Feb, 2020 - Anesthesia critical care & Pain Medicine
    quote !d = Intubation in COVID-19 patients should be performed by those experienced in airway management to increase first-pass success. Video laryngoscopy improves intubation rates and allows the operator to be further away from the patient's oropharynx.
  ...
  ref 'Zhang_et_al_2020g
    ...
    / February, 2020 -  Emerging microbes and infections
    quote !a = IgM and IgG titres were relatively low or undetectable in day 0. On day 5, an increase of viral antibodies can be seen in nearly all patients. IgM positive rate increased from 50% (8/16) to 81% (13/16), whereas IgG positive rate increased from 81% (13/16) to 100% (16/16).
  ...
  ref 'Luo_et_al_2020
    head = We examine province-level variability of the basic reproductive numbers of COVID-19 across China.
    ...
    / Feb, 2020 - medRxiv
    quote !a = Changes in weather alone (i.e., increase of temperature and humidity as spring and summer months arrive in the North Hemisphere) will not necessarily lead to declines in COVID-19 case counts without the implementation of extensive public health interventions.
  ...
  ref 'Want_et_at_2020
    head = We collected the cumulative number of confirmed cases of all cities and regions affected by COVID-19 in the world from January 20 to February 4, 2020, and calculated the daily means of the average, minimum and maximum temperatures in January.
    ...
    / February, 2020 - medRxiv
    quote !a = For SARS Cov, When the temperature increased to 38℃ and the relative humidity to 95%, the virus soon lost its activity.

    / February, 2020 - medRxiv
    quote !b = MERS could maintain its activity for a long time both as droplets on solid surface and as aerosol as long as in low-temperature, low-humidity environment.

    / February, 2020 - medRxiv
    quote !c = Temperature has significant impact on the transmission of COVID-19. There might be nonlinear dose-response relationship between the two, indicating that there is a best temperature contributing to its transmission and that low temperature is beneficial to the viral transmission.
  ...
  ref 'Zheng_et_al_2020
    ...
    / Feb, 2020 - medRxiv
    quote !a = We found that most of the indexes relating to organ injuries were negatively correlated with the number of lymphocytes in 2019-nCoV infected patients but not in non-2019-nCoV-infected pneumonia patients, further highlighting the virus infection – rather than the inflammatory reaction – as the possible cause of the multi-organ injury.

    / Feb, 2020 - medRxiv
    quote !b = Another supportive finding is that the difference in the number of monocytes, neutrophils, and NK cells is not significant in our analysis; while theoretically, these innate immune cells are the main player in a “cytokine storm".

    / Feb, 2020 - medRxiv
    quote !c = The most significant correlation happened between the injury indexes and CD4+ Th cell counts. Because CD4+ Th cells are critical for the regulation of both cellular immunity and humoral immunity,17 it is reasonable that these cells are most sensitive to the total anti-virus immune responses.

    / Feb, 2020 - medRxiv
    quote !d = Based on our clinical findings, we should seriously consider using immune-activating treatments for COVID-19 patients, which will be helpful to compensate the dysfunctions in the adaptive immune system and accelerate virus clearance process in vivo. Considering the high possibility of secondary infection induced by excessive inflammation in the severe cases, this strategy should be safer to apply in non-severe patients with the aim to lower the occurrence of severe. cases.
  ...
  ref 'Watanabe_et_al_2020
    ...
    / February, 2020 -  bioRxiv
    quote !a = We also demonstrate that amino-acid diversification indeed occurs at antibody accessible regions on the trimer, which confirms that glycans play a role in occluding specific regions if vulnerability on the glycoprotein.

    / February, 2020 -  bioRxiv
    quote !b = They compared between glycan shield from number of viruses. A strong correlation was observed and viruses historically classified as “evasion strong”59 had significantly elevated glycan shield densities and oligomannose abundance, which underscores the importance of glycan shielding in immune evasion.
  ...
  ref 'Zhang_et_al_2020e
    ...
    / February, 2020 -  Journal of medical virology
    quote !b = We suggest that the current children's RNA‐virus‐related vaccines are the best alternative methods to be used to vaccinate the uninfected people and health care workers.

    / February, 2020 -  Journal of medical virology
    quote !c = Convalescent plasma should be routinely used for the treatment of COVID‐19 infected critically sick patients if it is available.

    / February, 2020 -  Journal of medical virology
    quote !d = The avian IBV vaccine is also another choice for clinical trials if its safety has been approved in monkeys.
  ...
  ref 'Dong_et_al_2020b
    ...
    / Feb, 2020 - bioRxiv
    quote !a =  Children at all ages appeared susceptible to COVID-19, and there was no significant gender difference. However particularly infants, were vulnerable to infection.
    / Feb, 2020 - bioRxiv
    quote !b = This study provides strong evidence for human-to-human transmission as children were unlikely to visit the Huanan Seafood Wholesale Market where the early adult patients were reported to obtain 2019-nCoV.
  ...
  ref 'Zhang_et_al_2020c
    ...
    quote !a = We observed a good correlation between the inhibitory activity of the designed compounds against the isolated proteases, in viral replicons, and in virus-infected Huh7 cells.

    / February, 2020 -  Journal of Medicinal Chemistry
    quote !b = 11r exhibits excellent anti-MERS-CoV activity in virus-infected Huh7 cells. Because of the high similarity between the main proteases of SARS-CoV and the novel BetaCoV/Wuhan/2019, we expect 11r to exhibit good antiviral activity against the new coronavirus as well.
  ...
  ref 'Li_et_al_2020
    ...
    quote !a = Several options can be envisaged to control or prevent emerging infections of 2019-nCoV, including vaccines, monoclonal antibodies, oligonucleotide-based therapies, peptides, interferon therapies and small-molecule drugs. However, new interventions are likely to require months to years to develop.

    / February, 2020 -  Nature Reviews Drug Discovery
    quote !b = Given the available knowledge on their safety profiles, and in some cases efficacy against closely related coronaviruses, repurposing existing antiviral agents is a potentially important near-term strategy to tackle 2019-nCoV.
  ...
  ref 'Kim_et_al_2020
    ...
    / February, 2020 -  Journal of Korean Medical Science
    quote !a = In the early phase of 2019-nCoV pneumonia, chest radiography may miss patients with pneumonia.

    / February, 2020 -  Journal of Korean Medical Science
    quote !b = Lopinavir-ritonavir was used in the first patient transferred to South Korea from Wuhan, on day 4 of illness. The patient’s fever improved by day 11, and their dyspnea subsided by day 14 of illness.

    / February, 2020 -  Journal of Korean Medical Science
    quote !c = Taking travel history is of paramount importance for early detection and isolation of 2019-nCoV cases.
  ...
  ref 'Coutard_et_al_2020
    ...
    quote !a = The genomic sequence of 2019-nCoV indicates that the virus clusters with betacoronaviruses of lineage b.

    / February, 2020 -  Antiviral Research
    quote !b = 2019-nCoV S-protein sequence has a specific furin-like cleavage site absent in lineage b CoV including SARS-CoV sequences.

    / February, 2020 -  Antiviral Research
    quote !c = The furin-like cleavage site in the S-protein of 2019-nCoV may have implications for the viral life cycle and pathogenicity.

    / February, 2020 -  Antiviral Research
    quote !d = Campaigns to develop anti-2019-nCoV therapeutics should include the evaluation of furin inhibitors
  ...
  ref 'Chen_et_al_2020
    ...
    / The Lancet - Feb, 2020
    quote !a = To date, no specific treatment has been proven to be effective for SARS-CoV-2 infection. Apart from supportive care, such as oxygen supply in mild cases and extracorporeal membrane oxygenation for the critically ill patients, specific drugs for this disease are still being researched.

    / The Lancet - Feb, 2020
    quote !b = Management of COVID-19 has mainly focused on infection prevention, case detection and monitoring, and supportive care. However, no specific anti-SARS-CoV-2 treatment is recommended because of the absence of evidence.

    / The Lancet - Feb, 2020
    quote !c = Evidence shows that convalescent plasma from patients who have recovered from viral infections can be used as a treatment without the occurrence of severe adverse events. Therefore, it might be worthwhile to test the safety and efficacy of convalescent plasma transfusion in SARS-CoV-2-infected patients.
  ...
  ref 'Zhou_et_al_2020
    ...
    quote !a = Since the outbreak of severe acute respiratory syndrome (SARS) 18 years ago, a large number of SARS-related coronaviruses (SARSr-CoVs) have been discovered in their natural reservoir host, bats.
  ...
  ref 'Phan_et_al_2020b
    ...
    quote !a = Genomic sequences of SARS-VoV-2 provide evidence of the genetic diversity and rapid evolution of this novel coronavirus.
