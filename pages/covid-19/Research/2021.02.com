feed Feb2021
  ...
  ref 'Emary_et_al_02_04_2021
    ...
    quote !a = 499 participants developed Covid-19infection. 1524 NAAT positive nose/throat swabs were collected. Of these, 323 swabs from 256 participants were successfully sequenced

    / February, 2021 - Preprints with the Lancet
    quote !b = ChAdOx1 nCoV-19 recipients had a significantly lower viral load as represented byminimum PCR Ct value (p<0.0001) and were NAAT positive for a shorter time (p<0.0001) than participants who received the control vaccine.
  ...
  ref 'Voysey_et_al_02_01_2021
    ...
    / February, 2021 - Preprints with Lancet
    quote !a = ChAdOx1 nCoV-19 vaccination programmes aimed at vaccinating a large proportion of the population with a single dose, with a second dose given after a 3 month period is an effective strategy for reducing disease, and may be the optimal for rollout of a pandemic vaccine when supplies are limited in the short term.


  // Recurrent deletions in the SARS-CoV-2 spike glycoprotein drive antibody escape
  doi: https://doi.org/10.1126/science.abf6950
  ref 'McCarthy_et_al_02_03_2021
    head = We and others have reported the acquisition of deletions in the amino (N)-terminal domain (NTD) of the S glycoprotein during long-term infections of often-immunocompromised patients. We have identified this as an evolutionary pattern defined by recurrent deletions that alter defined antibody epitopes.
    ...
    quote !a = Coronaviruses acquire substitutions more slowly than other RNA viruses, due to a proofreading polymerase. In the spike glycoprotein, we find recurrent deletions overcome this slow substitution rate.

    / February, 2021 - Science
    quote !b = Deletion variants arise in diverse genetic and geographic backgrounds, transmit efficiently, and are present in novel lineages, including those of current global concern. They frequently occupy recurrent deletion regions (RDRs), which map to defined antibody epitopes.
  ...
  ref 'Wu_et_al_02_03_2021
    ...
    / February, 2021 - The Lancet
    quote !a = In the safety populations from both phases, any adverse reaction within 28 days after injection occurred in 20 of 100 participants in the 1·5 μg group, 25 of 125 in the 3 μg group, 27 of 123 in the 6 μg group, and 15 of 73 in the placebo group. All adverse reactions were mild or moderate in severity and injection site pain was the most frequently reported event.

    / February, 2021 - The Lancet
    quote !b = As of Aug 28, 2020, eight serious adverse events, considered unrelated to vaccination, have been reported by seven participants.
  ...
  ref 'Logunov_et_al_02_02_2021
    ...
    / February, 2021 - The Lancet
    quote !a = 19866 received two doses of vaccine or placebo and were included in the primary outcome analysis. From 21 days after the first dose of vaccine, 16 of 14964 participants in the vaccine group and 62 of 4902 in the placebo group were confirmed to have COVID-19; vaccine efficacy was 91·6%.

    / February, 2021 - The Lancet
    quote !b = Most reported adverse events were grade 1. 45 of 16427 participants in the vaccine group and 23 of 5435 participants in the placebo group had serious adverse events; none were considered associated with vaccination

    / February, 2021 - The Lancet
    quote !c =  Four deaths were reported during the study (three of 16427 participants in the vaccine group and one of 5435 participants in the placebo group), none of which were considered related to the vaccine.
