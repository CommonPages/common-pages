...
. Triage
  ...
  claim !NeutralizingtitersB1427B1429 = Plasma from vaccinated or convalescent individuals (two doses of Pfizer/BioNTech BNT162b2 or Moderna mRNA-1273) exhibited neutralizing titers, which were reduced 3-6 fold against the B.1.427/B.1.429 variant relative to wildtype pseudoviruses.
    ...
    claim !NTDmutationB1427B1429 = One study observed a complete loss of B.1.427/B.1.429 neutralization for a panel of mAbs targeting the N-terminal domain due to a large structural rearrangement of the NTD antigenic supersite involving an S13I-mediated shift of the signal peptide cleavage site. Several SARS-CoV-2 variants, including the B.1.1.7, B.1.351 and P1 lineages, harbor frequent mutations within the NTD supersite (site i) suggesting ongoing selective pressure from the host humoral immune response.
    -
      'McCallum_et_al_04_01_2021
    ...
    >
      We define an antigenic map of the SARS-CoV-2 NTD and identify a supersite (designated site i) recognized by all known NTD-specific neutralizing mAbs. NTD supersite suggesting ongoing selective pressure and the importance of NTD-specific neutralizing mAbs for protective immunity and vaccine design.
      Neutralizing NTD antibodies protect hamsters from SARS-CoV-2 challenge. Variants of concern have mutations in the NTD that escape neutralization.
      Indeed, several SARS-CoV-2 variants, including the B.1.1.7, B.1.351 and P1 lineages, harbor frequent mutations within the NTD supersite suggesting ongoing selective pressure and the importance of NTD-specific neutralizing mAbs for protective immunity and vaccine design.
     -
  ...
  / S13I/W152C Mutations - B.1.427/B.1.429 - B.1.526
  ...
  / The L18F substitution and the deletion of residue Y144 - - B.1.427/B.1.429
  ...
  claim !Immuneevasion = Several reports revealed that the L452R mutation reduced or abolished neutralizing activity. One study demonstrated that the mutation L452R can escape from human leukocyte antigen (HLA)-24-restricted cellular immunity. The observed L452R-mediated immune evasion of B.1.427/B.1.429 S concurs with previous findings that this substitution reduced the binding or neutralizing activity of some mAbs prior to the description of the B.1.427/B.1.429 variant.
    -
      'McCallum_et_al_04_01_2021
      'McCallum_et_al_04_01_2021.!b
  ...
  claim !ImmuneevasionL452RY453F = We showed direct evidence suggesting that the mutations in the RBM including L452R (in the B.1.427/429 lineage) and Y453F (in the B1.1.298 lineage) potentially escape from the HLA-A24-resticted cellular immunity. Therefore, these variants, particularly those possessing the L452R mutations, such as the B.1.427/429 lineage, can be the potential threat for these countries and regions with predominant HLA-A24 individuals.
    -
      'Motozono_et_al_04_05_2021
      'Motozono_et_al_04_05_2021.!a
  ...
  # L452R results in the largest increase in free energy of the RBD-ACE2 binding complex, predicting stronger virus-cell attachment and, thus, increased infectivity
  ...
  # nother recent study22 has demonstrated that the mutation L452R can escape from human leukocyte antigen (HLA)-24-restricted cellular immunity and can also increase viral infectivity, potentially promoting viral replication.
    ...
    # it was found that out of 52 naturally occurring mutations in the receptor-binding motif residues of RBD that form the interface of direct interaction with ACE2, L452R results in the largest increase in free energy of the RBD-ACE2 binding complex, predicting stronger virus-cell attachment and, thus, increased infectivity


    claim !StrongACE2binding = Studies have suggested that L452R mutation could improve the interaction between spike protein and human angiotensin-converting enzyme 2 (ACE2) receptor, resulting in stronger binding to the receptor and escape from neutralizing antibodies. This in turn might lead to significantly increased infectivity of the L452R variants
  ...
  claim !AdaptiveevolutionL452R = In addition to the two California strains, several independent L452R-carrying lineages have recently emerged across the globe, with over 90% of the isolates reported between December 2020 - February 2021. Such repeatedly emerging hot-spot mutations typically indicate strong positive selection, which might result from the selective pressure of RBD-specific neutralizing Abs. The recent strong positive selection for this mutation possibly reflects viral adaptation to the containment measures or increasing population immunity (to the original viral variants, i.e. the reconvalescents and vaccinated individuals).
    -
      'Tchesnokova_et_al_02_22_2021
      'Tchesnokova_et_al_02_22_2021.!a
      'Tchesnokova_et_al_02_22_2021.!b
  ...
  claim !CAL20CCAL20A = Our study showed that two independent nCoV variants recently emerged in the state of California that carry the L452R mutation in the Spike protein, the already defined and currently dominant CAL.20C as well as the more recently emerged CAL.20A identified here (The newly identified variant derives from the clade 20A). In contrast to CAL.20C that carries two additional to L452R mutations in the Spike protein, L452R is the only mutation found in CAL.20A.
    -
      'Tchesnokova_et_al_02_22_2021
      'Tchesnokova_et_al_02_22_2021.!a
      'Tchesnokova_et_al_02_22_2021.!b
  ...
  claim !CAL20Agorilla = One study found that the SARS-CoV-2 strain that caused the only recorded case of infection in an ape - gorillas in the San Diego Zoo, reported in January 2021 - is CAL.20A.
  -
    'Tchesnokova_et_al_02_22_2021
    'Tchesnokova_et_al_02_22_2021.!h
  ...
  >
    A variant first detected in sequences from India was designated under investigation on 1 April 2021 as VUI-21APR-01 (B.1.617.1). As per GISAID submissions, the B.1.617 lineage has been reported from several countries including UK, USA, Switzerland, Germany, Singapore etc. So far 21 countries have detected the B.1.617 variant, most of which have been reported from India.

  claim !!Mutations = The study investigated the S protein mutations associated with the COVID-19 cases in Maharashtra observed since the month of February 2021. The continuous increase in positivity could be attributed to signature mutations in the spike protein and functionally significant co-occurring triple mutations (L452R, E484Q, P681R). The unique combination of mutations L452R, E484Q and P681R noted in this study is an indication of convergent evolution.
  >
  ...
  claim !NeutralizingB1617 = Convalescent sera of the COVID-19 cases and recipients of BBV152 (Covaxin) were able to neutralize VUI B.1.617. In this study, a drop in neutralization was detected with the B.1.617 variant., However, the reduction of neutralizing capability was limited to 2-fold.
  -
  ...
  >
    ...
    The recent rise in mutational variants of SARS-CoV-2, especially with changes in the Spike protein, is of significant concern due to the potential ability for these mutations to increase viral infectivity, virulence and/or ability to escape protective antibodies.
  ...
  # claim !BeloHorizonte = One study reported that between 28 Feb and 15 Mar 68% of cases were caused by the P.1 lineage in the metropolitan region of Belo Horizonte (MRBH).
  # -
  #   'Moreira_et_al_04_08_2021
  #   'Moreira_et_al_04_08_2021.!b
  ...
  >
    the recurrent emergence of diverse VOC/VOIs sharing multiple mutations at the same genome position emphasizes a pattern of consistent evolutionary convergence in SARS-CoV-2 (21). It is possible that the continuous variant emergence is related to increased virus transmission rates.
