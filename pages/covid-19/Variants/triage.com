...
. Triage
 ...
 #######
  ...
  claim !NTDmutationB1427B1429 = One study observed a complete loss of B.1.427/B.1.429 neutralization for a panel of mAbs targeting the N-terminal domain due to a large structural rearrangement of the NTD antigenic supersite involving an S13I-mediated shift of the signal peptide cleavage site. Several SARS-CoV-2 variants, including the B.1.1.7, B.1.351, P1 and B.1.617 lineages, harbor frequent mutations within the NTD supersite (site i) suggesting ongoing selective pressure from the host humoral immune response.
  -
    'McCallum_et_al_04_01_2021
