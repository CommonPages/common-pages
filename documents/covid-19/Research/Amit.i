. Amit
  ...
  ref 'Fischer_et_al_08_2020
    ...
    / Science Advances — September 2, 2020
    quote !a = In proof-of-principle studies, we compared a variety of commonly available mask types and observed that some mask types approach the performance of standard surgical masks, while some mask alternatives, such as neck fleece or bandanas, offer very little protection.

    / Science Advances — September 2, 2020
    quote !b = Speaking through some masks (particularly the neck fleece) seemed to disperse the largest droplets into a multitude of smaller droplets and considering that smaller particles are airborne longer than large droplets (larger droplets sink faster), the use of such a mask might be counterproductive.

    / Science Advances — September 2, 2020
    quote !c = The performance of the valved N95 mask is likely affected by the exhalation valve, which opens for strong outwards airflow. While the valve does not compromise the protection of the wearer, it can decrease protection of persons surrounding the wearer.
  ...
  ref 'Lai_et_al_2012
    ...
    quote !a =  It was observed that fully sealed facemasks provide the highest protection, while the least protective was the normal wearing.
  ...
  ref 'Sande_et_al_2008
    ...
    quote !a = Any type of general mask use is likely to decrease viral exposure and infection risk on a population level, in spite of imperfect fit and imperfect adherence, personal respirators providing most protection. Masks worn by patients may not offer as great a degree of protection against aerosol transmission.

    / Plos One - July 9, 2008
    quote !b = The duration of wear and the type of activity did not have a significant impact on exposure reduction. Thus, the expected superior protection conferred by a professional FFP2 mask compared to a surgical mask or a home-made mask was maintained when these FFP2 masks were worn by healthy lay people in spite of the increased risk of a poor fit and significant behavioural leakage.

    / Plos One - July 9, 2008
    quote !c = Children were significantly less protected from exposure than adults, which might be related to an inferior fit of the masks on their smaller faces.

    / Plos One - July 9, 2008
    quote !d = The protection conferred by each of the masks appeared stable over time and was not dependent on activity. This suggests that leakage associated with suboptimal fit and compliance was stable over time.

    / Plos One - July 9, 2008
    quote !e = Overall these experiments show that significant protection against influenza transmission upon exposure can be conveyed also for lay people, including children, in spite of imperfect fit and imperfect adherence.
  ...
  ref 'Balazy_et_al_2006
    ...
    quote !a = The N95 filtering face piece respirators may not provide the expected protection level against small virions. Some surgical masks may let a significant fraction of airborne viruses penetrate through their filters, providing very low protection against aerosolized infectious agents in the size range of 10 to 80 nm.
  ...
  ref 'Syed_et_al_2003
    ...
    quote !a = One of the differences apparent between the response to SARS in the East and the West has been perceptions on the use and value of masks as means of personal protection against the infection.

    / Facemask as a symbol
    quote !b = the mask became to SARS what the condom symbolised for HIV/AIDS.
  ...
  ref 'MacIntyre_et_al_2009
    ...
    quote !a = If adherence were greater, mask use might reduce transmission during a severe influenza pandemic.

    / Emerging Infectious Diseases — February, 2009
    quote !b = Although our study suggests that community use of face masks is unlikely to be an effective control policy for seasonal respiratory diseases, adherent mask users had a significant reduction in the risk for clinical infection.
  ...
  ref '!a
    ...
    quote !a = Our findings suggest that a homemade mask should only be considered as a last resort to prevent droplet transmission from infected individuals, but it would be better than no protection.
