...
. Triage
  ...
  > Claim
    SARS-CoV-2 cross-reactive antibodies are non-neutralizing and do not meaningfully protect against SARS-CoV-2 infection or reduce COVID-19 severity.
  -
    'Lv_et_al_06_02_2020
    'Anderson_et_al_11_10_2020

  # Subject protective Immunity
  > Claim
    There is evidence to suggest that prior infection with a coronavirus, including  SARS-CoV-2, confers some level of immunity and  protection against reinfection with the  same viral species. However,the extent and duration of this protection is unknown.
  -
    'Bao_et_al_2020
  ...
  ## subject Symptoms
  # Recently widely reported in India too
  - Psychiatric sequelae - Anxiety disorders, insomnia, and dementia reported
    'Taquet_et_al_11_09_2020
  # Long term consequences
  # Widely Reported everywhere
  - Persistence Fatigue for long duration
  ...
  ## Incubation / Symptomatic Duration
  > Claim
    The mean time SARS-CoV-2 takes to develop symptoms (incubation period) is 5-6 days, with a range of between 1 and 14 days following exposure.
  -
  ...
  >
    There is an association between the severity of an infectious disease and the length of incubation period- covid 19. Patients with a shorter incubation period went on to have more severe disease.
  -
  ...
  > Claim
    Most symptomatic people experience symptoms within two to seven days after exposure, and almost all symptomatic people will experience one or more symptoms before day twelve.
  -
    'Wiersinga_et_al_07_10_2020.!a
    'Lauer_et_al_05_05_2020.!b


  # Can redo the existing claim of children vs adult in antibody response
  > Claim
    Study showing #SARSCoV2 antibody response differs between children & adults. Children generate more antibodies for spike (S), than nucleocapsid (N) protein.
  -
  ...
  - Reports (Distinct Strain, Asymptomatic both times but high viral load 2nd time)
