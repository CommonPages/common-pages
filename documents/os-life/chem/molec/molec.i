...
. molec
  ...
  /// Carbon dioxide (chemical formula CO<sub>2</sub>) is a colorless gas that consists of a carbon atom covalently double bonded to two oxygen atoms. CO<sub>2</sub> is produced by all aerobic organisms when they metabolize carbohydrates and lipids to produce energy by respiration.
  model CarbonDioxide
