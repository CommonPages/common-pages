...
/// Nucleotides are chemical compounds, that serve as the building blocks of the nucleic acids RNA and DNA, both of which are essential biomolecules within all life-forms on Earth.
model Nucleotide
  # https://simple.wikipedia.org/wiki/Nucleotide
