...
article '24
  ...
  index: hide
  line !c
    + c = Isotretinoin treatment did not improve the overall rates of SPTs, recurrences, or mortality in stage I NSCLC. Secondary multivariate and subset analyses suggested that isotretinoin was harmful in current smokers and beneficial in never smokers.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Lippman SM, Lee JJ, Karp DD, et al.: Randomized phase III intergroup trial of isotretinoin to prevent second primary tumors in stage I non-small-cell lung cancer. J Natl Cancer Inst 93 (8): 605-18, 2001.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/11309437">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1093/jnci/93.8.605">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1093/jnci/93.8.605">
