...
article '47
  ...
  index: hide
  line !c
    + c = Chemotherapy for stage IV NSCLC seems to have effectiveness for elderly patients and those with comorbid conditions that is similar to the efficacy seen in randomized trials containing mostly younger, highly selected patients. All suitable patients should be given the opportunity to consider palliative chemotherapy for metastatic NSCLC.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Earle CC, Tsai JS, Gelber RD, et al.: Effectiveness of chemotherapy for advanced lung cancer in the elderly: instrumental variable and propensity analysis. J Clin Oncol 19 (4): 1064-70, 2001.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/11181670">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1200/JCO.2001.19.4.1064">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1200/JCO.2001.19.4.1064">
