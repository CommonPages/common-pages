...
article '3
  ...
  index: hide
  line !c
    + c = In patients surviving an initial lung cancer, the cumulative risk for the development of a second primary lung cancer makes this cancer a common cause of death. The high risk of developing a second lung cancer makes patients with these cancers an important population for study of surveillance strategies and chemoprevention agents.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Johnson BE: Second lung cancers in patients after treatment for an initial lung cancer. J Natl Cancer Inst 90 (18): 1335-45, 1998.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/9747865">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1093/jnci/90.18.1335">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1093/jnci/90.18.1335">
