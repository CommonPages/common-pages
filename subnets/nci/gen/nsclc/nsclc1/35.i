...
article '35
  ...
  index: hide
  line !c
    + c = the number of N2 stations (single vs. multiple N2 stations) was found to be a useful prognostic factor, which can separate completely resected stage IIIA-N2 patients into high and low risk groups regarding both the overall survival and local recurrence.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Ichinose Y, Kato H, Koike T, et al.: Overall survival and local recurrence of 406 completely resected stage IIIa-N2 non-small cell lung cancer patients: questionnaire survey of the Japan Clinical Oncology Group to plan for clinical trials. Lung Cancer 34 (1): 29-36, 2001.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/11557110">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=Overall+survival+and+local+recurrence+of+406+completely+resected+stage+IIIa-N2+non-small+cell+lung+cancer+patients%3A+questionnaire+survey+of+the+Japan+Clinical+Oncology+Group+to+plan+for+clinical+trials.">
