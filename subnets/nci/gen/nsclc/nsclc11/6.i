...
article '6
  ...
  >>>
    ...
    <div class="Citation-text">Ries LA: Influence of extent of disease, histology, and demographic factors on lung cancer survival in the SEER population-based data. Semin Surg Oncol 10 (1): 21-30, 1994 Jan-Feb.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/8115783">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=Influence+of+extent+of+disease%2C+histology%2C+and+demographic+factors+on+lung+cancer+survival+in+the+SEER+population-based+data.">
