...
article '49
  ...
  index: hide
  line !c
    + c = Patients with advanced NSCLC and SD following first-line platinum-based doublet chemotherapy derive a significant OS benefit from maintenance erlotinib therapy.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Coudert B, Ciuleanu T, Park K, et al.: Survival benefit with erlotinib maintenance therapy in patients with advanced non-small-cell lung cancer (NSCLC) according to response to first-line chemotherapy. Ann Oncol 23 (2): 388-94, 2012.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/21610154">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1093/annonc/mdr125">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1093/annonc/mdr125">
