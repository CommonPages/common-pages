...
article '29
  ...
  index: hide
  line !c
    + c = Although the two treatment strategies provided a similar degree of palliation of thoracic symptoms, the difference in survival between the two study arms was of a clinically relevant magnitude.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Bezjak A, Dixon P, Brundage M, et al.: Randomized phase III trial of single versus fractionated thoracic radiation in the palliation of patients with lung cancer (NCIC CTG SC.15). Int J Radiat Oncol Biol Phys 54 (3): 719-28, 2002.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/12377323">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=Randomized+phase+III+trial+of+single+versus+fractionated+thoracic+radiation+in+the+palliation+of+patients+with+lung+cancer+%28NCIC+CTG+SC.15%29.">
