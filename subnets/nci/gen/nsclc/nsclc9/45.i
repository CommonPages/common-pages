...
article '45
  ...
  index: hide
  line !c
    + c = The addition of induction chemotherapy to concurrent chemoradiotherapy added toxicity and provided no survival benefit over concurrent chemoradiotherapy alone. The median survival achieved in each of the treatment groups is low, and the routine use of weekly carboplatin and paclitaxel with simultaneous radiotherapy should be re-examined.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Vokes EE, Herndon JE 2nd, Kelley MJ, et al.: Induction chemotherapy followed by chemoradiotherapy compared with chemoradiotherapy alone for regionally advanced unresectable stage III Non-small-cell lung cancer: Cancer and Leukemia Group B. J Clin Oncol 25 (13): 1698-704, 2007.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/17404369">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1200/JCO.2006.07.3569">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1200/JCO.2006.07.3569">
