...
article '25
  ...
  index: hide
  line !c
    + c = Radical radiation therapy is an effective treatment for small (T1 or &lt; 3 cm) tumors when treated to doses of 65 Gy or more, and should be offered as an alternative to surgery in elderly or infirm patients. New therapeutic strategies to improve the local control rate should be considered for larger tumors, through the use of hyperfractionated treatment, endobronchial &quot;boost&quot; irradiation, and sensitizing chemotherapy agents.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Dosoretz DE, Galmarini D, Rubenstein JH, et al.: Local control in medically inoperable lung cancer: an analysis of its importance in outcome and factors determining the probability of tumor eradication. Int J Radiat Oncol Biol Phys 27 (3): 507-16, 1993.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/8226142">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=Local+control+in+medically+inoperable+lung+cancer%3A+an+analysis+of+its+importance+in+outcome+and+factors+determining+the+probability+of+tumor+eradication.">
