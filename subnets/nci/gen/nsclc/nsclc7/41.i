...
article '41
  ...
  index: hide
  line !c
    + c = Post-SABR survival for early-stage NSCLC is not affected by tumour location. SABR achieves high local control with limited toxicity when appropriate fractionation schedules are used for central tumours.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Senthi S, Haasbeek CJ, Slotman BJ, et al.: Outcomes of stereotactic ablative radiotherapy for central lung tumours: a systematic review. Radiother Oncol 106 (3): 276-82, 2013.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/23462705">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1016/j.radonc.2013.01.004">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1016/j.radonc.2013.01.004">
