...
article '11
  ...
  index: hide
  line !c
    + c = Our results suggest that cryotherapy is an effective method of treatment in patients with ESBC. Due to its relative tolerance compared to surgery, cryotherapy could be proposed as a first-line therapy in this population with high carcinogenic risk.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Deygas N, Froudarakis M, Ozenne G, et al.: Cryotherapy in early superficial bronchogenic carcinoma. Chest 120 (1): 26-31, 2001.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/11451811">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1378/chest.120.1.26">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1378/chest.120.1.26">
