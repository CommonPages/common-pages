...
article '36
  ...
  index: hide
  line !c
    + c = SRT is well tolerated in patients with extensive comorbidity with high local control rates and minimal toxicity. Early outcomes are not inferior to those reported for conventional radiotherapy. In view of patient convenience, such risk-adapted SRT schedules should be considered treatment of choice in patients presenting with medically inoperable Stage I NSCLC.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Lagerwaard FJ, Haasbeek CJ, Smit EF, et al.: Outcomes of risk-adapted fractionated stereotactic radiotherapy for stage I non-small-cell lung cancer. Int J Radiat Oncol Biol Phys 70 (3): 685-92, 2008.</div>
    ...
    <div class="CitationLink" data-href="https://doi.org/10.1016/j.ijrobp.2007.10.053">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1016/j.ijrobp.2007.10.053">
