...
article '2
  ...
  index: hide
  line !c
    + c = Compared with lobectomy, limited pulmonary resection does not confer improved perioperative morbidity, mortality, or late postoperative pulmonary function. Because of the higher death rate and locoregional recurrence rate associated with limited resection, lobectomy still must be considered the surgical procedure of choice for patients with peripheral T1 N0 non-small cell lung cancer.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Ginsberg RJ, Rubinstein LV: Randomized trial of lobectomy versus limited resection for T1 N0 non-small cell lung cancer. Lung Cancer Study Group. Ann Thorac Surg 60 (3): 615-22; discussion 622-3, 1995.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/7677489">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=Randomized+trial+of+lobectomy+versus+limited+resection+for+T1+N0+non-small+cell+lung+cancer.+Lung+Cancer+Study+Group.">
