...
article '5
  ...
  index: hide
  line !c
    + c = A large number of EGFR mutations are found in adenocarcinoma tumor specimens from men and people who smoked cigarettes. If only women who were never smokers were tested, 57% of all EGFR mutations would be missed. Testing for EGFR mutations should be considered for all patients with adenocarcinoma of the lung at diagnosis, regardless of clinical characteristics. This strategy can extend the use of EGFR tyrosine kinase inhibitors to the greatest number individuals with the potential for substantial benefit.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">D'Angelo SP, Pietanza MC, Johnson ML, et al.: Incidence of EGFR exon 19 deletions and L858R in tumor specimens from men and cigarette smokers with lung adenocarcinomas. J Clin Oncol 29 (15): 2066-70, 2011.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/21482987">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1200/JCO.2010.32.6181">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1200/JCO.2010.32.6181">
