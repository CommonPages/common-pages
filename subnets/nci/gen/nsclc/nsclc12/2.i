...
article '2
  ...
  >>>
    ...
    <div class="Citation-text">Ellis PA, Smith IE, Hardy JR, et al.: Symptom relief with MVP (mitomycin C, vinblastine and cisplatin) chemotherapy in advanced non-small-cell lung cancer. Br J Cancer 71 (2): 366-70, 1995.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/7530988">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1038/bjc.1995.74">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1038/bjc.1995.74">
