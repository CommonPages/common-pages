...
article '10
  ...
  index: hide
  line !c
    + c = Although not statistically significant, clinically important differences in the median, 2-, 3-, and 4-year survival rates were observed, with a trend in favor of concurrent chemoradiation therapy, suggesting that is the optimal strategy for patients with locally advanced NSCLC.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Fournel P, Robinet G, Thomas P, et al.: Randomized phase III trial of sequential chemoradiotherapy compared with concurrent chemoradiotherapy in locally advanced non-small-cell lung cancer: Groupe Lyon-Saint-Etienne d'Oncologie Thoracique-Groupe Français de Pneumo-Cancérologie NPC 95-01 Study. J Clin Oncol 23 (25): 5910-7, 2005.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/16087956">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1200/JCO.2005.03.070">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1200/JCO.2005.03.070">
