...
article '2
  ...
  index: hide
  line !c
    + c = The majority of sites showing a carcinoma in situ progressed to invasive carcinoma. A considerable portion of the patients had neoplastic lesions at other bronchial sites. The fluorescence pattern of the bronchial mucosa may reflect early changes that are not found at histopathologic examination, but which may progress to neoplastic growth.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Venmans BJ, van Boxem TJ, Smit EF, et al.: Outcome of bronchial carcinoma in situ. Chest 117 (6): 1572-6, 2000.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/10858385">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1378/chest.117.6.1572">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1378/chest.117.6.1572">
