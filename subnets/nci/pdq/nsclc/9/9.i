...
. 9
  ...
  line !1
    ...
    +=
      \
        ...
        += Standard treatment options for resected/resectable disease include the following: [outline]
        += The preponderance of evidence indicates that postoperative cisplatin combination chemotherapy provides a significant survival advantage to patients with resected NSCLC with occult N2 disease discovered at surgery.
        += The optimal sequence of surgery and chemotherapy and the benefits and risks of postoperative radiation therapy in patients with resectable NSCLC are yet to be determined.
      ...
      \
        ...
        +=
          \
            ...
            +=
              \
                += The role of chemotherapy before surgery in patients with stage III N2 NSCLC has been extensively tested in clinical trials.
          ...
          \
            ...
            += Three trials have evaluated platinum-based combination chemotherapy followed by surgery versus platinum-based chemotherapy followed by radiation therapy (60–69.6 Gy) alone to determine whether surgery or radiation therapy was most efficacious.
              \
                ...
                += Rates of PFS were also similar in both groups. In view of its low morbidity and mortality, it was concluded that radiation therapy should be considered the preferred locoregional treatment for these patients.
  ...
  line !2
    ...
    +=
      \
        ...
        +=
          \
            += The addition of sequential and concurrent chemotherapy to radiation therapy has been evaluated in prospective randomized trials and meta-analyses.
        ...
        += The results from two randomized trials (including RTOG-9410 [NCT01134861]) and a meta-analysis indicate that concurrent chemotherapy and radiation therapy may provide greater survival benefit, albeit with more toxic effects, than sequential chemotherapy and radiation therapy.[Level of evidence: 1iiA]
          \
        ...
        +=
          \
            ...
            += The primary objective was OS. The study was designed as a superiority trial with 80% power to detect an OS HR of 0.74 with a type 1 error of .05.
            += This study randomly assigned 598 patients (arm A, 301; arm B, 297) and treated 555 patients (arm A, 283; arm B, 272).
              ...
              \
                ...
                += Durvalumab is a selective human IgG1 monoclonal antibody that blocks programmed death ligand 1 (PD-L1) binding to programmed death 1 (PD-1) and CD80, allowing T cells to recognize and kill tumor cells.
                  \
                    ...
                    += The most common adverse event of grade 3 or 4 was pneumonia in 4.4% of the patients receiving durvalumab and in 3.8% of the patients receiving placebo.
  ...
  line !3
    ...
    +=
      \
        += Standard treatment options for superior sulcus tumors include the following: Radiation therapy alone. Surgery. Chemoradiation therapy followed by surgery.
        += NSCLC of the superior sulcus, frequently termed Pancoast tumors, occurs in less than 5% of patients.[50,51]
        += Superior sulcus tumors usually arise from the apex of the lung and are challenging to treat because of their proximity to structures at the thoracic inlet.
          ...
          \
            ...
            += In the second trial, 75 patients were enrolled and treated with induction therapy with mitomycin C, vindesine, and cisplatin combined with 45 Gy of radiation therapy.
              \
                ...
                += At 3 years, the DFS rate was 49%, and the OS rate was 61%; at 5 years, the DFS rate was 45%, and the OS rate was 56%.[Level of evidence: 3iiiDi]
  ...
  line !4
    += Standard treatment options for tumors that invade the chest wall include the following: Surgery. Surgery and radiation therapy. Radiation therapy alone. Chemotherapy combined with radiation therapy and/or surgery.
    ...
    += Adjuvant chemotherapy is recommended and radiation therapy is reserved for cases with unclear resection margins.
      \
        += Adjuvant chemotherapy is recommended and radiation therapy is reserved for cases with unclear resection margins.
        += Survival rates were lower in patients who underwent incomplete resection and had mediastinal lymph node involvement.
        += Combined-modality approaches have been evaluated to improve ability to achieve complete resection.