...
model module foundations
  head = Coronaviruses are a group of related RNA viruses that cause diseases in mammals and birds. Coronavirus disease 2019 (COVID-19) is a contagious respiratory and vascular disease caused by the SARS-CoV-2 virus.
