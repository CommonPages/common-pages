...
subject module Transmission
  ...
  subject module Modes
    ...
    subject module Direct
      ...
      subject module Persontoperson
        ...
        / Direct physical contact and touching like embracing, hand-shaking
        ...
        / Interactions for long durations
  ...
  # -------------------------------------------
  subject module TransMechanism
    head = involves interrelation between viral load, viral shedding, viral activity, symptoms, aerosolisation, entry, and onset of synmptoms, and epidemiological factors like R-0 rates of infection, fality, attack etc.
    / Frontiers
    subject Frontiers
      head =
      -- Frontiers (unsorted)
