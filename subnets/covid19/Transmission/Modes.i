...
subject module Modes
  head = nCov-2 is found to spread directly (like interactions in close proximity) from infected patients as well as indirectly (like touching infected surfaces etc).
  --
    Direct
  --
    Indirect
  ...
  subject module Direct
    head = The virus can spread directly from infected person to another person by inhalation of respiratory droplets through air or shairng food, or being in close physical contact for prolonged duration with the infected person.
    --
      Airborne_trans
      SharedFood
    ...
    subject Airborne_trans
      head = The virus can spread through respiratory droplets with virus released into air by infected patients.
    ...
    / Sharing food
    subject SharedFood
      head = Sharing food with an infected patient could also spread the virus providing a channel of direct entry.
      --
        'Ghinai_et_al_04_17_2020
  ...
  subject module OtherModes
    ...
    subject Travelhistory
      head = Many reported cases had a travel history to places like Wuhan.
      --
        'Qian_et_al_03_17_2020
        'Yu_et_al_02_18_2020
        'Zhang_et_al_03_27_2020
