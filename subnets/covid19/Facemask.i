...
subject module Facemask
  ...
  subject Typefacemask
    ...
    subject Clothmask
      ...
      subject Efficacy
        ...
        subject Studies
          head = Even simple cloth facemasks can offer good protection.
  ...
  subject Whyfacemask
    ...
    ########## End of include; contents begin
    / The facemasks have become an important way for stopping spread of any respiratory diseases
    subject SpreadMechanism
      head = The mechanism of spreading in any pandemic will determine the steps taken to handle it. So far studies have shown that Covid19 has following spread mechanisms. The virus spreads from both symptomatic and asymptomatic infected individuals primarily via respiratory droplets and contact of common surfaces and faeces.
      --
        'WHO_06_2020.!a
        'Li_et_al_03_26_2020.!h
        #'Ong_et_al_03_04_2020.!a
        #'Guo_et_al_04_10_2020
    ...
    subject GeneralBenefits
      head = A recent meta-analysis of these observational studies, with the intrinsic biases of observational data, showed that either disposable surgical masks or reusable 12–16-layer cotton masks were associated with protection of healthy individuals within households and among contacts of cases.
      --
      ...
      subject Prevention
         head = Studies of influenza, influenza-like illness, and human coronaviruses (not including COVID-19) provide evidence that the use of a medical mask can prevent the spread of infectious droplets from a symptomatic infected person (source control) to someone else and potential contamination of the environment by these droplets.
  ...
  subject Whofacemask
    ...
    >>>
      We look at four major categories:
  ...
  # Line definitions
    ...
    line 'Asymptomaticdef
      head = Some people infected with the COVID-19 virus do not ever develop any symptoms, although they can shed virus which may then be transmitted to others. One recent systematic review found that the proportion of asymptomatic cases ranged from 6% to 41%, with a pooled estimate of 16% (12%–20%).
