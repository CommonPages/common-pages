...
subject module Mitigation
  ...
  subject module InfectionPrevention
    ...
    subject ProtectiveDevices
      ...
      #
      #         -- Even simple cloth facemasks can offer good protection.
      ...
      #       head =
      #       # The virus spreads from both symptomatic and asymptomatic infected individuals primarily through person-to- person contact and through direct contact with respiratory droplets generated when an infected person coughs or sneezes. Transmission may also occur through fomites in the immediate environment around the infected person. There are also several well-documented examples in which airborne transmission of SARS-CoV-2 appeared.
      #
      #       # Aerosol
      #       --
      #         # 'WHO_06_2020.!a
      ...
      #       >>>
      #         Given that one of the possibility of getting infection is from breathing water droplets, wearing any type of masks can reduce the chances of getting an infection.
      #       --
      #         'Sande_et_al_2008.!a
      #
      #
