...
#     '1
#
# += The process of interim guidance development during emergencies consists of a transparent and robust process of evaluation of the available evidence on benefits and harms, synthetized through expedited systematic reviews and expert consensus- building facilitated by methodologists.
#
# += This process also considers, as much as possible, potential resource implications, values and preferences, feasibility, equity, ethics and research gaps.
#
#
...
#
# += Defined by WHO as “experiencing larger outbreaks of local transmission defined through an assessment of factors including, but not limited to: large numbers of cases not linkable to transmission chains; large numbers of cases from sentinel
# settings, for the general public, and during home care.
#
# += It will be revised as more data become available.
#
#  Background
#
...
#
#
# += This document provides information and guidance on the use of masks in health care settings, for the general public, and during home care.
#
# += The World Health Organization (WHO) has developed specific guidance on IPC strategies for health care settings (2), long-term care facilities (LTCF) (3), and home care. (4)
# --
#      '2
#      '4
#
...
#
# Knowledge about transmission of the COVID-19 virus is accumulating every day.
#
# += COVID-19 is primarily a respiratory disease and the spectrum of infection with this virus can range from people with very mild, non-respiratory symptoms to severe acute respiratory illness, sepsis with organ dysfunction and death.
#
...
#
# += Droplet transmission occurs when a person is in close contact (within 1 metre) with an infected person and exposure to potentially infective respiratory droplets occurs, for example, through coughing, sneezing or very close personal contact resulting in the inoculation of entry portals such as the mouth, nose or conjunctivae
# (eyes).
#
# --
#      '5
...
#
# += The scientific community has been discussing whether the COVID-19 virus, might also spread through aerosols in the absence of aerosol generating procedures (AGPs).
#
...
#
#
# += However, the presence of viral RNA is not the same as replication- and infection- competent (viable) virus that could be transmissible and capable of sufficient inoculum to initiate invasive infection.
#
...
#
# += Studies that investigate transmission should be interpreted bearing in mind the context in which they occurred.
#
#
# += There is also the possibility of transmission from people who are infected and shedding virus but have not yet developed symptoms; this is called pre-symptomatic transmission.
#
...
#
#
# += Furthermore, among two studies which carefully investigated secondary transmission from cases to contacts, one found no secondary transmission among 91 contacts of 9 asymptomatic cases,
# --
#      '33
#
#
# += while the other reported that 6.4  % of cases were attributable to pre-symptomatic transmission.
#
# --
#      '32
#
...
#
#
# += Guidance on the use of masks in health care settings (including long-term care and residential facilities)
#
# += Use of medical masks and respirators to provide care to suspected or confirmed COVID-19 patients.
#
# += This section provides evidence- and consensus-based guidance on the use of medical masks and respirators by health workers providing direct care to COVID-19 patients.
#
#
#
# Available evidence
#
# += WHO’s guidance on the type of respiratory protection to be worn by health workers providing direct care to COVID-19 patients is based on 1) WHO guidelines recommendations on IPC of epidemic- and pandemic-prone acute respiratory infections in health care;
# --
#      '1
#
...
#
#
# += The WHO guidance is similar to recent guidelines of other professional organizations (the European Society of Intensive Care Medicine and the Society of Critical Care Medicine, and the Infectious Diseases Society of America). (38, 39)
# --
#      '38
#      '39
#
...
#      '42
#
# += WHO continues gathering scientific data and evidence on the effectiveness of different masks use and on its potential harms, risks and disadvantages, as well as its combination with hand hygiene, physical distancing and other IPC measures.
#
#  Recommendations
#
...
#
#
# += In conclusion, the great majority of the GDG members confirmed previous recommendations issued by WHO which include that:  in the absence of AGPs2, WHO recommends that health workers providing direct care to COVID-19 patients, should wear a medical mask (in addition to other PPE that are part of droplet and contact precautions); in care settings for COVID-19 patients where AGPs are performed (e.g. COVID-19 intensive and semi- intensive care units), WHO recommends that health workers should wear a respirator (N95 or FFP2 or FFP3 standard, or equivalent).
#
#
# += Note: Respirators are recommended for settings where AGPs are performed.
#
# += Based on values and preferences and if widely available, they could also be used when providing direct care to COVID-19 patients in other settings.
#
# += For additional guidance on PPE, including PPE beyond mask use by health workers, see WHO IPC guidance during health care when COVID-19 infection is suspected
# --
#      '2
#
# += and also WHO guidance on the rational use of PPE.
#
# --
#      '45
#
...
#
#
# += Additional considerations for community care settings: Community health workers should use standard precautions for all patients at all times, with particular emphasis regarding hand and respiratory hygiene, surface and environmental cleaning and disinfection, and the appropriate use of personal protective equipment.
#
...
# Guidance
#
# +=  WHO recommends that persons with any symptoms
# suggestive of COVID-19 should:
#
# --
#      '1
#      '2
...
#      '67
#
# += It is important to note that early symptoms for some people infected with COVID-19 may be very mild and unspecific;  follow instructions on how to put on, take off, and dispose of medical masks and perform hand hygiene;
# --
#      '68
...
# the population: if there is community transmission and there is limited or no capacity to implement other containment measures such as contact tracing, ability to carry out testing and isolate and care for suspected and confirmed cases.
#
# += depending on occupation: e.g ., individuals working in close contact with the public (e.g., social workers, personal support workers, cashiers).
#
...
#
#
# += Feasibility: availability and costs of masks, access to clean water to wash non-medical masks, and ability of mask wearers to tolerate adverse effects of wearing a
# mask.
#
#
# Type of mask: medical mask versus non-medical mask
#
# += Based on these criteria, Table 2 provides practical examples of situations where the general public should be encouraged to wear a mask and it indicates specific target populations and the type of mask to be used according to its purpose.
#
# += The decision of governments and local jurisdictions whether to recommend or make mandatory the use of masks should be based on the above criteria, and on the local context, culture, availability of masks, resources required, and preferences of the population.
#
#
#
...
#  reduced potential exposure risk from infected persons before they develop symptoms;  reduced potential stigmatization of individuals wearing masks to prevent infecting others (source control) or of people caring for COVID-19 patients in non-clinical settings;
# --
#      '70
...
#
# += The likely disadvantages of the use of mask by healthy people in the general public include: potential increased risk of self-contamination due to the manipulation of a face mask and subsequently touching eyes with contaminated hands;
# --
#      '48
#      '49
#
...
#
# += This can create favourable conditions for microorganism to amplify; potential headache and/or breathing difficulties, depending on type of mask used;  potential development of facial skin lesions, irritant dermatitis or worsening acne, when used frequently for long hours;
# --
#      '50
#
...
#
# += These masks are tested for their ability to block droplets (3 micrometres in size; EN 14683 and ASTM F2100 standards) and particles (0.1  micrometre in size; ASTM F2100 standard only).
#
...
#
# += Few of these combinations have been systematically evaluated and there is no single design, choice of material, layering or shape among the non- medical masks that are available.
#
...
#
#
# Type of materials: filtration efficiency (FE), breathability of single layers of materials, filter quality factor
#
...
#
# += Filtration efficiency is dependent on the tightness of the weave, fibre or thread diameter, and, in the case of non- woven materials, the manufacturing process (spunbond, meltblown, electrostatic charging).
# --
#      '49
#      '72
#
...
#
# += Breathability is the ability to breathe through the material of the mask.
#
...
#
#
# += The filter quality factor known as “Q” is a commonly used filtration quality factor; it is a function of filtration efficiency (filtration) and breathability, with higher values indicating better overall efficiency.
# --
#      '76
...
#
# += The innermost layer of the mask is in contact with the wearer’s face.
#
# += The outermost layer is exposed to the environment.
# --
#      '78
#
...
# --
#      '73
# += It is important to note that with more tightly woven materials, as the number of layers increases, the breathability may be reduced.
#
# += A quick check for breathability may be performed by attempting to breathe, through the mouth, and through the multiple layers.
#
#
...
# Coating of fabric
#
# += Coating the fabric with compounds like wax may increase the barrier and render the mask fluid resistant; however, such coatings may inadvertently completely block the pores and make the mask difficult to breathe through.
#
# += In addition to decreased breathability unfiltered air may more likely escape the sides of the mask upon exhalation.
#
...
#
#
# += WHO is collaborating with research and development partners and the scientific community engaged in textile engineering and fabric design to facilitate a better understanding of the effectiveness and efficiency of non- medical masks.
#
...
#
# += Research is also needed on non-medical mask use by children and other medically challenging persons and settings as mentioned above.
#
#
# += Table 4 provides a summary of guidance and practical considerations on the composition, construction and management of non-medical masks.
#
# Alternatives to non-medical masks for the general public
#
# += In the context of non-medical mask shortage, face shields may be considered as an alternative noting that they are inferior to mask with respect to prevention of droplet transmission.
#
...
#
#
# += Guidance on the use of medical masks for the care of COVID-19 patients at home
# WHO provides guidance on how to care for patients with confirmed and suspected COVID-19 at home when care in a health facility or other residential setting is not possible.
# --
#      '4
#
...
#  be isolated in a medical facility if confirmed, or self- isolate at home if isolation in a medical or other designated facility is not indicated or not possible; perform hand and respiratory hygiene frequently; keep a distance of at least 1 metre (3.3 feet) from other people;  wear a medical mask as much as possible; the mask should be changed at least once daily.
#
# += Persons who cannot tolerate a medical mask should rigorously apply respiratory hygiene (i.e.) cover mouth and nose with a disposable paper tissue when coughing or sneezing and dispose of it immediately after use or use a bent elbow procedure and then perform hand hygiene); limit movement and minimize shared space; avoid contaminating surfaces with saliva, sputum or respiratory secretions; improve airflow and ventilation in their living space by opening windows and doors as much as possible;  ensure adequate cleaning and disinfection of touch surfaces, near where the patient is being cared for, such as bedside tables, bedframes, and other bedroom furniture; electronic touchscreens, keyboards, and controls; and bathroom fixtures.
#
#
# += Caregivers or those sharing living space with people with suspected COVID-19 or with mild COVID-19 symptoms should:
#
#  perform hand hygiene according to the 5 Moments of Hand Hygiene,
# --
#      '80
# += using an alcohol-based handrub if hands are not visibly dirty or soap and water when hands are visibly dirty; keep a distance of at least 1 m from the affected person when possible; wear a medical mask when in the same room as the affected person; dispose of any material contaminated with respiratory secretions (disposable tissues) immediately after use and then perform hand hygiene;  improve airflow and ventilation in the living space by opening windows as much as possible; ensure adequate cleaning and disinfection of touch surfaces in the patient’s room, such as bedside tables, bedframes and other bedroom furniture; electronic touchscreens, keyboards, and controls; and bathroom fixtures.
#
#
# Guidance on mask management
#
# += For any type of mask, appropriate use and disposal are essential to ensure that they are as effective as possible and to avoid any increase in transmission.
#
#
# += WHO offers the following guidance on the correct use of masks, derived from best practices in health care settings:  perform hand hygiene before putting on the mask; place the mask carefully, ensuring it covers the mouth and nose, adjust to the nose bridge, and tie it securely to minimize any gaps between the face and the mask; avoid touching the mask while wearing it; remove the mask using the appropriate technique: do not touch the front of the mask but untie it from behind.
#
#
# += after removal or whenever a used mask is inadvertently touched, clean hands with an alcohol-based handrub, or soap and water if hands are visibly dirty;  replace masks as soon as they become damp with a new clean, dry mask; do not re-use single-use masks; discard single-use masks after each use and dispose of them immediately upon removal.
#
#
...
#
# += Otherwise, this interim guidance document will expire 2 years after the date of publication.
#
#
#
#
