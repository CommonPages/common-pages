. Amit
  ...
  ref 'Fischer_et_al_08_2020
    ...
    quote !a = The premise of protection from infected persons wearing a mask is simple: wearing a face mask will reduce the spread of respiratory droplets containing viruses.
  ...
  ref 'Lai_et_al_2012
    ...
    quote !b = It was also observed that the reduction of exposure decreases with increasing emission velocity and emission duration, and with decreasing separation distance between source and susceptible manikins.
  ...
  ref 'Balazy_et_al_2006
    ...
    quote !b = It should be noted that the surgical masks are primarily designed to protect the environment from the wearer, whereas the respirators are supposed to protect the wearer from the environment.
  ...
  ref 'Macintyre_et_al_2009
    ...
    quote !a = Although our study suggests that community use of face masks is unlikely to be an effective control policy for seasonal respiratory diseases, adherent mask users had a significant reduction in the risk for clinical infection.
    / Facemasks might be potentially useful only when large adherence
    quote !b = we found that distributing masks during seasonal winter influenza outbreaks is an ineffective control measure characterized by low adherence, results indicate the potential efficacy of masks in contexts where a larger adherence may be expected,
