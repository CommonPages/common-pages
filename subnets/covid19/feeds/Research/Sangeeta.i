feed Sangeeta
  ...
  article 'Carraturo_et_al_06_09_2020
    ...
    let !a self assert = The same consideration could be made for the risk coming from potentially contaminated food, for which Coronavirus persistance was reported for not more than 72 h of storage at 4 °C

    / June, 2020 - Environmental Pollution
    let !b self assert = On inanimate surfaces, strains of Coronavirus genus are capable to surviving up to nine days, but result extremely labile, being inactivated with really low concentrations of disinfectants.

    / June, 2020 - Environmental Pollution
    let !c self assert = A prolonged exposure to contaminated environmental sources, such as the exploitation of air pollutants (e.g., PM10), the extended contact with aerosols produced from wastewater and surface water plants treatment, the inadequate detergency processes of food and surfaces, may potentially lead to an augmented transmission risk, also in non immunocompromised individuals.
  ...
  article 'Luoma_et_al_07_07_2008
    ...
    let !a self assert = In this study, resuspension from the floor is indicated by the higher impacts found at low (0.4 m) heights for the larger (5–25 mm) particles, which are most readily resuspended (Thatcher and Layton, 1995). Impacts might be considerably larger in rooms with carpets, dirty floors, etc.

    / July, 2008 - Indoor Air
    let !b self assert =  Additional particle sources associated with occupants besides resuspension include particle shedding from people, e.g., dispersal of skin cells, fibers, and other particles. The effect of putting on a sweater near a monitoring site was quite dramatic
  ...
  article 'Yang_et_al_03_30_2020
    ...
    let !a self assert = In this case, for the first time we report small volumes of pleural effusion in both lungs in a non-severe patient of COVID-19.

    / February, 2020 - medRxiv
    let !b self assert = 9 patients were tested RT-PCR positive at admission while only 5 patients were chest CT scan positive at admission, indicating that RT-PCR has a higher sensitivity than chest CT scans in diagnosing COVID-19 in our study.
  ...
  article 'Dyal_et_al_05_08_2020
    ...
    let !a self assert = Solutions to structural and operational challenges that some facilities adopted included adjusting start and stop times of shifts and breaks to increase physical distance between workers. Outdoor break areas were added at some facilities to decrease contact between workers. Some facilities installed physical (e.g., plexiglass) barriers between workers; however, this was not practical for all worker functions. Symptom and temperature screening of workers was newly instituted in some facilities and improved in others.

    / May, 2020 - MMWR Morb Mortal Wkly Rep.
    let !b self assert = Changing transportation to and from the facilities to increase the number of vehicles and reduce the number of passengers per vehicle helped maintain physical distancing in some facilities.
  ...
  article 'Burke_et_al_05_03_2020
    ...
    / May, 2020 - medRxiv
    let !a self assert = The secondary attack rate among household members, all of whom had at least 1 respiratory sample tested, was 13%.
  ...
  article 'Setti_et_al_04_17_2020
    ...
    / April, 2020 - medRxiv
    let !a self assert = The infection rate of disease has been higher in Milan, (1.35 million inhabitants, Northern Italy) than in Rome (2.87 million inhabitants, Southern Italy), even if there has not been a substantial difference in urban management and social confinement as well as in ageing index of the two populations.

    / April, 2020 - medRxiv
    let !b self assert = In Milan, the average growth rate before the lockdown was significantly higher than Rome (0.34 vs. 0.27 per day, with a doubling time of 2.0 days vs. 2.6), suggesting a basic reproductive number R0>6.0, comparable with the highest values estimated for China.
  ...
  article 'Bourouiba_et_al_03_26_2020
    ...
    / March, 2020 - JAMA
    let !a self assert = Peak exhalation speeds can reach up to 33 to 100 feet per second (10-30 m/s), creating a cloud that can span approximately 23 to 27 feet (7-8 m). Protective and source control masks, as well as other protective equipment, should have the ability to repeatedly withstand the kind of high-momentum multiphase turbulent gas cloud that may be ejected during a sneeze or a cough and the exposure from them. Currently used surgical and N95 masks are not tested for these potential characteristics of respiratory emissions

    / March, 2020 - JAMA
    let !b self assert = Given the turbulent puff cloud dynamic model, recommendations for separations of 3 to 6 feet (1-2 m) may underestimate the distance, timescale, and persistence over which the cloud and its pathogenic payload travel, thus generating an underappreciated potential exposure range for a health care worker. For these and other reasons, wearing of appropriate personal protection equipment is vitally important for health care workers caring for patients who may be infected, even if they are farther than 6 feet away from a patient.

    / March, 2020 - JAMA
    let !c self assert = Given various combinations of an individual patient’s physiology and environmental conditions, such as humidity and temperature, the gas cloud and its payload of pathogen-bearing droplets of all sizes can travel 23 to 27 feet (7-8 m).

    / March, 2020 - JAMA
    let !d self assert = The degree and rate of evaporation depend strongly on ambient temperature and humidity conditions, but also on the inner dynamics of the turbulent puff cloud coupled with the composition of the liquid exhaled by the patient.
  ...
  article 'Wei_et_al_09_02_2016
    ...
    let !a self assert = Displacement ventilation may not be applicable to hospital rooms where respiratory infection is a concern.

    / September, 2016 - American Journal of Infection Control
    let !b self assert = Direct exposure to the expired fine droplets or droplet nuclei results in short-range airborne transmission.

    / September, 2016 - American Journal of Infection Control
    let !c self assert = Deposition of droplets and direct personal exposure to expired large droplets can lead to the fomite route and the droplet-borne route, respectively.
  ...
  article 'Zhang_et_al_04_07_2020
    ...
    let !a self assert = The timescales over which data should be collected to assess the transmission risk during close contact events are much shorter than those required for the distant airborne or fomite routes.
  ...
  article 'Gaffney_et_al_08_21_2020
    ...
    let !a self assert = Among teachers, 39.8% had definite and 50.6% had definite or possible risk factors for severe COVID-19 illness.

    / August, 2020 - Annals of Internal Medicine
    let !b self assert = The prevalence of risk factors was similar among adults living with younger versus older children

    / August, 2020 - Annals of Internal Medicine
    let !c self assert = Adults living with children in low-income households were more likely to be at risk than those in higher-income households, as were those residing with Black children; adults living with Asian children or children of other races/ethnicities were at lowest risk.

    / August, 2020 - Annals of Internal Medicine
    let !d self assert = The prevalence of most risk factors was similar among nonteacher workers, although more were smokers; 41.4% had any definite risk factors, and 55.8% had definite or possible risk factors.
  ...
  article 'Bean_et_al_07_01_2020
    ...
    let !a self assert = Measurable quantities of influenza A virus were transferred from stainless steel surfaces to hands for 24 hr and from tissues to hands for up to 15 min.

    / July, 2020 - J Infect Dis.
    let !b self assert = Virus survived on hands for up to 5 min after transfer from the environmental surfaces.
  ...
  article 'Chen_et_al_08_01_2020
    ...
    let !a self assert = Short-range airborne transmission is dominant beyond 0.2 m for talking and 0.5 m for coughing. Within the 2-m interpersonal distance, the shortest distance is travelled by droplets of approximately 112.5–225 μm in size for talking and 175–225 μm for coughing.

    / August, 2020 - Building and Environment
    let !b self assert = The smaller droplets follow the indoor air stream, whilst the larger droplets are dominated by their inertia and travel a longer distance.

    / August, 2020 - Building and Environment
    let !c self assert = The large droplet route only dominates when the droplets are larger than 100 μm, within 0.2 m for talking and 0.5 m for coughing.

    / August, 2020 - Building and Environment
    let !d self assert = For the direct face-to-face configuration, exhaled air streams begin to cover the nostrils of the susceptible person from 0.2 to 0.3 m and the eyes from 0.4 to 0.5 m. While talking, more droplets are deposited on the eyes at long distances due to a larger jet trajectory curvature. Exposure decreases as the interpersonal distance increases for both large droplet and short-range airborne sub-routes

    / August, 2020 - Building and Environment
    let !e self assert = The large droplet route contributes less than 10% of exposure when the droplets are smaller than 50 μm and when the subjects are more than 0.3 m apart, even while coughing.
