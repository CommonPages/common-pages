...
feed March2020
  ...
  article 'Conti_et_al_03_14_2020
    ...
    let !a self assert = When COVID-19 infect the upper and lower respiratory tract it can cause mild or highly acute respiratory syndrome with consequent release of pro-inflammatory cytokines, including interleukin (IL)-1β and IL-6. The binding of COVI-19 to the Toll Like Receptor (TLR) causes the release of pro-IL-1β which is cleaved by caspase-1, followed by inflammasome activation and production of active mature IL-1β which is a mediator of lung inflammation, fever and fibrosis. Suppression of pro-inflammatory IL-1 family members and IL-6 have been shown to have a therapeutic effect in many inflammatory diseases, including viral infections.


  # Origin
  // Evolutionary origins of the SARS-CoV-2 sarbecovirus lineage responsible for the COVID-19 pandemic
  doi: https://doi.org/10.1101/2020.03.30.015008
  article 'Boni_et_al_03_31_2020
    ...
    / March, 2020 - bioRxiv
    let !a self assert = Although the human ACE2-compatible receptor binding domain was very likely to have been present in a bat sarbecovirus lineage that ultimately lead to SARS-CoV-2, this RBD sequence has thus far only been found in a few pangolin viruses.

    / March, 2020 - bioRxiv
    let !b self assert = Despite intensified characterization of sarbecoviruses since SARS, the lineage giving rise to SARS-CoV-2 has been circulating unnoticed for decades in bats and been transmitted to other hosts such as pangolins.
  ...
  # transmission, Closed environment
  ...
  article 'Nishiura_et_al_2020c
    ...
    >>> Results
      Of the 110 cases examined, 27 (24.6%) were primary cases who generated secondary cases. The odds that a primary case transmitted COVID-19 in a closed environment was 18.7 times greater compared to an open-air environment (95% confidence interval [CI]: 6.0, 57.9).
  ...
  article 'XavierLescure_et_al_2020
  ...
  article 'Guo_et_al_2020
    ...
    let !a self assert = Upon virus genome sequencing, the COVID-19 was analyzed throughout the genome to Bat CoV RaTG13 and showed 96.2% overall genome sequence identity, suggesting that bat CoV and human SARS-CoV-2 might share the same ancestor, although bats are not available for sale in this seafood market.

    / March, 2020 - Military Medical Research
    let !b self assert = Besides, protein sequences alignment and phylogenetic analysis showed that similar residues of receptor were observed in many species, which provided more possibility of alternative intermediate hosts, such as turtles, pangolin and snacks.

    / March, 2020 - Military Medical Research
    let !c self assert = Compared with the known SARS-CoV and MERS-CoV genome, SARS-CoV-2 is closer to the SARS-like bat CoVs in terms of the whole genome sequence. Most genomic encoded proteins of SARS-CoV-2 are similar to SARS-CoVs, as well as exist certain differences.
  ...
  article 'Moriyama_et_al_2020
    ...
    let !a self assert = By virtue of being exposed to ambient air by breathing, the nasal and tracheal mucosal surface of the respiratory tract is affected by ambient temperature and the water content of the inhaled air. Inhalation of dry air causes epithelial damage, MCC impairment, and increased mucin production. Impaired ISG expression and tissue repair and increased viral burden and mortality after influenza virus infection have been proven in mice exposed to 7 days of low RH of10–20%. Devastating disease course following dry air exposure is mediated by inflammasome caspase activation.

    / March, 2020 - Annual Review of Virology
    let !b self assert = Similarly, inhalation of cold ambient air impairs MCC and increases mucin production. Lower temperature impairs type I IFN-mediated and IFN-independent antiviral defense mechanisms after rhinovirus infection.

    / March, 2020 - Annual Review of Virology
    let !c self assert = In contrast, exposure of mice to heat wave–level high temperature dampens virus-specific adaptive immune responses after influenza virus infection. The animal studies demonstrate a dramatic effect of environmental conditions on every aspect of host response to respiratory infection and disease.

    / March, 2020 - Annual Review of Virology
    let !d self assert = The intervention studies in school and nursery children, office workers, and army recruits have shown that increasing humidity from low to median range reduced respiratory infection rates and absenteeism.

    / March, 2020 - Annual Review of Virology
    let !e self assert = Given that the expression of the receptor for both SARS-CoV-2 and SARS-CoV, angiotensin-converting enzyme 2, appears to be concentrated in a small population of type II alveolar cells, we speculate that the low humidity and temperature environment would promote the viability of SARS-CoV-2 in the droplets and impaired ciliary clearance and innate immune defense, for robust access to the deep lung tissue and rapid transmission between infected individuals.

    / March, 2020 - Annual Review of Virology
    let !f self assert = Since the respiratory airways, where the type I and II alveolar cells are located, are not reachable by respiratory droplets with a diameter of more than 5 micrometers, it appears likely that at least the severe cases of COVID-19 with viral pneumonia are the result of airborne transmission events.

    / March, 2020 - Annual Review of Virology
    let !g self assert = A recent study that examined province-level variability of the basic reproductive numbers of COVID-19 across China found that not only dry and cold locations experience high viral spread, but certain locations with high AH also have higher viral transmission within the population. The precise relationship between temperature, humidity, and COVID-19 will become more evident as the Northern Hemisphere reaches the summer months

    / March, 2020 - Annual Review of Virology
    let !h self assert = Seasonal changes in the environmental factors can affect not only local defense mechanisms but also systemic physiological changes. Thermoneutral temperature housing potentiates antitumor immunity and GVHD onset in mice. In addition, a short daylight period and consequent deficiency of vitamin D impair nonspecific immune responses. In conclusion, the combination of low humidity, temperature, and sunlight may trigger an impairment of the local and systemic antiviral defense mechanisms, leading to the increased host susceptibility to the respiratory viruses in winter.

    / March, 2020 - Annual Review of Virology
    let !i self assert = Collectively, we can begin to assemble the factors that promote viral spread and disease in the winter months for cold and influenza viruses. However, other respiratory virus infections peak in spring or summer. One of the possible explanations is the replication conflict among respiratory viruses. Co-infection of winter respiratory viruses and spring respiratory viruses in the animal model may provide insights into the unknown mechanisms of spring-to-summer epidemics.

    / March, 2020 - Annual Review of Virology
    let !j self assert = Another unresolved issue is the observation that even in the highly controlled environment of the animal housing setting (22.2°C, 50% RH, controlled light/dark cycle) using the same viral stock, rate of transmission of influenza virus was higher when the experiments were carried out in the winter (November to April, 58.2%) versus summer (May to October, 34.1%). Thus, in addition to temperature, lighting, and humidity, there may be other environmental factors controlled by the seasons that contribute to higher levels of influenza virus infections in the winter months.

    / March, 2020 - Annual Review of Virology
    let !k self assert = In addition to vaccines and antiviral drugs, nonpharmaceutical interventions to prevent respiratory infections are gaining attention. Lifestyle (eating healthy, sleeping more than 7 h/day) and hygiene practices (washing hands, wearing facemasks) are known to increase antimicrobial resistance and prevent transmission, respectively (118–121). In addition to these measures, we might consider controlling the indoor environment to combat respiratory infections. Such interventions with humidifiers have been realized since the 1960s with promising results

    / March, 2020 - Annual Review of Virology
    let !l self assert = More recently, a study in Minnesota found that humidifying preschool classrooms during January to March to ∼45% RH results in a significant reduction in the total number of influenza virus and viral genome copies found in the air and on objects compared to control classrooms. Such nonpharmaceutical interventions can be combined with vaccination strategies to achieve better prevention of respiratory viral infections.
...
# Tag - Pandemic
  ...
  article 'Anderson_et_al_2020
    ...
    / Nature Medicine - March 17, 2020
    let !c self assert = We identify two notable genomic features of SARS-CoV-2: (i) SARS-CoV-2 appears to be optimized for binding to the human receptor ACE2; and (ii) the spike protein of SARS-CoV-2 has a functional polybasic (furin) cleavage site at the S1–S2 boundary through the insertion of 12 nucleotides, which additionally led to the predicted acquisition of three O-linked glycans around the site.

    / Nature Medicine - March 17, 2020
    let !d self assert = Instead, we propose two scenarios that can plausibly explain the origin of SARS-CoV-2: (i) natural selection in an animal host before zoonotic transfer; and (ii) natural selection in humans following zoonotic transfer.
