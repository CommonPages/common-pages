...
feed June2020
  ...
  ref 'Horve_et_al_06_28_2020
    ...
    / June, 2020 - medRxiv
    let !a self assert = Although no known transmission events were determined to be associated with these specimens, the findings suggest the potential for HVAC systems to facilitate transmission by environmental contamination via shared air volumes with locations remote from areas where infected persons reside.
  ...
  article 'Meinhardt_et_al_06_04_2020
    ...
    / June, 2020 - bioRxiv
    let !h self assert = The detection of - compared to values measured in the lower respiratory tract - persistently high levels of SARS-CoV-2 RNA in the olfactory mucosa (124% as mean value compared to lower respiratory tract) up to 53 days after initial symptoms, including the detection of sgRNA suggests that olfactory mucosa remains a region of continuous SARS-CoV-2 replication and persistence, thus enabling a constant viral replenishment for the CNS.

    / June, 2020 - bioRxiv
    let !i self assert = In line with our findings there is a comparable SARS-CoV-2 infection gradient from the nose to the lungs which is paralleled by expression of the receptor molecule ACE228. Although this remains to be speculation and widespread dysregulation of homeostasis of cardiovascular, pulmonal and renal systems has to be regarded as the leading cause in fatal COVID-19 cases, previous findings of SARS-CoV infection and other coronaviruses in the nervous system as well as the herein described presence of SARS-CoV-2 RNA in the medulla oblongata comprising the primary respiratory and cardiovascular control center bring to mind the possibility that SARS-CoV2  infection, at least in some instances, can aggravate respiratory or cardiac problems - or even cause failure - in a CNS-mediated manner.

     / June, 2020 - bioRxiv
     let !j self assert = Even when following distinct routes upon first CNS entry and - based on our findings - in the absence of clear signs of widespread distribution of SARS-CoV-2 in the CNS (i.e. no signs of meningitis/encephalitis in COVID-19 cases), it cannot be excluded that the virus may spread more widely to other brain regions, thus eventually contributing to a more severe or even chronic disease course, depending on various factors such as the time of virus persistence, viral load, and immune status, amongst others.
  ...
  article 'Daly_et_al_06_05_2020
    ...
    / June, 2020 - bioRxiv
    let !a self assert = A striking difference in the S protein of SARS-CoV-2 and SARS-CoV is the presence, in the former, of a polybasic sequence motif, RRAR, at the S1/S2 boundary. It provides a cleavage site for a proprotein convertase, furin, a membrane-bound host cell protease.

    / June, 2020 - bioRxiv
    let !a1 self assert = We noticed that the C-terminus of the S1 protein generated by furin has a polybasic amino acid sequence (682RRAR685), that conforms to a [R/K]XX[R/K] motif, termed the ‘C-end rule’ (CendR). CendR motifs bind to neuropilin-1 (NRP1) and NRP2, dimeric transmembrane receptors that regulate pleiotropic biological processes, including axon guidance, angiogenesis and vascular permeability.

    / June, 2020 - bioRxiv
    let !b self assert = That deletion of the terminal 682RRAR685 residues reduced S protein binding indicated the association largely depended on the CendR motif. Residual binding was observed with the ΔRRAR mutant indicating an additional CendR-independent association between Nrp1 and the S1 protein.

    / June, 2020 - bioRxiv
    let !c self assert = To establish the functional relevance of this interaction, we first generated HeLa wild type and NRP1 knock out cell lines stably expressing ACE2, designated as HeLaWT+ACE2 and HeLaNRP1KO+ACE2, respectively. Infection was visualized and quantified by staining with an anti-SARS nucleocapsid (N) polyclonal antibody. The percentage of infected cells was 73% lower in the HeLaNRP1KO+ACE2 cells compared to HeLaWT+ACE2 cells.

    / June, 2020 - bioRxiv
    let !d self assert = We also noted that SARS-CoV-2-infected HeLaWT+ACE2 cells displayed a distinct multi-nucleated syncytia cell pattern, as reported by others. Of infected HeLaWT+ACE2 cells, the majority (83%) formed syncytia while in HeLaNRP1KO+ACE2 cells this multi-nucleated cell phenotype was less prevalent. Together these data establish that NRP1 promotes SARS-CoV-2 infection.

    / June, 2020 - bioRxiv
    let !e self assert = Based on this model, we investigated whether two key residues (R685 of S1 and T316 of NRP1) contributed to the interaction between S1 and NRP1. Site-directed mutagenesis of R685 of S1493-685 to aspartic acid reduced S1 association with the NRP1 b1 domain by greater than 75 %. Site-directed mutagenesis of T316 to arginine within mCherry-b1 reduced association with GFP-S1493-685, morethan 80%, consistent with its inhibitory impact on VEGF-A164 binding.

    / June, 2020 - bioRxiv
    let !f self assert = To evaluate the interaction of NRP1 with trimeric S on the surface of virions, we incubated vesicular stomatitis virus (VSV) pseudoviral particles harbouring SARS-CoV-2 S protein with wild type mCherry-b1 or mCherry-b1(T316R) immobilised on mCherry-nanotrap beads. Wild type mCherry-b1 immunoprecipitated proteins that could correspond to processed forms of S1, whereas the T316R mutant did not.

    / June, 2020 - bioRxiv
    let !g self assert =  When these cells were infected with SARS-CoV-2, viral infection was significantly enhanced in cells expressing NRP1-GFP compared toGFP control, whereas cells expressing the T316R mutant failed to rescue infection. This established that the SARS-CoV-2 S1 CendR (682RRAR685) and NRP1 interaction promotes infection.

    / June, 2020 - bioRxiv
    let !h self assert =  All three monoclonal antibodies bound to the NRP1 b1b2 domain but only mAb#3 bound to the CendR-binding pocket, as defined by a reduced ability to bind to a b1b2 mutant that targets residues (S346, E348, T349) at the opening of the binding pocket12. All three monoclonal antibodies displayed staining by immunofluorescence in NRP1-expressing PPC-1 human primary prostate cancer cells but not in M21 human melanoma cells that do not express NRP1.

    / June, 2020 - bioRxiv
    let !i self assert = Using mAb#3 and a control monoclonal antibody targeting avian influenza A virus (H11N3) hemagglutinin we found that mAb#3 inhibited SARS-CoV-2 infection of Caco-2 and Calu-3 cells by 38%.

    / June, 2020 - bioRxiv
    let !j self assert = A SARS-CoV-2 virus with a natural deletion of the S1/S2 furin cleavage site demonstrated attenuated pathogenicity in hamster models, causing less alveolar damage. NRP1 binding to the CendR-motif in S1 is thus likely to play a role in the increased pathogenicity of SARS-CoV-2 compared with SARS-CoV. The interaction between S1 and NRP1 can be reduced by monoclonal antibodies that bind to the CendR-binding pocket of NRP1 b1. Disrupting CendR-peptide binding to neuropilins by antibodies and oligopeptide/peptidomimetics has been recognised as a potential anti-cancer strategy, and the same approach may provide a route to COVID-19 therapies.

    / June, 2020 - bioRxiv
    let !k self assert = Interstingly, gene expression analysis of lung tissue from COVID-19 patients recently revealed an up-regulation of NRP1 and NRP2.
  ...
  article 'Woloshin_et_al_06_05_2020
    ...
    / June, 2020 - The New England Journal of Medicine
    let !g self assert = Shows how the post-test probability of infection varies with the pretest probability for tests with low (70%) and high (95%) sensitivity. The threshold highlights why very sensitive diagnostic tests are needed. With a negative result on the low-sensitivity test, the threshold is exceeded when the pretest probability exceeds 15%, but with a high-sensitivity test, one can have a pretest probability of up to 33% and still, assuming the 5% threshold, be considered safe to be in contact with others.
  ...
  article 'Weissleder_et_al_06_03_2020
    ...
    / June, 2020 - Science Translational Medicine
    let !w self assert = Containing COVID-19 will likely require combinations and concomitant use of the different types of diagnostic tests discussed above. To be successful, these assays will need to be deployed in such a way that broad and repeated testing becomes routine.
