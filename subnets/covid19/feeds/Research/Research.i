...
feed Research
  ...
  ref 'Wadhera_et_al_2020
    ...
    let !a self assert = The Bronx, which has the highest proportion of racial/ethnic minorities, the most persons living in poverty, and the lowest levels of educational attainment had higher rates of hospitalization (634) and death (224) related to COVID-19 than the other 4 boroughs.

    / April, 2020 - JAMA Network
    let !b self assert = In contrast, the rates for hospitalizations and deaths were lowest among residents of the most affluent borough, Manhattan, which is composed of a predominately white population. Hospitalizations- 331, deaths- 122.

    / April, 2020 - JAMA Network
    let !c self assert = Manhattan and the Bronx have the highest number of per capita hospital beds, and Manhattan has the highest population density, indicating that other factors, such as underlying comorbid illnesses, occupational exposures, socioeconomic determinants, and race-based structural inequities may explain the disparate outcomes among the boroughs

    / April, 2020 - JAMA Network
    let !d self assert = The proportion of older adults (aged ≥65 years) was lowest in the Bronx (12.8%) and highest in Manhattan (16.5%), whereas the proportion of black or African American persons was highest in the Bronx (38.3%) and lowest in Staten Island (11.5%).

    / April, 2020 - JAMA Network
    let !e self assert = There were 48 short-term acute care hospitals. The number of hospitals per borough ranged from 2 in Staten Island to 16 in Manhattan. The number of hospital beds per 100 000 population was lowest in Queens (144 beds) and highest in the Bronx (336 beds) and in Manhattan (534 beds).

    / April, 2020 - JAMA Network
    let !f self assert = Among New York City boroughs, there was variation in the number of COVID-19 tests performed per 100 000 population (4599 in the Bronx; 2970 in Brooklyn; 2844 in Manhattan; 3800 in Queens; and 5603 in Staten Island).
  ...
  ref 'Asadi_et_al_2019
    ...
    let !a self assert = Our results indicate that speech is potentially of much greater concern than breathing for two reasons: the particles on average are larger, and thus could potentially carry a larger number of pathogens, and much greater quantities of particles are emitted compared to breathing, thus increasing the odds of infecting nearby susceptible individuals.

    / February, 2019 - Scientific Reports
    let !b self assert = Although the particle emission rate increased with amplitude, the size distribution of the particles was not affected significantly, with the geometric mean particle diameter remaining near 1 μm regardless of voice amplitude. Because the particle size remains similar regardless of amplitude, the increased particle counts  indicate that the total volume of emitted respiratory fluid (i.e., the proteinaceous liquid droplets aerosolized from the serous and mucoid layers lining the respiratory tract) increases considerably with the vocalization loudness.

    / February, 2019 - Scientific Reports
    let !c self assert = Our tests of different languages yielded no significant differences, at odds with previous speculation that language spoken might have played a role in the epidemiology of SARS coronavirus transmission39, and suggesting that some as yet unknown physiological factor causes the dramatic variation among individuals.

    / February, 2019 - Scientific Reports
    let !d self assert = Likewise, we measured the temperature and humidity during the experiments, and found no significant impact of temperature or humidity on either the particle emission rate or the mean particle size

    / February, 2019 - Scientific Reports
    let !e self assert = Our direct comparison of particles emitted during various types of breathing versus speech demonstrates that even quiet speech yields significantly more particles than normal breathing. Coupled with the observation that the particles generated during speech on average are slightly larger, the results suggest that laryngeal particle generation, which presumably does not occur during normal breathing, is at least partially responsible for the observed larger rates of particle emission.

    / February, 2019 - Scientific Reports
    let !f self assert = A second key epidemiological implication of our results is that simply talking in a loud voice would increase the rate at which an infected individual releases pathogen-laden particles into the air, which in turn would increase the probability of transmission to susceptible individuals nearby. For example, an airborne infectious disease might spread more efficiently in a school cafeteria than a library, or in a noisy hospital waiting room than a quiet ward.

    / February, 2019 - Scientific Reports
    let !g self assert = A key recurring feature of the data is that some individual participants emitted many more particles than others. In other words, although half of the participants emitted fewer than 3 particles per second, a small fraction of individuals (8 out of 40) emitted considerably more. These “speech superemitters,” whose individual particle emission rate exceeded the group mean by one standard deviation or more, consistently released an order of magnitude more particles than their peers.

    / February, 2019 - Scientific Reports
    let !h self assert = The speech outliers correspond to a single participant who is a speech superemitter (F4), but this individual was not also responsible for the observed outliers of “fast-deep” and “nose” breathing activities. In other words, the “breathing high producers” are not necessarily also speech superemitters.

    / February, 2019 - Scientific Reports
    let !i self assert = Our data suggest a related hypothesis, that infected individuals could be transmitting significant numbers of respiratory pathogens via speech in the absence of overt clinical signs of illness like coughing or sneezing. More research is needed; however, the presence of asymptomatic or paucisymptomatic superspreaders would have important public health implications in the surveillance for and mitigation of infectious disease epidemics that are spread by airborne respiratory particles.

    / February, 2019 - Scientific Reports
    let !j self assert = Notably, different disease states are known to alter the physicochemical properties of the mucosal fluid lining the respiratory tract, so it is possible that infected individuals might generate markedly different quantities of particles than those emitted by the healthy individuals tested here.
  ...
  ref 'Langwig_et_al_2017
    ...
    / November, 2017 - American Society for Microbiology
    let !i self assert = Nonetheless, if selective breeding for disease resistance reduces variation in susceptibility, this will result in larger epidemics than if mean susceptibility is reduced by the same amount while preserving trait variance.
  ...
  ref 'Olsen_et_al_2003
    ...
    let !a self assert = Among the 22 patients with SARS, the date of onset of illness ranged from March 17 to March 23, a mean of four days after the flight (range, two to eight) and there were no recognized exposures to patients with SARS before or after the flight. A total of five persons died as a result of their illness (three persons from Hong Kong, one from China, and one from Singapore).

    / December, 2003 - N Engl J Med
    let !b self assert = The risk of illness was related to the proximity to the index patient, with illness reported in 8 of the 23 passegers who were seated in the same row as the patient or in the three rows in front of him, as compared with 10 of the 88 passengers who were seated elsewhere (relative risk, 3.1; 95 percent confidence interval, 1.4 to 6.9). It is notable that 56 percent of the passengers who became infected were not seated in the same row as the index patient or in the three rows in front of him.
  ...
  ref 'Hamburger_et_al_1948
   ...
   / May, 1948 - The American Journal of Medicine
   let !r self assert = A more precise understanding of the ro1e of sneezing in the transmission of different respiratory diseases may result from a study of the concentration of the infective agent in the saliva and of thefrequency of sneezing among carriers of the agent.
  ...
  ref 'Ryan_et_al_2001
    ...
    / August, 2001 - American Journal of Preventive Medicine
    let !b self assert = No change was noted in hospitalization rates for respiratory illness, which remained low during the observation period.

    / August, 2001 - American Journal of Preventive Medicine
    let !c self assert = Among respondents, 48.8% reported washing their hands at least 5 times per day, 38.9% reported washing 3 to 5 times per day, and 12.3% reported washing fewer than 3 times per day. Infrequent handwashers had more self-reported respiratory illness than frequent handwashers (4.7 episodes/recruit vs 3.2 episodes/recruit; OR 1.5, 95% CI 1.2–1.8). Infrequent handwashers were also more likely to report hospitalization for respiratory illness than frequent handwashers (OR 10.9, 95% CI 2.7– 46.2).
  ...
  ref 'Wang_et_al_2005
    ...
    / December, 2005 - Epidemiol. Infect
    let !b self assert = Patient M clinical symptoms and examination results made one attending physician suspect SARS. Further investigation revealed the contact history with SARS in the Beijing hospital. Based on his clinical symptoms and contact history, patient M was immediately listed as a suspect SARS case. At 11:30 hours on 17 April, he was transferred to Tianjin Thorax Disease Hospital. He was treated there for 2 days before being transferred again to Tianjin Infectious Disease Hospital on 19 April at around midnight, where he died. Cases occurred after exposure to patient M in both these other hospitals and have been documented elsewhere. Briefly, 164 of the total 175 SARS in this city can be traced to patient M.

    / December, 2005 - Epidemiol. Infect
    let !c self assert = Of the 1140 hospital staff and patients in this hospital at the time, 111 were diagnosed as either suspect or probable cases. The crude attack rate was 9-7%. Among all cases observed in this hospital, 33 were infected directly from patient M and 89 of all 111 SARS patients in the hospital could be traced to him.

    / December, 2005 - Epidemiol. Infect
    let !d self assert = The latent period for the secondary cases varied from 2 to 11 days with a median latent time of 4 days. The outbreak started on 16 April, peaked on 24 April and lasted until 12 May.

    / December, 2005 - Epidemiol. Infect
    let !e self assert = Of the 111 people who became infected in Hospital P, 81-1% (90/111) of them were probable cases. The SARS infection pattern in Hospital P is consistent with a person-to-person transmission pattern. Cardiology Unit I, where the index patient was first seen, had the highest number of SARS patients.
  ...
  ref 'Kline_et_al_1995
    ...
    let !a self assert = The index patient had a progressively worsening cough, and over a period of six months his weight declined from 80 to 49 kg. There was no intervention, however, even though he was eligible for health care under government programs. There was a public clinic within six blocks of the bar and a public hospital within three miles, yet he did not seek health care, nor did any of the bars employees or customers intervene.

    / July, 1995 - N Engl J Med
    let !b self assert = Instead, the patient went untreated until he could barely stand unassisted, had extensive destruction of lung tissue, and had infected numerous others. His alcoholism and mental health problems were a highly effective barrier to health care. Though it would have been difficult, early intervention would probably have reduced the extent of the outbreak.

    / July, 1995 - N Engl J Med
    let !c self assert = The index patient proved highly infectious. Forty-one of 97 contacts (42 percent) interviewed at the bar were infected. Active tuberculosis developed in 14 of 97 (14 percent). These numbers are higher than expected. In a typical contact investigation, approximately 20 to 30 percent of the close contacts have positive tuberculin skin tests and in only 1 or 2 percent does active tuberculosis develop.

    / July, 1995 - N Engl J Med
    let !d self assert = Also higher than expected was the proportion of the people we surveyed who were infected but without disease initially (i.e., they had positive tuberculin skin tests, normal chest films, and no symptoms), yet who later progressed to active disease.

    / July, 1995 - N Engl J Med
    let !e self assert = Nineteen such people were offered isoniazid prophylaxis. Six completed therapy and remained well, but 13 refused preventive therapy or were noncompliant. In 3 of these 13 (23 percent), active tuberculosis developed within two years.

    / July, 1995 - N Engl J Med
    let !f self assert = Typically, in approximately 5 percent of the people who convert to positive tuberculin skin tests, active tuberculosis develops in one year, and in an additional 5 percent it develops at some time during their lives.10 A higher rate of active disease after conversion of the tuberculin test is expected among people infected in infancy, during puberty and adolescence, and in senescence, and those infected with HIV.10,11 However, all the contacts at the bar in whom active tuberculosis developed were adults, and only one was HIV-positive.

    / July, 1995 - N Engl J Med
    let !g self assert = Our study suggests that initial infection may progress to active disease more frequently in heavy alcohol users. Another factor contributing to the high incidence of both infection and active disease at the bar may have been the high infectivity of the index patient.

    / July, 1995 - N Engl J Med
    let !h self assert = RFLP analysis proved very useful in our investigation and supplemented standard epidemiologic procedures. The same 15 repeats of the insertion sequence were found in all the isolates we tested. The genetic fingerprint of the outbreak strain helped prove linkage among the infected people, including one person with exogenous reinfection, four with upper-lobe disease that resembled endogenous reactivation, and two who were missed by the contact investigation and presented more than two years later.

    / July, 1995 - N Engl J Med
    let !i self assert = In a study of an outbreak of tuberculosis in a homeless shelter, Nardell and colleagues also identified cases of exogenous reinfection and of upper-lobe disease resembling endogenous reinfection. They used phage typing and the resistance patterns of culture isolates to link cases to the outbreak. Our findings support their conclusion that the radiographic pattern of disease may not distinguish reactivation tuberculosis from primary infection acquired during an outbreak.

    / July, 1995 - N Engl J Med
    let !j self assert = Four symptomatic participants had positive sputum cultures but negative chest films. Active pulmonary tuberculosis in patients with negative chest films, an underappreciated combination, has been reported, particularly in immunocompromised patients. In the context of a contact investigation, a negative chest film in a tuberculin-positive subject does not rule out active tuberculosis.

    / July, 1995 - N Engl J Med
    let !k self assert = The cost of failing to complete prophylactic treatment was very high. Of 13 tuberculin-positive contacts who refused isoniazid prophylaxis or did not comply with the regimen, 3 had their conditions progress to active tuberculosis within two years.

    / July, 1995 - N Engl J Med
    let !l self assert = Our experience suggests that chronic alcoholism is such a high-risk factor for progression to active disease that major efforts to ensure completion of six months of isoniazid therapy are worthwhile for tuberculin-positive heavy drinkers who are close contacts of people with active disease.
  ...
  ref 'Schwartz_et_al_2020
    ...
    / March, 2020 - Arch Pathol Lab Med
    let !b self assert = Although there were co-morbid conditions present in some of the women, some of which were obstetrical in etiology, they apparently did not result in life-threatening maternal SARS-CoV 2 disease. It is significant that these co-morbid maternal conditions, which included preeclampsia, pregnancy-induced hypertension, uterine scarring, gestational diabetes, and uterine atony, did not appear to be risk factors for intrauterine transmission of SARS-CoV-2 to the fetus.

    / March, 2020 - Arch Pathol Lab Med
    let !c self assert = Gestational age among these 22 mothers at the time of onset of COVID-19 varied between 30 and 40 weeks, and at least in this range did not appear to be associated with heightened risk for maternal-fetal viral transmission.

    / March, 2020 - Arch Pathol Lab Med
    let !d self assert = Among the 30 neonates delivered to these women who underwent testing, there were no cases of rt-PCR-confirmed SARS-CoV-2 infection, despite the existence of perinatal complications in some of the infants. An interesting observation is that in those cases where placentas were tested for SARS-CoV 2, the results were negative. This lack of maternal-fetal transmission of SARS-CoV-2 is consistent with past experiences with other coronavirus infections – SARS and MERS - occurring in pregnant women.

    / March, 2020 - Arch Pathol Lab Med
    let !e self assert = Early in the epidemic there were two cases of neonatal SARS-CoV-19 infection reported. One was an infant diagnosed at 17 days of life having a history of close contact with 2 confirmed cases of SARS-CoV-2 infection (mother and nanny), and the other was a neonate who was found to be infected 36 hours following delivery. In both infants there was no direct evidence for vertical transmission, and because viral testing was delayed, a postpartum neonatal infection acquired through an infected contact could not be eliminated.

    / March, 2020 - Arch Pathol Lab Med
    let !f self assert = At this point in the global pandemic of COVID-19 infection there is no evidence that SARSCoV-2 undergoes intrauterine or transplacental transmission from infected pregnant women to their fetuses. Analysis of additional cases is necessary to determine if this remains true.
  ...
  ref 'Sutton_et_al_2020
    ...
    / April, 2020 - Annals of the New York Academy of Sciences
    let !b self assert = Nasopharyngeal swabs were obtained from 210 of the 211 women (99.5%) who did not have symptoms of Covid-19; of these women, 29 (13.7%) were positive for SARS-CoV-2. Thus, 29 of the 33 patients who were positive for SARS-CoV-2 at admission (87.9%) had no symptoms of Covid-19 at presentation.
  ...
  ref 'Mansur_et_al_2015
    ...
    let !a self assert = Analogous to evidence demonstrated by previous cardiovascular studies that a statin treatment duration of 8 to 12 weeks is needed to achieve pleotropic effects, we believe that patients with sepsis-associated ARDS must be pretreated with statins for 8 to 12 weeks to achieve beneficial effects in this patient group.

    / June, 2015 - BMC Medicine
    let !b self assert = We found that the beneficial impact of statin therapy was accompanied by significantly lower organ-specific SOFA scores in three organ systems (the cardiovascular, central nervous, and hepatic systems) among the patients on statin therapy. The observed lower cardiovascular scores might have been due to anti-inflammatory effects of the statin therapy, which inhibited the release of inflammatory mediators and resulted in less vasodilatation in the patients in this group

    / June, 2015 - BMC Medicine
    let !c self assert = Furthermore, the patients with severe ARDS who received statin therapy had significantly more vasopressor-free days compared with those without this therapy (13 ± 7 and 9 ± 7, respectively; P = 0.0034).The severe ARDS patients on statin therapy required less ECMO therapy and had more ECMO-free days compared with those without statin therapy (18 ± 9 and 15 ± 9, respectively; P = 0.0873).
    ...
    / June, 2015 - BMC Medicine
    let !e self assert = Multivariate Cox regression analysis revealed that the absence of statin therapy was an independent prognostic indicator of 28-day mortality risk (hazard ratio, 5.46; 95 % CI, 1.38–21.70; P = 0.0156).

    / June, 2015 - BMC Medicine
    let !f self assert = Similarly, the observed lower hepatic SOFA scores can be explained by the fact that statin therapy has a beneficial effect on liver function. As shown by Arnaud et al., statins exert direct anti-inflammatory effects on hepatocytes by reducing IL-6-induced CRP production.

    / June, 2015 - BMC Medicine
    let !g self assert = The patients with statin therapy in the severe ARDS group had reduced C-reactive protein (CRP) levels compared with those without this therapy (125 ± 79 and 166 ± 85, respectively; P = 0.1400). Furthermore, the severe ARDS patients with statin therapy had lower levels of procalcitonin compared with those without therapy (3.2 ± 9.5 and 7.3 ± 15.1, respectively; P = 0.0743).

    / June, 2015 - BMC Medicine
    let !h self assert = According to our investigation, preventive statin treatment in patients with a high predisposition to sepsis or sepsis-associated ARDS may be of potential therapeutic significance and should be addressed in future studies.
  ...
  ref 'Williams_et_al_2020
    ...
    let !a self assert = Of the 622 people, 39 (6.3%) patients tested positive using standard RT-PCR tests on nasopharyngeal samples. Out of the 39 COVID-19 positive patients, SARS-CoV-2 was also detected in the saliva of 33 of them. As a control, the group also tested saliva specimens from 50 patients with PCR-negative swabs. SARS-CoV-2 was detected in 1 of the 50 samples (2%; 95% CI 0.1%-11.5%)

    / April, 2020 - Journal of Clinical Microbiology
    let !b self assert = The median cycle threshold (Ct) value was significantly lower in NPS than saliva, suggestive of higher viral loads in NPS, and in both samples, there was a correlation between Ct value and days from symptom onset.
  ...
  ref 'Zheng_et_al_2020b
    ...
    / March, 2020 - Cellular & Molecular Immunology
    let !b self assert = Different from that reported by Chen et al., we did not observe increased neutrophils or decreased lymphocytes. Instead, we found that the severe group had a significant reduction in granulocytes compared to the mild group.

    / March, 2020 - Cellular & Molecular Immunology
    let !c self assert = No statistical differences in interleukin-6 (IL-6) and tumor necrosis factor-α (TNF-α) plasma concentrations were found among the three groups. Although patients had higher sCD14 levels than healthy people, there were no significant differences between the severe and mild groups.

    / March, 2020 - Cellular & Molecular Immunology
    let !d self assert = The proportions of multiple molecules related to T cell activation and regulation increased significantly in patients compared to healthy controls, but several functional molecules showed a marked decrease.

    / March, 2020 - Cellular & Molecular Immunology
    let !e self assert = Among the differentially expressed functional molecules, the levels of interferon-γ (IFN-γ) and TNF-α in CD4+ T cells were lower in the severe group than in the mild group, whereas the levels of granzyme B and perforin in CD8+ T cells were higher in the severe group than in the mild group.

    / March, 2020 - Cellular & Molecular Immunology
    let !f self assert = The activation molecules showed no differences in CD4+ T cells, whereas the levels of HLA-DR and TIGIT in CD8+ T cells were higher in the severe group than in the mild group.

    / March, 2020 - Cellular & Molecular Immunology
    let !g self assert = Our results showed significant differences among the three subject groups in the level of exhaustion modules, including PD-1, CTLA-4, and TIGIT, and functional modules, including IFN-γ, TNF-α, and IL-2.

    / March, 2020 - Cellular & Molecular Immunology
    let !h self assert = Compared with the healthy control and mild group, the frequency of multi-functional CD4+ T cells (positive for at least two cytokines) decreased significantly in the severe group, whereas the proportion of non-functional (IFN-γ−TNF-α−IL-2−) subsets increased significantly. Thus, the functional damage of CD4+ T cells may have predisposed COVID-19 patients to severe disease

    / March, 2020 - Cellular & Molecular Immunology
    let !i self assert = In CD8+ T cells, the frequency of the non-exhausted (PD-1−CTLA-4−TIGIT−) subset in the severe group was significantly lower than that in the other two groups. Because functional blockade of PD-1, CTLA-4, and TIGIT is beneficial for CD8+ T cells to maintain lasting antigen-specific immunity and antiviral effects, the excessive exhaustion of CD8+ T cells in severe patients may reduce their cellular immune response to SARS-CoV-2.

    / March, 2020 - Cellular & Molecular Immunology
    let !j self assert = Subsequent hierarchical cluster analysis showed that these immunological factors could better distinguish healthy, mild, and severe patients, independent of age and chronic ailment. In conclusion, our study identified potential immunological risk factors for COVID-19 pneumonia and provided clues for its clinical treatment.
  ...
  ref 'Liu_et_al_2020b
    ...
    let !a self assert =  As an experimental drug, remdesivir is not expected to be largely available for treating a very large number of patients in a timely manner.

    / March, 2020 - Cell Discovery
    let !b self assert = Of two potential drugs—remdesivir and chloroquine—chloroquine appears to be the drug of choice for large-scale use due to its availability, proven safety record, and a relatively low cost.

    / March, 2020 - Cell Discovery
    let !c self assert = An overdose of cloroquine can cause acute poisoning and death.

    / March, 2020 - Cell Discovery
    let !d self assert = Hydroxychloroquine (HCQ) sulfate, a derivative of cloroquine (CQ), was first synthesized in 1946 by introducing a hydroxyl group into CQ and was demonstrated to be much less (~40%) toxic than CQ in animals4. More importantly, HCQ is still widely available to treat autoimmune diseases, such as systemic lupus erythematosus and rheumatoid arthritis.

    / March, 2020 - Cell Discovery
    let !e self assert = HCQ may be a potent candidate to treat infection by SARS-CoV-2. Whether HCQ is as efficacious as CQ in treating SARS-CoV-2 infection still lacks the experimental evidence.

    / March, 2020 - Cell Discovery
    let !f self assert = Our results show that HCQ can efficiently inhibit SARS-CoV-2 infection in vitro. In combination with its anti-inflammatory function, we predict that the drug has a good potential to combat the disease. This possibility awaits confirmation by clinical trials.
  ...
  ref 'Young_et_al_2020
    ...
    / March, 2020 - Jama Network
    let !a self assert = Among the first 18 patients diagnosed with SARS-CoV-2 infection in Singapore, clinical presentation was frequently a mild respiratory tract infection. Some patients required supplemental oxygen and had variable clinical outcomes following treatment with an antiretroviral agent.
  ...
  ref 'Cortegiani_et_al_2020
    ...
    let !a self assert = No specific pharmacological treatments are available to date for COVID-19.

    / March, 2020 - Journal of Critical Care
    let !b self assert = Chloroquine is a widely used, safe and cheap, effective in viral infections in pre-clinical studies.

    / March, 2020 - Journal of Critical Care
    let !c self assert = Specific pre-clinical evidence and expert opinions suggest potential use against SARS-CoV-2.

    / March, 2020 - Journal of Critical Care
    let !d self assert = There is sufficient pre-clinical rationale and evidence regarding the effectiveness of chloroquine for treatment of COVID-19 as well as evidence of safety from long-time use in clinical practice for other indications to justify clinical research on the topic.
  ...
  ref 'Holshue_et_al_2020
    ...
    / March, 2020 - The New England Journal of Medicine
    let !b self assert = Remdesivir was used in the first confirmed case of COVID-19 in the United States. Intravenous remdesivir (dose unknown) was initiated for compassionate use on day 7 of hospitalization based on the patient’s worsening condition. The patient’s condition improved by the following day.
  ...
  ref 'Chen_et_al_2020b
    ...
    / March, 2020 - BioRxiv
    let !a self assert = We found that SARS-CoV-2 replicates poorly in dogs, pigs, chickens, and ducks, but efficiently in ferrets and cats.
  ...
  ref 'Sun_et_al_2020
    ...
    / March, 2020 - BioRxiv
    let !a self assert = SARS-CoV-2 infects mammalian cells by binding to ACE2, a transmembrane protein.

    / March, 2020 - BioRxiv
    let !b self assert = The conservation of ACE2 and its expression pattern across mammalian species, which are yet to be comprehensively investigated, may provide valuable insights into tracing potential hosts of SARS-CoV-2.

    / March, 2020 - BioRxiv
    let !c self assert = We found high conservation of ACE2 genes among common mammals at both DNA and peptide levels, suggesting that a broad range of mammalian species can potentially be the hosts of SARS-CoV-2.

    / March, 2020 - BioRxiv
    let !d self assert = We showed that high level of ACE2 expression in certain human tissues is consistent with clinical symptoms of COVID-19 patients.

    / March, 2020 - BioRxiv
    let !e self assert = We observed that ACE2 expressed in a species-specific manner in the mammals examined. Notably, high expression in skin and eyes in cat and dog suggested that these animals may play roles in transmitting SARS-CoV-2 to humans.

    let !f self assert = It is likely that cats and dogs may have contributed to the COVID-19 pandemic. For the least, people should also be vigilant with handling of pets in the effort of containing the spread of SARS-CoV-2.
  ...
  ref 'Banerjee_et_al_2020
    ...
    let !a self assert = Many viruses that are harmful to humans do not appear to cause disease in bats. In many cases, bats are able to harbor these viruses with no observed clinical consequence.

    / January, 2020 - Viral Immunology
    let !b self assert = Understanding how bats control virus-mediated pathogenesis may enable researchers to identify novel therapeutic targets and molecules to treat infections with these viruses in other mammals, including humans and agricultural animals.

    / January, 2020 - Viral Immunology
    let !c self assert = Several adaptations have been discovered in bat cells that enable robust antiviral immune responses against RNA viruses.

    / January, 2020 - Viral Immunology
    let !d self assert = However, the immune response against DNA viruses in bats has been dampened (17, 94), most likely due to the evolution of flight in bats and the associated risk of DNA damage driving immunopathology.
  ...
  ref 'Graham_et_al_2010
    ...
    let !a self assert = Over the past 30 years, several cross-species transmission events, as well as changes in virus tropism, have mediated significant animal and human diseases.
  ...
  ref 'Zhu_et_al_2020
    ...
    let !a self assert = In December 2019, a cluster of patients with pneumonia of unknown cause was linked to a seafood wholesale market in Wuhan, China. Different from both MERS-CoV and SARS-CoV, 2019-nCoV is the seventh member of the family of coronaviruses that infect humans.

    / January, 2020 - New England Journal of Medicine
    let !b self assert = Although 2019-nCoV is similar to some betacoronaviruses detected in bats (Figure 4), it is distinct from SARS-CoV and MERS-CoV.
  ...
  ref 'Phan_et_al_2020
    ...
    let !a self assert = Our pair-wise sequence analysis demonstrated that bat SARS-like coronavirus was the closest relative to 2019-nCoV, sharing 88% nucleotide similarity. In addition, 2019-nCoV is the new member of the genus Betacoronavirus.
  ...
  ref 'Cui_et_al_2018
    ...
    let !a self assert = Coronaviruses cause respiratory and intestinal infections in animals and humans. They were not considered to be highly pathogenic to humans until the outbreak of severe acute respiratory syndrome (SARS) in 2002 and 2003 in Guangdong province, China.

    / December, 2018 -  Nature Review Microbiology
    let !b self assert = At the beginning of the 2002-2003 SARS epidemic, almost all early index patients had animal exposure before developing disease.

    / December, 2018 -  Nature Review Microbiology
    let !c self assert = Ten years after SARS, another highly pathogenic coronavirus, Middle East respiratory syndrome coronavirus (MERS-CoV) emerged in Middle Eastern countries.

    / December, 2018 -  Nature Review Microbiology
    let !d self assert = Whereas the emergence of SARS involved palm civets, most of the early MERS index cases had contact with dromedary camels.

    / December, 2018 -  Nature Review Microbiology
    let !e self assert = In 2016 and 2017, swine acute diarrhoea syndrome (SADS) was observed in four pig breeding farms in Guangdong province, with a mortality up to 90% for piglets 5 days or younger. A novel HKU2-related bat coronavirus, named SADS-CoV, was identified as the causative agent.

    / December, 2018 -  Nature Review Microbiology
    let !f self assert = Currently, no clinical treatments or prevention strategies are available for any human coronavirus.

    / December, 2018 -  Nature Review Microbiology
    let !g self assert = It is widely accepted that many viruses have existed in their natural reservoirs for a very long time. The constant spillover of viruses from natural hosts to humans and other animals is largely due to human activities, including modern agricultural practices and urbanization. Therefore, the most effective way to prevent viral zoonosis is to maintain the barriers between natural reservoirs and human society.
  ...
  ref 'Shi_et_al_2008
    ...
    / April, 2008 - Virology
    let !a self assert = Evidence so far indicated that the origin of the 2003 SARS epidemic and the 2004 mild SARS cases was from masked palm civets.

    / April, 2008 - Virology
    let !b self assert = Because of unknown mechanisms, bats appear to be natural reservoirs of several new and re-emerging viruses, such as Hendra virus, Nipah virus, Menangle virus, lyssavirus and Ebola virus, etc. over the last 20 years.
  ...
  ref 'Ruiyun_et_al_2020
    ...
    / March, 2020 - Science
    let !b self assert = Per person, the transmission rate of undocumented infections was 55% of documented infections ([46%–62%]), yet, due to their greater numbers, undocumented infections were the infection source for 79% of documented cases.

    / March, 2020 - Science
    let !c self assert = The high proportion of undocumented infections, many of whom were likely not severely symptomatic, appears to have facilitated the rapid spread of the virus throughout China.
  ...
  ref 'Anderson_et_al_2020
    ...
    / Nature Medicine - March 17, 2020
    let !b self assert = SARS-CoV-2 may have originated through natural selection in an animal host before zoonotic transfer.
  ...
  ref 'Woelfel_et_al_2020
    ...
    / medRxiv - March, 2020
    let !a self assert = COVID-19 can often present as a common cold-like illness.
    / medRxiv - March, 2020
  ...
  ref 'Zhou_et_al_2020
    head = Here we report the identification and characterization of a new coronavirus (2019-nCoV), which caused an epidemic of acute respiratory syndrome in humans in Wuhan, China.
