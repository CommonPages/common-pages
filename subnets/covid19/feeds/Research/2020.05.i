...
feed May2020
  ...
  ref 'Barile_et_al_05_22_2020
    ...
    / May, 2020 - Molecules
    let !l self assert = Systemic administration of the inhibitors in the treated group was tolerated by mice at 3 mg/kg doses, but a maximum tolerated dose of about 10–15 mg/kg was observed in separate toxicity studies, suggesting that more targeted delivery strategies may improve the observed therapeutic window. Similar to other antiviral drugs such as Zanamivir, this could be perhaps simply accomplished by devising proper inhalable formulations, which should be facilitated by the high aqueous solubility of the agents (>1 mM).
  ...
  ref 'Liu_et_al_05_14_2020
    ...
    / May, 2020 - PLOS Pathogens
    let !f self assert = Pangolin-CoV-2020 and SARS-CoV-2 also shared a very conserved receptor binding motif (RBM) (98.6%), which was more conserved than in Bat-CoV-RaTG13 (76.4%).
...
# Counter - Corticosteroid
  ...
  article 'Sethuraman_et_al_05_06_2020
    ...
    / May, 2020 - JAMA
    let !i self assert = Typically, the majority of antibodies are produced against the most abundant protein of the virus, which is the NC. Therefore, tests that detect antibodies to NC would be the most sensitive. However, the receptor-binding domain of S (RBD-S) protein is the host attachment protein, and antibodies to RBD-S would be more specific and are expected to be neutralizing. Therefore, using one or both antigens for detecting IgG and IgM would result in high sensitivity.7 Antibodies may, however, have cross-reactivity with SARS-CoV and possibly other coronaviruses.
  ...
  article 'Mehra_et_al_05_01_2020
  ...
  article 'Mueller_et_al_05_29_2020
  ...
  article 'Latinne_et_al_05_31_2020
  ...
  article 'Hamiel_et_al__05_13_2020
  ...
  article 'DelValle_et_al_05_30_2020
    ...
    / May, 2020 - MedRxiv
    let !r self assert = There are no available data correlating levels of IL-6 and response to treatment, and none of the current studies have used cytokine profiling as part of their inclusion criteria. It is possible that patients with moderate disease and high IL-6 levels will best benefit from cytokine blockade. There is also a need to evaluate the effect of anti-TNF-a therapy on its own in COVID-19. Since IL-6 and TNFa appear to be independent variables, studies with combination regimen blocking both cytokines would be important to consider for added clinical efficacy
  ...
  article 'Lee_et_al_05_28_2020
    ...
    / May, 2020 - The Lancet
    let !a self assert = 169 (21%) patients were listed as having no comorbidities apart from their cancer diagnosis. Approximately half of the patients had metastatic cancer, of which malignant neoplasia of the digestive organs, haematological malignancies, breast and respiratory and thoracic organs were the commonest primary tumour sites. The median time from identification of documented COVID-19 disease until study endpoints were met (death or discharge from hospital) was 5 days (range 0–38).

    / May, 2020 - The Lancet
    let !b self assert = In terms of the pattern of COVID-19 presentation, most patients (484 [61%]) presented with fever, cough (377 [47%]), or shortness of breath (312 [39%]). However, diarrhoea (51 [6%]), nausea and vomiting (39 [5%]), ageusia (13 [2%]), and anosmia (nine [1%]) were also identified as presenting symptoms.
  ...
  article 'Chandrashekar_et_al_05_20_2020
  ...
  article 'Stringhini_et_al_05_06_2020
  ...
  article 'Ju_et_al_05_26_2020
    ...
    / May, 2020 - Nature
    let !a self assert =  We found that P2B-2F6 failed to cross react with SARS-CoV RBD. Only four of the 12 epitope residues recognized by P2B-2F6 are conserved which likely to explain the lacking cross-reactivity to SARS-CoV by P2B-2F6. Cross-recognition between RBDs was also absent in plasma assays, further highlighting the immunological distinctions of RBDs from the three viruses.

    / May, 2020 - Nature
    let !b self assert = However, substantial plasma cross-reactivity was found against SARS-CoV and MERS-CoV trimeric Spike proteins, although this was higher with the former than the latter. This indicates that cross-reactivity likely occurs outside of RBD regions. Determining whether this cross-reactivity has protective implications requires further investigation.

    / May, 2020 - Nature
    let !c self assert = Although we failed to obtain crystal structures of two other potent neutralizing antibodies (P2C-1F11 and P2C-1A3), however, given their strong competition with P2B-2F6, it is reasonable to hypothesize that they also act through interference of the RBD and ACE2 interaction.
  ...
  article 'Smith_et_al_05_08_2020
  ...
  article 'Robbiani_et_al_05_22_2020
  ...
  article 'Domling_et_al_05_20_2020
  ...
  article 'Subbarao_et_al_05_19_2020
  ...
  article 'Puelles_et_al_05_13_2020
  ...
  article 'Skirmuntt_et_al_05_12_2020
  ...
  article 'Kimmig_et_al_05_20_2020
  ...
  article 'Dieterle_et_al_05_20_2020
  ...
  article 'Vanderheiden_et_al_05_20_2020
  ...
  article 'Breiman_et_al_05_21_2020
  ...
  article 'Hillen_et_al_05_15_2020
  ...
  article 'Kaslow_et_al_05_07_2020
  ...
  article 'Viner_et_al_05_24_2020
    ...
    / May, 2020 - medRxiv
    let !a self assert = In a post-hoc subgroup analysis we found that estimates of susceptibility were lower in studies of household contacts only compared with studies including all traced contacts. Such subgroup analyses are exploratory and this could reflect confounding by shielding of children within families.


  # Disease Severity
  // Pulmonary Vascular Endothelialitis, Thrombosis, and Angiogenesis in Covid-19
  doi: https://doi.org/10.1056/NEJMoa2015432
  article 'Ackermann_et_al_05_21_2020
  ...
  article 'Allen_et_al_05_06_2020
    ...
    / May, 2020 - Preprints
    let !a self assert = There are reports of asymptomatic transmission of SARS-CoV-2.ix By definition, asymptomatic patients are not coughing or sneezing, which means they are not frequently generating large droplets. Therefore, for these asymptomatic patients, other modes of transmission, namely fomite and airborne, must be occurring.

    / May, 2020 - Preprints
    let !b self assert =  Viruscontaining droplets that are released by breathing, talking, and coughing span a continuum of sizes, from 0.01 to hundreds of microns. It is impossible for someone to release “large droplets” (>5 microns) without also releasing smaller ones. Thus, transmission that is purported to occur via the spray of large droplets from a cough could in fact be occurring through inhalation of much smaller droplets at close range.

    / May, 2020 - Preprints
    let !c self assert = In fact, a physics-based simulation suggests that the majority of exposure at close range occurs by inhalation of small droplets rather than by contact with large droplets that land on the mouth, nose, and eyes, unless the people are closer than 30 cm or the droplets are very large.
  ...
  article 'Morawska_et_al_05_27_2020
    head = We believe that the use of engineering controls in public buildings, including hospitals, shops, offices, schools, kindergartens, libraries, restaurants, cruise ships, elevators, conference rooms or public transport, in parallel with effective application of other controls (including isolation and quarantine, social distancing and hand hygiene), would be an additional important measure globally to reduce the likelihood of transmission and thereby protect healthcare workers, patients and the general public.
    ...
    let !a self assert = Ventilation plays a critical role in removing exhaled virus-laden air, thus lowering the overall concentration and therefore any subsequent dose inhaled by the occupants.

    / May, 2020 - Environment International
    let !b self assert = HVAC (heating,  ventilating and air conditioning) system control strategies can usually be modified to increase ventilation to a certain extent in the occupied zones, with relatively little additional cost, to reduce the risks of airborne transmission between occupants.

    / May, 2020 - Environment International
    let !c self assert = The recirculation of air is a measure for saving energy, but care must be taken,  as it can transport airborne contaminants (including infectious viruses) from one space and distribute them to other spaces connected to the same system, potentially increasing the risk of airborne infection in areas that otherwise would not have been contaminated.
  ...
  article 'Mehra_et_al_05_22_2020
    ...
    / May, 2020 - The Lancet
    let !a self assert = Compared with the control group (0·3%), hydroxychloroquine (6·1%; 2·369, 1·935–2·900), hydroxychloroquine with a macrolide (8·1%; 5·106, 4·106–5·983), chloroquine (4·3%; 3·561, 2·760–4·596), and chloroquine with a macrolide (6·5%; 4·011, 3·344–4·812) were independently associated with an increased risk of de-novo ventricular arrhythmia during hospitalisation.

    / May, 2020 - The Lancet
    let !b self assert = The presence of cardiovascular comorbidity in the study population could partially explain the observed risk of increased cardiovascular toxicity with the use of chloroquine or hydroxychloroquine, especially when used in combination with macrolides.

    # Statins - ACE inhibitor
    / May, 2020 - The Lancet
    let !c self assert = In this investigation, consistent with our previous findings in a smaller cohort of 8910 patients,20 we found that women and patients being treated with ACE inhibitors (but not angiotensin receptor blockers) or statins had lower mortality with COVID-19. These findings imply that drugs that stabilise cardiovascular function and improve endothelial cell dysfunction might improve prognosis, independent of the use of cardiotoxic drug combinations.


  # Hydroxychloroquine
  // Observational Study of Hydroxychloroquine in Hospitalized Patients with Covid-19
  doi: https://doi.org/10.1056/NEJMoa2012410
  article 'Geleris_et_al_05_27_2020
  ...
  article 'Mudd_et_al_05_15_2020
    ...
    / May, 2020 - medRxiv
    let !a self assert =  The signatures of this common COVID-19 phenotype were highly elevated IL-6 and IL-8, paired with lower levels (compared to severe influenza) of cytokines in many other pathways and essentially the absence of any Type I or Type II IFN response.

    / May, 2020 - medRxiv
    let !b self assert = Single cell transcriptional profiling of COVID-19 and influenza subjects with respiratory failure identified profound suppression in type I and type II interferon signaling in COVID-19 patients across multiple clusters. In contrast, COVID-19 cell clusters were enriched for alterations in metabolic, stress, and apoptotic pathways. These alterations were consistent with an increased glucocorticoid response in COVID-19 patients compared to influenza.

    / May, 2020 - medRxiv
    let !c self assert =  When considered across the spectrum of innate and adaptive immune profiles, the immune pathologies underlying severe influenza and COVID-19 are substantially distinct. The majority of COVID-19 patients with acute respiratory failure do not have a cytokine storm phenotype but instead exhibit profound type I and type II IFN immunosuppression when compared to patients with acute influenza. Upregulation of a small number of inflammatory mediators, including IL-6, predicts acute respiratory failure in both COVID-19 and influenza patients.


  # Therapeutics - Frontiers -  monoclonal antibodies
  // A human neutralizing antibody targets the receptor binding site of SARS-CoV-2
  doi: https://doi.org/10.1038/s41586-020-2381-y
  article 'Shi_et_al_05_26_2020
  ...
  article 'Lythgoe_et_al_05_29_2020
  ...
  article 'Dohery_et_al_05_29_2020
  ...
  article 'Siedner_et_al_05_29_2020
  ...
  article 'Kantor_et_al_05_28_2020
    ...
    / May, 2020 - medRxiv
    let !a self assert = Living in a larger home was associated with a reduced risk of both anxiety and depression; this effect was seen despite the lack of any association between anxiety or depression and household income and persisted when including income and number of household members into a multivariable model.

    / May, 2020 - medRxiv
    let !b self assert =  Similarly, we found that increased time spent outdoors correlated with a reduction in depression (but not anxiety) risk, and those that spent more than an hour a day outdoors had approximately half the risk of depression as those that spent no time outdoors. This association of depression with time outdoors echoes prior research on access to green space access and its impact on mental health.

    / May, 2020 - medRxiv
    let !c self assert = Our finding that both larger living space and increased time spent outdoors correlate with a reduction in mental health burden may have actionable implications for public health initiatives and decisions regarding access to outdoor recreation areas during stay at home or shelter in place orders.

    / May, 2020 - medRxiv
    let !d self assert = Media consumption, measured by the number of hours spent watching or reading about the pandemic, was not associated with the presence of anxiety or depression. Similarly, we did not detect significant associations between likelihood of meeting criteria for anxiety or depression and household income or religiosity on adjusted multivariable analyses.


  # Epidemic - NY
  // Introductions and early spread of SARS-CoV-2 in the New York City area
  doi: https://doi.org/10.1126/science.abc1917
  article 'Reiche_et_al_05_29_2020
  ...
  article 'Rosenberg_et_al_05_08_2020
  ...
  article 'Bert_et_al_05_27_2020
    ...
    let !a self assert = We observed a differential pattern of SARS-CoV-2 specific T cell immunodominance in individuals with no history of SARS, COVID-19 or contact with SARS/COVID-19 patients (n=18). Half of them (9/18) possess T cells targeting the ORF-1 coded proteins NSP7 and 13, which were rarely detected in COVID-19- and SARS-recovered patients. Epitope characterization of NSP7-specific T cells showed recognition of protein fragments with low homology to “common cold” human coronaviruses but conserved among animal betacoranaviruses.
  ...
  article 'Zubair_et_al_05_29_2020
    ...
    let !a self assert = Patients with MS (Multiple Sclerosis) taking disease-modifying therapies that have immunosuppressive effects may be at increased risk of developing severe COVID-19 disease. The National MS Society has released recommendations for all patients with MS, in general, to continue disease-modifying therapies.

    / May, 2020 - JAMA Neurol
    let !b self assert = If a patient is at high risk of exposure to SARS-CoV-2 and due for additional immunosuppressive therapy, the MS International Federation recommends that clinicians should weigh the risks and benefits of switching the patient to interferons, glatiramer acetate, or natalizumab.

    / May, 2020 - JAMA Neurol
    let !c self assert = Many neuromuscular disorders are treated with immunosuppressive medications, which can increase the risk of developing severe COVID-19 disease. Additionally, patients with myasthenia gravis or Lambert Eaton myasthenic syndrome may have respiratory muscle weakness, which can put them at further risk for severe complications in COVID-19.

    / May, 2020 - JAMA Neurol
    let !d self assert = The International Myasthenia Gravis/COVID Working Group105 recommends continuing current treatments. For those receiving immunosuppressive therapy, the group recommends extravigilant social distancing and telemedicine visits. As discussed, hydroxychloroquine exacerbates myasthenia gravis symptoms and is contraindicated. For patients with chronic dysimmune neuropathies, the risks and benefits of in-hospital infusions should be weighed with the risk of exposure to SARS-CoV-2 and developing severe COVID-19 disease.

    / May, 2020 - JAMA Neurol
    let !e self assert = Epilepsy does not increase a patient’s risk of contracting SARS-CoV-2 or put patients at higher risk of severe disease. Nearly all antiepileptic drugs are not immunosuppressive and are safe for patients with COVID-19.

    / May, 2020 - JAMA Neurol
    let !f self assert = Viral infections and fever may trigger seizure in patients with epilepsy. Clinicians should anticipate breakthrough seizures, prescribe medications for short-term management, and provide patients with a detailed plan.


  # Origin
  // Emergence of SARS-CoV-2 through recombination and strong purifying selection
  doi: https://doi.org/10.1126/sciadv.abb9153
  article 'Li_et_al_05_19_2020
    ...
    let !a self assert = An analysis of 6,400 SARS-CoV-2 sequences from GISAID identifies only one very rare mutation, G476S that is directly in a ACE2 contact residue. It was found in a local cluster of sequences from Washington state. However, it is at the periphery of the receptor contact surface, and so may not significantly impact the virus’s receptor binding affinity.

    / May, 2020 - Science Advances
    let !b self assert = If the new SARS-CoV-2 strain did not cause widespread infections in its natural or intermediate hosts, such a strain may never be identified. The close proximity of animals of different species in a wet market setting may increase the potential for cross-species spillover infections, by enabling recombination between more distant coronaviruses and the emergence of recombinants with novel phenotypes.
  ...
  article 'Goldman-Israelow_et_al_05_27_2020
    ...
    / May, 2020 - bioRxiv
    let !b self assert = To better understand the role of type I interferon signaling we infected both IFNAR-/- and IRF3/7-/- and showed that despite similar kinetics of viral clearance, there was significant blunting of ISG response, suggesting that viral replication is resistant to interferon signaling as was previously show with SARS-CoV-1 and has been suggested in SARS-CoV-2 given its vast array of interferon antagonists.

    / May, 2020 - bioRxiv
    let !c self assert = . While endogenous type I interferon signaling seems to have little effect on SARS-CoV-2 replication, it clearly orchestrates a proinflammatory immune response and may cause immunopathology in patients.
  ...
  article 'Somsen_et_al_05_27_2020
  ...
  article 'Lai_et_al_2020b
    ...
    / May, 2020 - Nature
    let !i self assert = Secondly, the importance and effects of the three types of NPIs differed. Compared to travel restrictions, improved detection and isolation of cases as well as the social distancing likely had a greater impact on the containment of outbreak. The social distancing intervention reduced contact with people who travelled from the epicentre of the outbreak. This is likely to have been especially helpful in curbing the spread of an emerging pathogen to the wider community, and reduced the spread risk from asymptomatic or mild infections.
  ...
  article 'Peccia_et_al_2020
    ...
    / May, 2020 - Medrxiv
    let !a self assert = SARS-CoV-2 viral RNA concentrations were quantitatively compared with local hospital admission data and community COVID-19 compiled testing data. SARS-CoV-2 viral RNA was detectable in all samples tested and ranged from 1.7 x 103 virus RNA copies mL-1 to 4.6 x 105 virus RNA copies mL-1. The lower concentration in this range corresponds to a qRT-PCR cycle threshold (CT) value of 38.75 and can be considered a detection threshold for this method and sludge matrix.

    / May, 2020 - Medrxiv
    let !b self assert = Overall, 96.5% of all CT values were less than 38 and values between 38 and 40 were reported as positive if detection occurred with virus nucleocapsid N1 and N2 primer sets and both replicates.

    / May, 2020 - Medrxiv
    let !c self assert = Concentration comparisons  between replicates produced an average slope of 0.98 ± 0.17 st. dev., while replicates comparing N and RP primer values result in a flat line, with average slope of 0.05 ± 0.05 st. dev. Overall, the SARS-CoV-2 RNA concentration time series results consistently reveal a curve that increases over times, peaks, and then decreases to May 1.

    / May, 2020 - Medrxiv
    let !d self assert = New Haven COVID-19 epidemic suggest that these data may provide useful epidemiological insights (Figure 1C). SARS-CoV-2 RNA sludge concentrations were quantitatively compared with data that are commonly used to track the community progression of COVID-19 including hospital admissions and COVID-19 compiled testing data for the four municipalities (New Haven, East Haven, Hamden, and Woodbridge, CT) served by the ESWPAF. All three measures traced the initial wave of the SARS-CoV-2 outbreak in the New Haven metropolitan area.

    / May, 2020 - Medrxiv
    let !e self assert = The virus RNA time course peaked 3 days earlier than hospital admissions (April 9 versus April 12) and a cross correlation analysis revealed a correlation coefficient (R=0.996) between smoothed RNA and hospital data when the latter was shifted 3 days forward.

    / May, 2020 - Medrxiv
    let !f self assert = Comparing the LOWESS-smoothed daily virus RNA and COVID-19 testing data reveals that the peak in COVID-19 cases (April 16) occurred 7 days following the peak in SARS-CoV-2 RNA concentration (April 9). A cross correlation analysis resulted in a maximum correlation coefficient (R=0.994) when the COVID-19 testing data is adjusted 7 days forward. Regressing the adjusted COVID-19 testing data and SARS-CoV-2 virus RNA concentrations yield a value of 1,305 virus RNA copies/mL per new COVID-19 case report as the outbreak ascended, and 1,240 virus RNA copies/mL per new COVID-19 case report as the outbreak descended.

    / May, 2020 - Medrxiv
    let !g self assert = This study uniquely utilized primary sewage sludge instead of raw wastewater for virus RNA measurements. Sewage sludge is comprised of solids that are removed during primary sedimentation steps and typically gravity thickened. As a result, primary sludge has a greater solids content (2 to 5%) than raw wastewater (0.01 to 0.05%).

    / May, 2020 - Medrxiv
    let !h self assert = Due to the elevated solids content and the high case load observed during the outbreak (~1,200 per 100,000 population), the concentrations of SARS-CoV-2 RNA reported here ranged from two to three orders of magnitude greater than raw wastewater SARS-CoV-2 values previously reported

    / May, 2020 - Medrxiv
    let !i self assert = SARS-CoV-2 RNA concentrations in sewage sludge were a leading indicator of community outbreak dynamics over hospitalization and compiled COVID-19 testing data. SARS-CoV-2 RNA concentrations led hospital admissions by 3 days and COVID-19 cases by 7 days.

    / May, 2020 - Medrxiv
    let !j self assert = SARS-CoV-2 RNA concentrations led hospital admissions by 3 days and COVID-19 cases by 7 days.  Hospital admissions to Yale New Haven Hospital from the four towns served by the wastewater treatment facility both rose and fell more slowly than the observed RNA concentrations. The rates of SARS-CoV-2 RNA increases and decreases were similar to the COVID-19 testing data, and reflect the very concentrated outbreak that took place within New Haven and its neighboring towns. The strong correlation between the virus RNA and COVID-19 case data provides an approach to independently evaluate the local SARS-CoV-2 testing rate and to estimate the number of new cases.

    / May, 2020 - Medrxiv
    let !k self assert = While the results here demonstrate the potential utility of such an approach, we note that these relationships could be treatment plant specific, as primary sludge process trains are not uniform, and that compiled COVID-19 testing is prompted by symptoms, thus underestimating the true number of cases

    / May, 2020 - Medrxiv
    let !l self assert = Our study could have substantial policy implications. Jurisdictions can use primary sludge SARS-CoV-2 concentrations to preempt community outbreak dynamics or provide an additional basis for easing restrictions, especially when there are limitations in clinical testing. Raw wastewater and sludge-based surveillance is particularly useful for low and middle-income countries where clinical testing capacity is limited.


  # Remdesivir
  // Remdesivir for the Treatment of Covid-19 — Preliminary Report
  doi: https://doi.org/10.1056/NEJMoa2007764
  article 'Beigel_et_al_2020
    ...
    / May, 2020 - The New England Journal of Medicine
    let !a self assert =  Preliminary results from the 1059 patients (538 assigned to remdesivir and 521 to placebo) with data available after randomization indicated that those who received remdesivir had a median recovery time of 11 days (95% confidence interval [CI], 9 to 12), as compared with 15 days (95% CI, 13 to 19) in those who received placebo (rate ratio for recovery, 1.32; 95% CI, 1.12 to 1.55; P<0.001).

    / May, 2020 - The New England Journal of Medicine
    let !b self assert =  Mortality was numerically lower in the remdesivir group than in the placebo group, but the difference was not significant (hazard ratio for death, 0.70; 95% CI, 0.47 to 1.04; 1059 patients). The Kaplan–Meier estimates of mortality by 14 days were 7.1% and 11.9% in the remdesivir and placebo groups, respectively. The Kaplan–Meier estimates of mortality by 28 days are not reported in this preliminary analysis, given the large number of patients that had yet to complete day 29 visits. An analysis with adjustment for baseline ordinal score as a stratification variable showed a hazard ratio for death of 0.74 (95% CI, 0.50 to 1.10).

    / May, 2020 - The New England Journal of Medicine
    let !c self assert = Serious adverse events occurred in 114 patients (21.1%) in the remdesivir group and 141 patients (27.0%) in the placebo group; 4 events (2 in each group) were judged by site investigators to be related to remdesivir or placebo. There were 28 serious respiratory failure adverse events in the remdesivir group (5.2% of patients) and 42 in the placebo group (8.0% of patients). Acute respiratory failure, hypotension, viral pneumonia, and acute kidney injury were slightly more common among patients in the placebo group. No deaths were considered to be related to treatment assignment, as judged by the site investigators.

    / May, 2020 - The New England Journal of Medicine
    let !d self assert = Grade 3 or 4 adverse events occurred in 156 patients (28.8%) in the remdesivir group and in 172 in the placebo group (33.0%). The most common adverse events in the remdesivir group were anemia or decreased hemoglobin (43 events [7.9%], as compared with 47 [9.0%] in the placebo group); acute kidney injury, decreased estimated glomerular filtration rate or creatinine clearance, or increased blood creatinine (40 events [7.4%], as compared with 38 [7.3%]); pyrexia (27 events [5.0%], as compared with 17 [3.3%]); hyperglycemia or increased blood glucose level (22 events [4.1%], as compared with 17 [3.3%]); and increased aminotransferase levels including alanine aminotransferase, aspartate aminotransferase, or both (22 events [4.1%], as compared with 31 [5.9%]). Otherwise, the incidence of adverse events was not found to be significantly different between the remdesivir group and the placebo group.

    / May, 2020 - The New England Journal of Medicine
    let !e self assert =  Among patients with a baseline ordinal score of 5 (421 patients), the rate ratio for recovery was 1.47 (95% CI, 1.17 to 1.84); among patients with a baseline score of 4 (127 patients) and those with a baseline score of 6 (197 patients), the rate ratio estimates for recovery were 1.38 (95% CI, 0.94 to 2.03) and 1.20 (95% CI, 0.79 to 1.81), respectively. For those receiving mechanical ventilation or ECMO at enrollment (baseline ordinal scores of 7; 272 patients), the rate ratio for recovery was 0.95 (95% CI, 0.64 to 1.42). A test of interaction of treatment with baseline score on the ordinal scale was not significant.

    / May, 2020 - The New England Journal of Medicine
    let !f self assert = The odds of improvement in the ordinal scale score were higher in the remdesivir group, as determined by a proportional odds model at the day 15 visit, than in the placebo group (odds ratio for improvement, 1.50; 95% CI, 1.18 to 1.91; P=0.001; 844 patients)

    / May, 2020 - The New England Journal of Medicine
    let !g self assert = Our findings highlight the need to identify Covid-19 cases and start antiviral treatment before the pulmonary disease progresses to require mechanical ventilation.

    / May, 2020 - The New England Journal of Medicine
    let !h self assert = These preliminary findings support the use of remdesivir for patients who are hospitalized with Covid-19 and require supplemental oxygen therapy. However, given high mortality despite the use of remdesivir, it is clear that treatment with an antiviral drug alone is not likely to be sufficient. Future strategies should evaluate antiviral agents in combination with other therapeutic approaches or combinations of antiviral agents to continue to improve patient outcomes in Covid-19.
  ...
  article 'Riphagen_et_al_2020
    ...
    / May, 2020 - The Lancet
    let !b self assert = Most of the children had no significant respiratory involvement, although seven of the children required mechanical ventilation for cardiovascular stabilisation. Other notable features (besides persistent fever and rash) included development of small pleural, pericardial, and ascitic effusions, suggestive of a diffuse inflammatory process.

    / May, 2020 - The Lancet
    let !c self assert = All children tested negative for severe acute respiratory syndrome coronavirus 2 (SARS-CoV-2) on broncho-alveolar lavage or nasopharyngeal aspirates.

    / May, 2020 - The Lancet
    let !d self assert = Despite being critically unwell, with laboratory evidence of infection or inflammation3 including elevated concentrations of C-reactive protein, procalcitonin, ferritin, triglycerides, and D-dimers, no pathological organism was identified in seven of the children. Adenovirus and enterovirus were isolated in one child.

    / May, 2020 - The Lancet
    let !e self assert = Baseline electrocardiograms were non-specific; however, a common echocardiographic finding was echo-bright coronary vessels (appendix), which progressed to giant coronary aneurysm in one patient within a week of discharge from paediatric intensive care (appendix).

    / May, 2020 - The Lancet
    let !f self assert = One child developed arrhythmia with refractory shock, requiring extracorporeal life support, and died from a large cerebrovascular infarct. The myocardial involvement2 in this syndrome is evidenced by very elevated cardiac enzymes during the course of illness.

    / May, 2020 - The Lancet
    let !g self assert = All children were given intravenous immunoglobulin (2 g/kg) in the first 24 h, and antibiotic cover including ceftriaxone and clindamycin. Subsequently, six children have been given 50 mg/kg aspirin.
  ...
  article 'Li_et_al_2020d
    ...
    let !a self assert = Even if the virus cannot replicate in the male reproductive system, it may persist, possibly resulting from the privileged immunity of testes.

    / May, 2020 - Infectious Disease
    let !b self assert = 23 participants (60.5%) had achieved clinical recovery and 15 participants (39.5%) were at the acute stage of infection. Results of semen testing found that 6 patients (15.8%) had results positive for SARS-CoV-2, including 4 of 15 patients (26.7%) who were at the acute stage of infection and 2 of 23 patients (8.7%) who were recovering, which is particularly noteworthy.

    / May, 2020 - Infectious Disease
    let !c self assert = But there was no significant difference between negative and positive test results for patients by age, urogenital disease history, days since onset, days since hospitalization, or days since clinical recovery.
  ...
  article 'Hosier_et_al_2020
    ...
    / May, 2020 - Medrxiv
    let !a self assert = SARS-CoV-2 localized predominantly to syncytiotrophoblast cells at the maternal-fetal interface of the placenta.
