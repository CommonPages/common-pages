...
# Bats - Antiviral
  ...
  article 'Alharbi_et_al_11_19_2019
  ...
  article 'Shan-Shi_et_al_06_05_2019
    ...
    let !a self assert = Though the exact mechanistic role of ORF8b in SARS-CoV pathogenesis remains unclear, it is well established that the splitting of ORF8 corresponds with the shift from the early to the middle stage of the SARS epidemic, with the majority of affected patients being infected by virus containing the split ORF. Recent advances in mouse models have shown that SARS pathogenesis is driven by high initial virus titers resulting from a late interferon response, which drives aberrant recruitment of IMMs and activation of the innate immune response resulting in cytotoxicity. Given the likelihood that ORF8b is evolutionarily adaptive for the virus, it follows that ORF8b may contribute to SARS-CoV pathogenesis by impairing the host interferon response and/or targeting the innate immune system.

    / June, 2019 - Cell Death Discovery
    let !b self assert = In our study, ORF8b appears to be degraded by the autophagy–lysosome system, as treatment with bafilomycin A1 increases ORF8b levels. The aggregation ability of ORF8b may be protective against degradation, as we consistently observed that the anti-aggregation V77K mutant is expressed at lower levels than ORF8b.

    / June, 2019 - Cell Death Discovery
    let !c self assert = It has previously been reported that ORF8ab and ORF8b induce ER stress40, which is consistent with our findings showing accumulation of CHOP by ORF8b expression dependent on V77.

    / June, 2019 - Cell Death Discovery
    let !d self assert = We also find induction of lysosomal stress and activation of TFEB by ORF8b. Both ER stress and TFEB have been shown to propagate the inflammatory response, with TFEB directly promoting the transcription of inflammatory cytokines26,41,42. This may be a cellular mechanism by which ORF8b activates the innate immune response in macrophages and contributes to SARS-CoV pathogenesis.

    / June, 2019 - Cell Death Discovery
    let !e self assert =  Our findings indicate the SARS-CoV can activate NLRP3 inflammasome in macrophages via ORF8b. While SARS-CoV abortively infects macrophages/monocytes, enough ORF8b may be present to impact lysosome integrity, autophagy pathways, and NLRP3 inflammasomes. In contrast to macrophages, the SARS-CoV productively replicates in lung epithelial cells. These cells also express NLRP3 and can assemble NLRP3 inflammasomes.

    / June, 2019 - Cell Death Discovery
    let !f self assert = In humans infected with the SARS-CoV the full impact of ORF-8b on the pathways we delineated in this study are likely in the lung epithelium.

    / June, 2019 - Cell Death Discovery
    let !g self assert = ORF8b may contribute to the cytokine storm and inflammasome activation that occurs during severe SARS-CoV infection. Moving forward, live virus deletion studies are required to assess the effects of ORF8b mediated intracellular aggregates and ORF8b mediated NLRP3 activation.
...
# Pyroptosis Frontiers
  ...
  article 'Yan_et_al_2019
    ...
    let !a self assert = We found that a 50% compliance in donning a respiratory protective device resulted in a significant reduction in risk for fitted and unfitted N95 respirators, high‐filtration surgical masks, and both low‐filtration and high‐filtration pediatric masks. An 80% compliance rate essentially eliminated the influenza outbreak.


  # Background
  // Middle East Respiratory Syndrome Coronavirus: A Review
  link: https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6446491/
  article 'Ramadan_et_al_2019
