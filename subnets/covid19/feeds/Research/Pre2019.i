...
feed Pre2019
  ...
  article 'Weniger_et_al_1979
    ...
    let !a self assert = Minor side effecs generally consist of gastrointestinal disturbances (nausea, vomiting, abdominal pain, anorexia), dizziness, headache, and occasionally pruritus.

    / June, 1979 - World Health Organization
    let !b self assert = the acute toxic effects of chloroquine are exerted mainly on the heart.

    / June, 1979 - World Health Organization
    let !c self assert = for an average adult 1.5 g of chloroquine base is a toxic dose, and 2.0 g (30- 35 mg/kg) is a lethal dose.

    / June, 1979 - World Health Organization
    let !d self assert = if the drug is taken on an empty stomach, absorption is rapid and almost complete and severe toxic manifestations may appear within 30 minutes; but if the tablets are taken after a meal, absorption is delayed and slow, and symptoms may not appear until some two hours or more after ingestion.

    / June, 1979 - World Health Organization
    let !e self assert = chronic effects: blurred vision, seeing halos around lights,   Retinal lesions, myopathy (diseases of the muscle tissue), hearing loss (ototoxicity).
  ...
  ref 'Yang_et_al_12_30_2015
    ...
    / December, 2015 - Journal of Virology
    let !b self assert = The WIV16 genome has a 40.9% G+C content and short untranslated regions (UTRs) of 264 and 339 nt at the 5′ and 3′ termini, respectively. Its gene organization is identical to that of WIV1 and slightly different from that of the civet SARS-CoV and other bat SL-CoVs due to an additional ORF (name ORFx) detected between the ORF6 and ORF7 genes of the WIV1 and WIV16 genomes. The conserved transcriptional regulatory sequence was identified upstream of ORFx, indicating that this is likely to be a potential functional gene.

    / December, 2015 - Journal of Virology
    let !c self assert = The overall nucleotide sequence of WIV16 has 96% identity (higher than that of any previously reported bat SL-CoVs) to human and civet SARS-CoVs.

    / December, 2015 - Journal of Virology
    let !d self assert = A detailed comparison of protein sequences between SARS-CoV GZ02, a strain from an early-phase patient, and all reported bat SL-CoVs indicated that WIV16 is the closet progenitor of the SARS-CoV in most proteins, particularly in the S protein.

    / December, 2015 - Journal of Virology
    let !e self assert = All isolates of SARS-CoV and SL-CoV have high identity in both their nucleotide and their amino acid sequences in the S2 region but are highly diverse in their S1 regions.

    / December, 2015 - Journal of Virology
    let !f self assert = The WIV16 S gene has 95% sequence identity at the nucleotide level and 97% identity at the amino acid level to SARS-CoVs, much higher than those of WIV1, which has 88% identity at the nucleotide level and 90% identity at the amino acid level.

    / December, 2015 - Journal of Virology
    let !g self assert = Unlike with other bat SL-CoVs, the S1-NTD of WIV16 is very similar to that of SARS-CoV. The S1-NTD of WIV16 has an amino acid sequence identity to SARS-CoVs of 94% but of only 50% to 75% to other bat SL-CoVs.

    / December, 2015 - Journal of Virology
    let !h self assert = It is worth noting that the WIV16 RBD (amino acids [aa] 318 to 510) has 95% sequence identity to the SARS-CoV RBD but is almost identical to WIV1s. Thus, the WIV16 S gene is likely a recombinant of WIV1s gene and a recent ancestor of SARS-CoVs gene.

    / December, 2015 - Journal of Virology
    let !i self assert = High sequence conservation of the WIV16 RBD with that of SARS-CoVs predicts that WIV16 is likely also to use ACE2 as a cellular entry receptor. This was confirmed by infection of HeLa cells expressing ACE2 from human, civet, and Chinese horseshoe bat, respectively. Cell susceptibility testing using different cell lines further indicated that WIV16 has the same host range as WIV1.

    / December, 2015 - Journal of Virology
    let !j self assert = To assess whether the major sequence difference of the S1-NTD will have an effect on virus entry and/or replication, the growth kinetics of the two viruses were comparatively studied. The two viruses grew at very similar rates, with WIV16s rate being slightly lower than WIV1s rate during the 48-h period examined in this study. It is hard to conclude whether this subtle difference is significant and related to the S1-NTD sequence difference. Further investigation with more cell lines is required to confirm this preliminary observation.

    / December, 2015 - Journal of Virology
    let !k self assert = It should be noted that WIV16 is not the closest strain to the human SARS-CoVs with regard to ORF8. Full-length ORF8 is present in several SARS-CoV genomes of early-phase patients, all civet SARS-CoVs, and bat SL-CoVs. It is split into two ORFs (ORF8a and -b) in most human SARS-CoVs from late-phase patients due to a deletion event in this part of the genome.

    / December, 2015 - Journal of Virology
    let !l self assert = Our results provide further evidence that Chinese horseshoe bats are natural reservoirs of SARS-CoVs.

    / December, 2015 - Journal of Virology
    let !m self assert = Considering everything together, we predict that there are diverse SL-CoVs to be discovered in bats. Continued surveillance of this group of viruses in bats will be necessary and important not only for a better understanding of the spillover mechanism but also for more effective risk assessment and prevention of future SARS-like disease outbreaks.
  ...
  ref 'Johnson_et_al_10_08_2012
    ...
    let !a self assert = The studies demonstrate that potentially infectious aerosols may be produced in substantial quantities during flushing. Aerosolization can continue through multiple flushes to expose subsequent toilet users. Some of the aerosols desiccate to become droplet nuclei and remain adrift in the air currents. However, no studies have yet clearly demonstrated or refuted toilet plume-related disease transmission, and the significance of the risk remains largely uncharacterized.
  ...
  article 'Niwa_et_al_10_15_2018
    ...
    / October, 2018 - J Immunol
    let !b self assert = IFN-λ receptor 1 knockdown and a JAK inhibitor, ruxolitinib, attenuated polyI:C-induced IFN-λ expression, confirming that a positive autocrine feedback loop, the IFN-λ receptor–JAK–STAT pathway, was involved in IFN-λ expression.

    / October, 2018 - J Immunol
    let !c self assert = In Western blotting analysis, we demonstrated that polyI:C and IAV infection induced STAT1 phosphorylation in normal human bronchial epithelial cells, whereas IL-17A suppressed polyI:C- or IAV-mediated STAT1 phosphorylation.

    / October, 2018 - J Immunol
    let !d self assert = Furthermore, we found that cotreatment with IL-17A and polyI:C or IAV infection synergistically increased suppressor of cytokine signaling (SOCS)1 and SOCS3 expression. SOCS1 small interfering RNA and SOCS3 small interfering RNA negated the inhibitory effect of IL-17A in polyI:C-induced IFN-λ expression by restoring attenuated STAT1 phosphorylation.

    / October, 2018 - J Immunol
    let !e self assert = We found, for the first time to our knowledge, that IL-17A suppressed polyI:C- and IAV infection–induced IFN-λ expression in primary culture of NHBE cells. Analysis of intracellular signaling transduction revealed that both NF-κB and IRF3 activation were required for polyI:C-induced IFN-λ expression.

    / October, 2018 - J Immunol
    let !f self assert = In this study, we have shown that IL-17A suppressed polyI:C- and IAV infection–induced IFN-λ production in NHBE cells. IL-17A is a cytokine that induces the expression of a variety of cytokines, chemokines, and mucins in airway epithelial cells and plays a key role in the pathogenesis of asthma and COPD, including neutrophilic airway inflammation and airway remodeling (e.g., mucus metaplasia, airway fibrosis). Former studies have shown that elevated levels of IL-17A were found in patients with severe asthma and COPD, a group known to be more susceptible to viral infection than healthy subjects

    / October, 2018 - J Immunol
    let !g self assert = In addition, neutrophilic forms of asthma are associated with IL-17A, and these endotypes are generally severe and resistant to corticosteroid treatment.

    / October, 2018 - J Immunol
    let !h self assert = Given that IFN-λ plays a central role in the mucosal host defense response against viral infection, attenuation of airway IFN-λ production by IL-17A, which constitutes a novel finding in this study, may thus represent one of the causes of defective antiviral immunity in chronic airway diseases, especially in severe neutrophilic asthma.

    / October, 2018 - J Immunol
    let !i self assert = In addition, viral infection is the most common cause of acute exacerbation of asthma and COPD in clinical practice. Impairment of IFN-λ production would likely bring about a prolonged airway viral infection, which may provoke exacerbation of asthma and COPD. Thus, additional studies using animal models are required to determine whether elevated levels of IL-17A attenuate IFN-λ production and impair antiviral host defense response, resulting in exacerbation of asthma and COPD.

    / October, 2018 - J Immunol
    let !j self assert = In addition, we found that not only direct activation of NF-κB and IRF3 but also positive feedback through the IFNLR–JAK–STAT1 pathway via an autocrine mechanism were involved in polyI:C-induced IFN-λ expression. In the time-course study, induction of IFN-λ1 and IFN-λ2/3 were observed at 2–48 h after polyI:C treatment. Analysis of the signaling pathways revealed that NF-κB and IFR3 were involved in IFN-λ induction from the early stage. Conversely, the positive feedback loop of the IFNLR–JAK–STAT1 pathway was mostly related to persistent IFN-λ expression after polyI:C treatment.

    / October, 2018 - J Immunol
    let !k self assert = When IFN-λ is produced in epithelial cells, IFN-λ binds to the heterodimeric receptor, IFNLR/IL10RB, leading to activation of the JAK–STAT pathway, which induces the expression of ISGs. However, no study had been reported regarding the role of a positive autocrine/paracrine feedback loop in IFN-λ expression. The findings in this study clearly demonstrate that a positive autocrine feedback loop exists in IFN-λ expression in airway epithelial cells, which results in sustained increase of IFN-λ production and persistent antivirus immune response in airway epithelium.

    / October, 2018 - J Immunol
    let !l self assert = Considering that IL-17A did not induce IFN-λ expression and had no additive effect on polyI:C-induced IFN-λ mRNA expression, it is reasonable that IL-17A–mediated NF-κB activation is not involved in IFN-λ expression.

    / October, 2018 - J Immunol
    let !m self assert = In this study, we revealed that both SOCS1 and SOCS3 induced by cotreatment with IL-17A and polyI:C or IAV infection negatively regulated IFN-λ expression by inhibiting the JAK–STAT1 signaling pathway. As IFN-λ is critical to antiviral defense at epithelial surfaces, determining specific regulators of IFN-λ expression may thus lead to the development of new strategies for modulating epithelial antiviral host defense in the lung.
    ...
    / October, 2018 - J Immunol
    let !o self assert = Based on the findings of the current study, elevated IL-17A expression in the airway, which is sometimes observed in patients with severe asthma, may cause attenuation of airway IFN-λ production, resulting in defective antiviral immunity.
  ...
  article 'Salje_et_al_04_20_2020
    ...
    / April, 2020 - Science
    let !g self assert = We identify two clear subpopulations in those cases that are hospitalized: individuals that die quickly upon hospital admission (15% of fatal cases, mean time to death of 0.67 days) and individuals who die after longer time periods (85% of fatal cases, mean time to death of 13.2 days). The proportion of fatal cases who die rapidly remains approximately constant across age-groups. Potential explanations for different subgroups of fatal cases include heterogeneous patterns of healthcare seeking, access to care, underlying comorbidities, such as metabolic disease and other inflammatory conditions. A role for immunopathogenesis has also been proposed.

    / April, 2020 - Science
    let !h self assert = By 11 May we project 3900 (range: 2600–6300) daily infections across the country, down from between 150,000–390,000 immediately prior to the lockdown. At a regional level, we estimate that 58% of infections will be in Ile-de-France and Grand Est combined. We find that the time people spend in ICU appears to differ across the country, which may be due to differences in health care practices

    / April, 2020 - Science
    let !i self assert = These different scenarios result in mean IFRs from 0.5 to 0.9%, the proportion of the population infected by the 11 May 2020 ranging from 1.7–8.9%, the number of daily infections at this date ranging from 1700 to 9600 and a range of reproductive numbers post lockdown of 0.62–0.73
  ...
  article 'Lei_et_al_01_06_2020
    ...
    / Jan, 2008 - Indoor Air.
    let !a self assert = The dominant transmission routes vary for the 3 viruses, mainly depending on the pathogen‐specific parameters, such as the inactivation rate on human hands and environmental surfaces, the virus dose‐response rate, and the virus concentration.


  # Aersol
  // Modality of human expired aerosol size distributions
  doi: https://doi.org/10.1016/j.jaerosci.2011.07.009
  article 'Johnson_et_al_06_21_2011
  ...
  article 'Erasmus_et_al_05_28_2020
  ...
  article 'Seto_et_al_2003
    ...
    / May, 2003 - The Lancet
    let !d self assert = That use of masks and hand-washing was associated with non-infection, and that no staff became infected when they used all four measures, suggest that precautions against droplets and contact are adequate for prevention of nosocomial SARS, where no aerosolisations are expected.

    / May, 2003 - The Lancet
    let !e self assert = The surgical and N95 masks were both effective in significantly reducing the risk of infection, which together with the finding that 30% of non-infected staff did not use masks supports that transmission is not airborne.
  ...
  article 'Chondrogianni_et_al_2010
  ...
  article 'Kleinnijenhuis_et_al_2012
