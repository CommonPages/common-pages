...
Because HCl is an  *acid*, its molecules react with water, transferring H<sup>+</sup> ions to form hydronium ions (H<sub>3</sub>O<sup>+</sup>) and chloride ions (Cl<sup>−</sup>):
