index: hide
name: Reaction Mechanisms - Introduction
...
While the overall reaction equation for the decomposition of ozone indicates that two molecules of ozone react to give three molecules of oxygen, the mechanism of the reaction  *does not involve the direct collision and reaction of two ozone molecules*. Instead, one O<sub>3</sub> decomposes to yield O<sub>2</sub> and an oxygen atom, and a second O<sub>3</sub> molecule subsequently reacts with the oxygen atom to yield two additional O<sub>2</sub> molecules.
