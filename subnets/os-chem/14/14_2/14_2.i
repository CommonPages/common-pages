...
story 14_2
  >
    ...
    {'Figure_14_2_phscale Figure 14.2.phscale} shows the relationships between [H<sub>3</sub>O<sup>+</sup>], [OH<sup>−</sup>], pH, and pOH, and gives values for these properties at standard temperatures for some common substances.
    ...
    The pH of a solution may also be visually estimated using colored indicators ({'Figure_14_2_indicator Figure 14.2.indicator}).
