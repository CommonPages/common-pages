...
article '20356642
  ...
  index: hide
  line !c
    + c = Nodal failure rates in clinically uninvolved nodal stations were not increased with IFRT when compared to ENI. IFRT also resulted in significantly decreased esophageal toxicity, suggesting that IFRT may allow for integration of concurrent systemic chemotherapy in a greater proportion of patients.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Fernandes AT, Shen J, Finlay J, et al. Elective nodal irradiation (ENI) vs. involved field radiotherapy (IFRT) for locally advanced non-small cell lung cancer (NSCLC): A comparative analysis of toxicities and clinical outcomes. Radiother Oncol 2010;95:178-184.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/20356642">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1016/j.radonc.2010.02.007">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1016/j.radonc.2010.02.007">
