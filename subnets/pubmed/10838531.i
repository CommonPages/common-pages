...
article '10838531
  ...
  index: hide
  line !c
    + c = Our results provide a benchmark against which new treatment regimens can be evaluated. Control of locoregional disease remains the major challenge in treating lung cancers of the superior sulcus. The potential benefit of preoperative chemotherapy or chemoradiotherapy must be assessed by whether it leads to higher rates of complete resection and a lower risk of local relapse.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Rusch VW, Parekh KR, Leon L, et al.: Factors determining outcome after surgical resection of T3 and T4 lung cancers of the superior sulcus. J Thorac Cardiovasc Surg 119 (6): 1147-53, 2000.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/10838531">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1067/mtc.2000.106089">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1067/mtc.2000.106089">
