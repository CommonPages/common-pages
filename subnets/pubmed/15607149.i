...
article '15607149
  ...
  index: hide
  line !c
    + c = Endobronchial brachytherapy boost enhances local disease control rates in MILC treated with EBRT. Local control outcome is optimized when radical EBRT doses are used in conjunction with brachytherapy.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Mantz CA, Dosoretz DE, Rubenstein JH, et al.: Endobronchial brachytherapy and optimization of local disease control in medically inoperable non-small cell lung carcinoma: a matched-pair analysis. Brachytherapy 3 (4): 183-90, 2004.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/15607149">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1016/j.brachy.2004.09.005">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1016/j.brachy.2004.09.005">
