...
article '16769986
  ...
  index: hide
  line !c
    + c = In a population-based cohort, PORT use is associated with an increase in survival in patients with N2 nodal disease but not in patients with N1 and N0 nodal disease.
