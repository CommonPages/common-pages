...
article '19049763
  ...
  index: hide
  line !c
    + c = Salvage lung resection after definitive chemoradiation is feasible, with encouraging survival. Surgical indication is predictive, with higher survival among patients undergoing resection for abnormal FDG-PET than for obvious relapse by CT. FDG-PET should be studied prospectively in selecting patients for salvage lung resection. Systematic staging may have increased primary incorporation of surgery, minimizing the need for late salvage.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Bauman JE, Mulligan MS, Martins RG, et al. Salvage Lung Resection After Definitive Radiation (>59 Gy) for Non-Small Cell Lung Cancer: Surgical and Oncologic Outcomes. Ann Thorac Surg 2008;86:1632-1639.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/19049763">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1016/j.athoracsur.2008.07.042">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1016/j.athoracsur.2008.07.042">
