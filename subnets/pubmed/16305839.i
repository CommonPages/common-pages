...
article '16305839
  ...
  index: hide
  line !c
    + c = The presence of lymph node metastases has a disastrous impact on survival in this subset of patients. En-bloc resection is strongly suggested to be the standard of surgical care, and adjuvant radiotherapy does not seem to be necessary in N0 patients when a complete R0 resection has been achieved. For huge tumors (larger than 6 cm), this report suggests that the role of perioperative chemotherapy needs further evaluation.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Doddoli C, D'Journo B, Le Pimpec-Barthes F, et al.: Lung cancer invading the chest wall: a plea for en-bloc resection but the need for new treatment strategies. Ann Thorac Surg 80 (6): 2032-40, 2005.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/16305839">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1016/j.athoracsur.2005.03.088">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1016/j.athoracsur.2005.03.088">
