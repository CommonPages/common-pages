...
article '16162756
  ...
  index: hide
  line !c
    + c = Our results indicate that patient survival following resection for NSCLC is associated with the number of LNs evaluated during surgery. This is likely due to reduction of staging error: a decreased likelihood of missing positive LNs with an increasing number of LNs sampled. Although we are reluctant to recommend a definitive &quot;optimal number,&quot; our data support the conclusion that an evaluation of nodal status should include somewhere from 11 to 16 LNs.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Ludwig MS, Goodman M, Miller DL, et al.: Postoperative survival and the number of lymph nodes sampled during resection of node-negative non-small cell lung cancer. Chest 128 (3): 1545-50, 2005.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/16162756">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1378/chest.128.3.1545">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1378/chest.128.3.1545">
  ...
  >>> CONCLUSIONS
    Our results indicate that patient survival following resection for NSCLC is associated with the number of LNs evaluated during surgery. This is likely due to reduction of staging error: a decreased likelihood of missing positive LNs with an increasing number of LNs sampled. Although we are reluctant to recommend a definitive &quot;optimal number,&quot; our data support the conclusion that an evaluation of nodal status should include somewhere from 11 to 16 LNs.
