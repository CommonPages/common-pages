...
article '14605072
  ...
  index: hide
  line !c
    + c = Very high radiation dose treatments were tolerated in this population of medically inoperable patients with stage I NSCLC using ESR techniques.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Timmerman R, Papiez L, McGarry R, et al.: Extracranial stereotactic radioablation: results of a phase I study in medically inoperable stage I non-small cell lung cancer. Chest 124 (5): 1946-55, 2003.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/14605072">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1378/chest.124.5.1946">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1378/chest.124.5.1946">
