...
article '17409968
  ...
  index: hide
  line !c
    + c = Selection or exclusion of NSCLC patients for erlotinib therapy after failure of standard therapy for advanced or metastatic disease should not be based solely on EGFR protein expression as determined by immunohistochemistry.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Clark GM, Zborowski DM, Culbertson JL, et al.: Clinical utility of epidermal growth factor receptor expression for selecting patients with advanced non-small cell lung cancer for treatment with erlotinib. J Thorac Oncol 1 (8): 837-46, 2006.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/17409968">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=Clinical+utility+of+epidermal+growth+factor+receptor+expression+for+selecting+patients+with+advanced+non-small+cell+lung+cancer+for+treatment+with+erlotinib.">
