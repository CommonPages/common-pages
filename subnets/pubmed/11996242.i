...
article '11996242
  ...
  index: hide
  line !c
    + c = Long-term survival of patients with completely resected stage I NSCLC was adversely influenced in a relatively balanced way by factors related to the clinical status of the patient, to the tumor, and to the treatment.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Thomas P, Doddoli C, Thirion X, et al.: Stage I non-small cell lung cancer: a pragmatic approach to prognosis after complete resection. Ann Thorac Surg 73 (4): 1065-70, 2002.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/11996242">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=Stage+I+non-small+cell+lung+cancer%3A+a+pragmatic+approach+to+prognosis+after+complete+resection.">
  ...
  >>> BACKGROUND
    Long-term results of the surgical treatment of stage I non-small cell lung cancer (NSCLC) are disappointing.
