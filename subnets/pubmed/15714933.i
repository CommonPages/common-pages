...
article '15714933
  ...
  index: hide
  line !c
    + c = Although this trial met the pre-determined criteria for equivalence between the two palliative regimens, significantly more patients achieved complete resolution of symptoms and palliation of chest pain and dyspnoea with the fractionated regimen.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Erridge SC, Gaze MN, Price A, et al.: Symptom control and quality of life in people with lung cancer: a randomised trial of two palliative radiotherapy fractionation schedules. Clin Oncol (R Coll Radiol) 17 (1): 61-7, 2005.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/15714933">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=Symptom+control+and+quality+of+life+in+people+with+lung+cancer%3A+a+randomised+trial+of+two+palliative+radiotherapy+fractionation+schedules.">
