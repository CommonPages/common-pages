...
article '16288485
  ...
  index: hide
  line !c
    + c = First-line docetaxel-cisplatin chemotherapy showed similar activity in elderly and younger patients with advanced/metastatic NSCLC; elderly patients tolerated docetaxel-platinum well despite experiencing slightly more toxicity than younger patients.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Belani CP, Fossella F: Elderly subgroup analysis of a randomized phase III study of docetaxel plus platinum combinations versus vinorelbine plus cisplatin for first-line treatment of advanced nonsmall cell lung carcinoma (TAX 326). Cancer 104 (12): 2766-74, 2005.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/16288485">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1002/cncr.21495">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1002/cncr.21495">
