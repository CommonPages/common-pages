...
article '23649440
  ...
  index: hide
  line !c
    + c = Since the last iteration of the staging guidelines, PET scanning has assumed a more prominent role both in its use prior to surgery and when evaluating for metastatic disease. Minimally invasive needle techniques to stage the mediastinum have become increasingly accepted and are the tests of first choice to confirm mediastinal disease in accessible lymph node stations. If negative, these needle techniques should be followed by surgical biopsy. All abnormal scans should be confirmed by tissue biopsy (by whatever method is available) to ensure accurate staging. Evidence suggests that more complete staging improves patient outcomes.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text"> Silvestri GA, Gonzalez AV, Jantz MA, et al. Methods for staging non-small cell lung cancer: Diagnosis and management of lung cancer, 3rd ed: American College of Chest Physicians evidence-based clinical practice guidelines. Chest 2013;143:e211S-250S. </div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/23649440">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1378/chest.12-2355">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1378/chest.12-2355">
