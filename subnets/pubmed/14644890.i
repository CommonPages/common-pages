...
article '14644890
  ...
  index: hide
  line !c
    + c = Positron emission tomography with 18-fluorodeoxyglucose is more accurate than CT for mediastinal staging. Positron emission tomography with 18-fluorodeoxyglucose is more sensitive but less specific when CT shows enlarged mediastinal lymph nodes.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Gould MK, Kuschner WG, Rydzak CE, et al.: Test performance of positron emission tomography and computed tomography for mediastinal staging in patients with non-small-cell lung cancer: a meta-analysis. Ann Intern Med 139 (11): 879-92, 2003.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/14644890">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=Test+performance+of+positron+emission+tomography+and+computed+tomography+for+mediastinal+staging+in+patients+with+non-small-cell+lung+cancer%3A+a+meta-analysis.">
