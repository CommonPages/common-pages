...
article '17551145
  ...
  index: hide
  line !c
    + c = Our individual patient data meta-analysis suggests that cisplatin-based chemotherapy is slightly superior to carboplatin-based chemotherapy in terms of response rate and, in certain subgroups, in prolonging survival without being associated with an increase in severe toxic effects. Therefore, cisplatin-based third-generation regimens should remain the standard reference for the treatment of selected patients with advanced-stage NSCLC and of those with earlier-stage disease.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Ardizzoni A, Boni L, Tiseo M, et al.: Cisplatin- versus carboplatin-based chemotherapy in first-line treatment of advanced non-small-cell lung cancer: an individual patient data meta-analysis. J Natl Cancer Inst 99 (11): 847-57, 2007.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/17551145">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1093/jnci/djk196">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1093/jnci/djk196">
