...
article '16478643
  ...
  index: hide
  line !c
    + c = A platinum-based doublet induced a statically significant reduction in the risk of death when compared with non-platinum chemotherapy without inducing an unacceptable increase in toxicity.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Pujol JL, Barlesi F, Daurès JP: Should chemotherapy combinations for advanced non-small cell lung cancer be platinum-based? A meta-analysis of phase III randomized trials. Lung Cancer 51 (3): 335-45, 2006.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/16478643">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1016/j.lungcan.2005.11.001">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1016/j.lungcan.2005.11.001">
  ...
  >>> BACKGROUND
    Non-platinum regimens have been proposed as an alternative to the platinum-based combinations for treatment of advanced non-small cell lung cancer. However, conflicting results were reported.
