...
article '15020612
  ...
  index: hide
  line !c
    + c = Our data suggest that individuals in whom gefitinib is efficacious are more likely to have adenocarcinomas of the bronchioloalveolar subtype and to be never smokers. These observations may provide clues to mechanisms determining sensitivity to this agent and suggest that NSCLC has a different biology in patients who never smoked and those with bronchioloalveolar carcinoma.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Miller VA, Kris MG, Shah N, et al.: Bronchioloalveolar pathologic subtype and smoking history predict sensitivity to gefitinib in advanced non-small-cell lung cancer. J Clin Oncol 22 (6): 1103-9, 2004.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/15020612">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1200/JCO.2004.08.158">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1200/JCO.2004.08.158">
