...
article '12527573
  ...
  index: hide
  line !c
    + c = PET scanning is more accurate than CT scanning or EUS for detecting mediastinal metastases. The NPVs of the clinical evaluations for brain, abdominal, and bone metastases are &gt; or = 90%, suggesting that routinely imaging asymptomatic lung cancer patients may not be necessary. However, more definitive prospective studies that better define the patient population and improved reference standards are necessary to more accurately assess the true NPV of the clinical evaluation.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Toloza EM, Harpole L, McCrory DC: Noninvasive staging of non-small cell lung cancer: a review of the current evidence. Chest 123 (1 Suppl): 137S-146S, 2003.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/12527573">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1378/chest.123.1_suppl.137s">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1378/chest.123.1_suppl.137s">
