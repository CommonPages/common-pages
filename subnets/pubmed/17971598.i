...
article '17971598
  ...
  index: hide
  line !c
    + c = PCI is effective in preventing brain metastases following this aggressive trimodality approach. Neurocognitive late effects are not significantly different between patients treated with or without PCI.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Pöttgen C, Eberhardt W, Grannass A, et al.: Prophylactic cranial irradiation in operable stage IIIA non small-cell lung cancer treated with neoadjuvant chemoradiotherapy: results from a German multicenter randomized trial. J Clin Oncol 25 (31): 4987-92, 2007.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/17971598">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1200/JCO.2007.12.5468">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1200/JCO.2007.12.5468">
  ...
  >>> PURPOSE
    To investigate the role of prophylactic cranial irradiation (PCI) within a trimodality protocol (chemotherapy, chemoradiotherapy, surgery) for patients with operable stage IIIA non-small-cell lung cancer (NSCLC).
