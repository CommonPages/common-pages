...
article '17943820
  ...
  index: hide
  line !c
    + c = Adding a second drug improved tumor response and survival rate. Adding a third drug had a weaker effect on tumor response and no effect on survival.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Delbaldo C, Michiels S, Rolland E, et al.: Second or third additional chemotherapy drug for non-small cell lung cancer in patients with advanced disease. Cochrane Database Syst Rev  (4): CD004569, 2007.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/17943820">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1002/14651858.CD004569.pub2">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1002/14651858.CD004569.pub2">
