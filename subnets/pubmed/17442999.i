...
article '17442999
  ...
  index: hide
  line !c
    + c = Despite elderly patients' receiving less chemotherapy, adjuvant vinorelbine and cisplatin improves survival in patients older than 65 years with acceptable toxicity. Adjuvant chemotherapy should not be withheld from elderly patients.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Pepe C, Hasan B, Winton TL, et al.: Adjuvant vinorelbine and cisplatin in elderly patients: National Cancer Institute of Canada and Intergroup Study JBR.10. J Clin Oncol 25 (12): 1553-61, 2007.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/17442999">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1200/JCO.2006.09.5570">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1200/JCO.2006.09.5570">
