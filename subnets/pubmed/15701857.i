...
article '15701857
  ...
  index: hide
  line !c
    + c = Efficacy measures for both regimens seem similar to the most effective chemotherapies for advanced non-small cell lung cancer (platinum combinations) with less hematologic and nonhematologic toxicity. Comparing either of these two regimens to platinum-based therapies in a large randomized trial is warranted.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Scagliotti GV, Kortsik C, Dark GG, et al. Pemetrexed combined with oxaliplatin or carboplatin as first-line treatment in advanced non-small cell lung cancer: a multicenter, randomized, phase II trial. Clin Cancer Res 2005;11:690-696.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/15701857">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=Pemetrexed+combined+with+oxaliplatin+or+carboplatin+as+first-line+treatment+in+advanced+non-small+cell+lung+cancer%3A+a+multicenter%2C+randomized%2C+phase+II+trial.">
