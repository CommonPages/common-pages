...
article '21119545
  ...
  index: hide
  line !c
    + c = These analyses demonstrate a statistically significant interaction between treatment effect and NSCLC histology, indicating superior efficacy of pemetrexed in nonsquamous patients compared with other standard treatment options. Thus, histology is consistently predictive of the improved efficacy of pemetrexed in patients with nonsquamous NSCLC.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Scagliotti G, Brodowicz T, Shepherd FA, et al. Treatment-by-histology interaction analyses in three phase III trials show superiority of pemetrexed in nonsquamous non-small cell lung cancer. J Thorac Oncol 2011;6:64-70.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/21119545">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1097/JTO.0b013e3181f7c6d4">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1097/JTO.0b013e3181f7c6d4">
