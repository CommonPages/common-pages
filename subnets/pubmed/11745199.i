...
article '11745199
  ...
  index: hide
  line !c
    + c = Patients with advanced NSCLC and a PS of 2 experienced a large number of adverse reactions and overall poor survival. A comparison with patients with a PS of 0-1 suggests that these events and the shorter survival were related to disease process rather than treatment. Alternative strategies need to be explored with therapy specifically tailored for this group of patients.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Sweeney CJ, Zhu J, Sandler AB, et al.: Outcome of patients with a performance status of 2 in Eastern Cooperative Oncology Group Study E1594: a Phase II trial in patients with metastatic nonsmall cell lung carcinoma . Cancer 92 (10): 2639-47, 2001.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/11745199">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=Outcome+of+patients+with+a+performance+status+of+2+in+Eastern+Cooperative+Oncology+Group+Study+E1594%3A+a+Phase+II+trial+in+patients+with+metastatic+nonsmall+cell+lung+carcinoma+.">
