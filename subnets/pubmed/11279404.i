...
article '11279404
  ...
  index: hide
  line !c
    + c = En bloc resection of the chest wall and lung is the procedure of choice to obtain complete resection in lung carcinoma invading the chest wall. Survival is highly dependent on the completeness of resection, nodal involvement, and depth of chest wall invasion.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Facciolo F, Cardillo G, Lopergolo M, et al.: Chest wall invasion in non-small cell lung carcinoma: a rationale for en bloc resection. J Thorac Cardiovasc Surg 121 (4): 649-56, 2001.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/11279404">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1067/mtc.2001.112826">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1067/mtc.2001.112826">
