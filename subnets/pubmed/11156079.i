...
article '11156079
  ...
  index: hide
  line !c
    + c = Patients with N2-positive NSCLC whose nodal disease is eradicated after neoadjuvant therapy and surgery enjoy significantly improved cancer-free survival. These data support surgical resection for patients downstaged by induction therapy; however, patients who are not downstaged do not benefit from surgical resection. Direct effort should be made to improve the accuracy of restaging before resection.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Bueno R, Richards WG, Swanson SJ, et al. Nodal stage after induction therapy for stage IIIA lung cancer determines patient survival. Ann Thorac Surg 2000;70:1826- 9 1831.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/11156079">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=Nodal+stage+after+induction+therapy+for+stage+IIIA+lung+cancer+determines+patient+survival.">
