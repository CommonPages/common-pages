...
article '10218505
  ...
  index: hide
  line !c
    + c = The declines in cancer incidence and death rates, particularly for lung cancer, are encouraging. However, unless recent upward trends in smoking among adolescents can be reversed, the lung cancer rates that are currently declining in the United States may rise again.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Wingo PA, Ries LA, Giovino GA, et al.: Annual report to the nation on the status of cancer, 1973-1996, with a special section on lung cancer and tobacco smoking. J Natl Cancer Inst 91 (8): 675-90, 1999.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/10218505">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1093/jnci/91.8.675">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1093/jnci/91.8.675">
