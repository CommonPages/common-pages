...
article '8790186
  ...
  index: hide
  line !c
    + c = These results show through rigorous decision tree analysis, the potential cost-effectiveness of using FDG PET in the management of NSCLC. These results form a basis for detailed study of the results obtained from multicenter trials on the accuracy of PET in NSCLC management. Furthermore, the techniques utilized for decision tree analysis have broad range of applicability to the entire field of nuclear medicine.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Gambhir SS, Hoh CK, Phelps ME, et al.: Decision tree sensitivity analysis for cost-effectiveness of FDG-PET in the staging and management of non-small-cell lung carcinoma. J Nucl Med 37 (9): 1428-36, 1996.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/8790186">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=Decision+tree+sensitivity+analysis+for+cost-effectiveness+of+FDG-PET+in+the+staging+and+management+of+non-small-cell+lung+carcinoma.">
