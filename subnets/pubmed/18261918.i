...
article '18261918
  ...
  index: hide
  line !c
    + c = Studies investigating survival after sublobar resection of stage IA NSCLC should always distinguish between anatomical segmentectomies and wedge resections. If limited functional operability requires a sublobar resection of stage IA NSCLC, segmentectomy with systematic lymphadenectomy should be preferred.
  ...
  >>>
    ...
    <div class="CitationLink" data-href="https://doi.org/10.1016/j.ejcts.2007.12.048">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1016/j.ejcts.2007.12.048">
