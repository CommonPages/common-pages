...
article '15063229
  ...
  index: hide
  line !c
    + c = Visceral pleural involvement, nonsquamous histology, and vascular invasion are all significant adverse prognostic factors after surgical resection of T1-2N1M0 nonsmall cell cancer of the lung. These findings conflict with previously published reports, and we advocate a prospective, large-scale study in order to clarify the prognostic significance of histologic characteristics in stage II disease.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Khan OA, Fitzgerald JJ, Field ML, et al.: Histological determinants of survival in completely resected T1-2N1M0 nonsmall cell cancer of the lung. Ann Thorac Surg 77 (4): 1173-8, 2004.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/15063229">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1016/j.athoracsur.2003.08.080">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1016/j.athoracsur.2003.08.080">
