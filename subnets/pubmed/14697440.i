...
article '14697440
  ...
  index: hide
  line !c
    + c = Treatment of Stage IIIA NSCLC using either induction C/S or CRT resulted in similar outcomes in terms of local control and median overall, 5-year overall, distant metastasis-free, and disease-free survival. However, patients undergoing induction C/S often needed postoperative RT to achieve local control equivalent to that achieved with concurrent CRT. Advances in radiation-based treatment as reflected in this study have resulted in similar outcomes compared with modern induction C/S. To improve survival, however, newer systemic agents that reduce and control distant metastasis are required.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Taylor NA, Liao ZX, Cox JD, et al.: Equivalent outcome of patients with clinical Stage IIIA non-small-cell lung cancer treated with concurrent chemoradiation compared with induction chemotherapy followed by surgical resection. Int J Radiat Oncol Biol Phys 58 (1): 204-12, 2004.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/14697440">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=Equivalent+outcome+of+patients+with+clinical+Stage+IIIA+non-small-cell+lung+cancer+treated+with+concurrent+chemoradiation+compared+with+induction+chemotherapy+followed+by+surgical+resection.">
