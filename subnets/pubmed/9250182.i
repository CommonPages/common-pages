...
article '9250182
  ...
  index: hide
  line !c
    + c = CHART compared with conventional radiotherapy gave a significant improvement in survival of patients with NSCLC. Further improvement may be achieved with dose escalation in conformal radiotherapy, by the addition of cytotoxic chemotherapy, and by hypoxic cell radiosensitisation.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Saunders M, Dische S, Barrett A, et al.: Continuous hyperfractionated accelerated radiotherapy (CHART) versus conventional radiotherapy in non-small-cell lung cancer: a randomised multicentre trial. CHART Steering Committee. Lancet 350 (9072): 161-5, 1997.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/9250182">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=Continuous+hyperfractionated+accelerated+radiotherapy+%28CHART%29+versus+conventional+radiotherapy+in+non-small-cell+lung+cancer%3A+a+randomised+multicentre+trial.+CHART+Steering+Committee.">
