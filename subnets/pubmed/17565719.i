...
article '17565719
  ...
  index: hide
  line !c
    + c = PDT is effective in early primary or recurrent NSCLC, resulting in a CR rate of 72%. The incorporation of PDT in standard clinical practice, in combination with radiotherapy, warrants further investigation.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Corti L, Toniolo L, Boso C, et al.: Long-term survival of patients treated with photodynamic therapy for carcinoma in situ and early non-small-cell lung carcinoma. Lasers Surg Med 39 (5): 394-402, 2007.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/17565719">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1002/lsm.20513">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1002/lsm.20513">
