...
article '17873170
  ...
  index: hide
  line !c
    + c = AFB is a useful tool for the localization of microinvasive neoplasia. A number of endobronchial techniques available for the curative treatment can be considered first-line therapy in inoperable cases. For operable cases, the techniques may be considered and discussed with the patients.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Kennedy TC, McWilliams A, Edell E, et al.: Bronchial intraepithelial neoplasia/early central airways lung cancer: ACCP evidence-based clinical practice guidelines (2nd edition). Chest 132 (3 Suppl): 221S-233S, 2007.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/17873170">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1378/chest.07-1377">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1378/chest.07-1377">
