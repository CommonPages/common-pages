...
article '11697832
  ...
  index: hide
  line !c
    + c = Comparison of GEM with cisplatin-based therapy in symptomatic, advanced NSCLC demonstrates that GEM produces significantly a stronger and longer-lasting clinical benefit, probably due to its equal effectiveness in terms of ORR, time-to-progression or survival, combined with significantly less severe therapy-related toxicity.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Vansteenkiste JF, Vandebroek JE, Nackaerts KL, et al.: Clinical-benefit response in advanced non-small-cell lung cancer: A multicentre prospective randomised phase III study of single agent gemcitabine versus cisplatin-vindesine. Ann Oncol 12 (9): 1221-30, 2001.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/11697832">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1023/a:1012208711013">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1023/a:1012208711013">
