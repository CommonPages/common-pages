...
article '17485133
  ...
  index: hide
  line !c
    + c = Given cisplatin-based regimens had a higher overall response rate as compared with carboplatin-based regimens, there was not a survival advantage in the cisplatin group. Therefore, the toxicity profile might play an important role in decision to choose cisplatin-based or carboplatin-based regimens.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Jiang J, Liang X, Zhou X, et al.: A meta-analysis of randomized controlled trials comparing carboplatin-based to cisplatin-based chemotherapy in advanced non-small cell lung cancer. Lung Cancer 57 (3): 348-58, 2007.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/17485133">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://doi.org/10.1016/j.lungcan.2007.03.014">
    <div class="CitationLink-icon CitationLink-Doi"></div>
    <div class="CitationLink-text">DOI</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=10.1016/j.lungcan.2007.03.014">
