...
article '16640806
  ...
  index: hide
  line !c
    + c = In terms of response and survival, paclitaxel/carboplatin administered once weekly is comparable with the every-3-week schedule. Toxicity differences should be considered when choosing the appropriate schedule for the individual.

  include !c.c

  >>>
    <div class="Citation Citation--inline"><div class="Citation-body">
    <div class="Citation-text">Schuette W, Blankenburg T, Guschall W, et al.: Multicenter randomized trial for stage IIIB/IV non-small-cell lung cancer using every-3-week versus weekly paclitaxel/carboplatin. Clin Lung Cancer 7 (5): 338-43, 2006.</div>
    <div class="Citation-links">
    <div class="CitationLink" data-href="https://www.ncbi.nlm.nih.gov/pubmed/16640806">
    <div class="CitationLink-icon CitationLink-Pubmed"></div>
    <div class="CitationLink-text">PubMed</div>
    </div>
    <div class="CitationLink" data-href="https://scholar.google.com/scholar?q=Multicenter+randomized+trial+for+stage+IIIB%2FIV+non-small-cell+lung+cancer+using+every-3-week+versus+weekly+paclitaxel%2Fcarboplatin.">
