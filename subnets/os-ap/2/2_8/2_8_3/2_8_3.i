...
story 2_8_3
  >
    The  **pelvic girdle** (hip girdle) is formed by a single bone, the  **hip bone** or  **coxal bone** (coxal = “hip”), which serves as the attachment point for each lower limb. Each hip bone, in turn, is firmly joined to the axial skeleton via its attachment to the sacrum of the vertebral column. The right and left hip bones also converge anteriorly to attach to each other. The bony  **pelvis** is the entire structure formed by the two hip bones, the sacrum, and, attached inferiorly to the sacrum, the coccyx ({'Figure_8_3_1 Figure 8.3.1}).
