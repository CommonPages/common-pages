...
/// The nervous system is involved in receiving information about the environment around us (sensation) and generating responses to that information (motor responses). Sensory inputs are also integrated with memories, emotional state, or learning (cognition). The central nervous system (CNS) is the brain and spinal cord, and the peripheral nervous system (PNS) is everything else. The somatic nervous system (SNS) is responsible for conscious perception and voluntary motor responses. The autonomic nervous system (ANS) is responsible for involuntary control of the body, which regulates the internal environment. The enteric nervous system (ENS) is responsible for controlling your digestive system.
space 3
  ...
  path FullPath
    ...
    step
      --
        3.3_12.3_12_0.3_12_0_0
    / Basic Structure and Function of the Nervous System - Introduction
    step
      --
        3.3_12.3_12_1.3_12_1_0
    ...
    / The Action Potential - Introduction
    step
      --
        3.3_12.3_12_4.3_12_4_0
    ...
    step
      --
        3.3_13.3_13_0.3_13_0_0
    / The Embryologic Perspective - Introduction
    step
      --
        3.3_13.3_13_1.3_13_1_0
    / The Neural Tube
    ...
    step
      --
        3.3_14.3_14_0.3_14_0_0
    / Sensory Perception - Introduction
    step
      --
        3.3_14.3_14_1.3_14_1_0
    / Sensory Receptors
    ...
    step
      --
        3.3_15.3_15_0.3_15_0_0
    / Divisions of the Autonomic Nervous System - Introduction
    step
      --
        3.3_15.3_15_1.3_15_1_0
    ...
    step
      --
        3.3_16.3_16_0.3_16_0_0
    / Overview of the Neurological Exam - Introduction
    step
      --
        3.3_16.3_16_1.3_16_1_0
    ...
    step
      --
        3.3_17.3_17_0.3_17_0_0
    / An Overview of the Endocrine System - Introduction
    step
      --
        3.3_17.3_17_1.3_17_1_0
    ...
    / The Pituitary Gland and Hypothalamus - Introduction
    step
      --
        3.3_17.3_17_3.3_17_3_0
    / Posterior Pituitary
    ...
    / The Parathyroid Glands - Introduction
    step
      --
        3.3_17.3_17_5.3_17_5_0
    / Chapter Review
    ...
    / The Adrenal Glands - Introduction
    step
      --
        3.3_17.3_17_6.3_17_6_0
    / Adrenal Cortex
    ...
    / Development and Aging of the Endocrine System - Introduction
    step
      --
        3.3_17.3_17_11.3_17_11_0
    / Chapter Review
