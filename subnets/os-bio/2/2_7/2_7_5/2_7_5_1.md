...
Another familiar fermentation process is alcohol fermentation ( {'Figure_7_5_3 Figure 7.5.3}) that produces ethanol, an alcohol. The first chemical reaction of alcohol fermentation is the following (CO<sub>2</sub> does not participate in the second reaction):
