...
A variety of mechanisms is used to control cellular respiration. Some type of control exists at each stage of glucose metabolism. Access of glucose to the cell can be regulated using the  **GLUT proteins** that transport glucose ({'Figure_7_7_1 Figure 7.7.1}). Different forms of the GLUT protein control passage of glucose into the cells of specific tissues.
