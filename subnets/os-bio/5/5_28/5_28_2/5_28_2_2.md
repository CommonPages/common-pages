...
Class Scyphozoa includes all the jellies and is exclusively a marine class of animals with about 200 known species. The defining characteristic of this class is that the medusa is the prominent stage in the life cycle, although there is a polyp stage present. Members of this species range from 2 to 40 cm in length but the largest scyphozoan species,  *Cyanea capillata*, can reach a size of 2 m across. Scyphozoans display a characteristic bell-like morphology ({'Figure_28_2_5ab Figure 28.2.5ab}).
