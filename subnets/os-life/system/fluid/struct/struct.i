...
. struct
  ...
  /// The tunica externa is the outermost tunica (layer) of a blood vessel, surrounding the tunica media. It is mainly composed of collagen and, in arteries, is supported by external elastic lamina. The collagen serves to anchor the blood vessel to nearby organs, giving it stability.
  model TunicaExterna
  ...
  /// An artery is a blood vessel that takes blood away from the heart to all parts of the body. Most arteries carry oxygenated blood.
  model Artery
    # https://en.wikipedia.org/wiki/Artery
    >>>
      An  **artery** is a blood vessel that conducts blood away from the heart. All arteries have relatively thick walls that can withstand the high pressure of blood ejected from the heart. However, those close to the heart have the thickest walls, containing a high percentage of elastic fibers in all three of their tunics. This type of artery is known as an  **elastic artery** ({'Figure_21_1_3 Figure 21.1.3}).
    ...
    >>>
      ...
      Farther from the heart, where the surge of blood has dampened, the percentage of elastic fibers in an artery’s tunica intima decreases and the amount of smooth muscle in its tunica media increases. The artery at this point is described as a  **muscular artery**.
    ...
    /// An elastic artery is an artery with a large number of collagen and elastin filaments in the tunica media, which gives it the ability to stretch in response to each pulse. Elastic arteries include the largest arteries in the body, those closest to the heart.
    model ElasticArtery
      # https://en.wikipedia.org/wiki/Elastic_artery

    /// A muscular artery (or distributing artery) is a medium-sized artery that draws blood from an elastic artery and branches into "resistance vessels" including small arteries and arterioles. Muscular arteries contain layers of smooth muscle.
    model MuscularArtery
  ...
  /// Capillaries are the smallest blood vessels in the body. They convey blood between the arterioles and venules. These microvessels are the site of exchange of many substances with the interstitial fluid surrounding them.
  model Capillary
    ...
    model ContinuousCapillary
      # https://en.wikipedia.org/wiki/Capillary#Continuous
    ...
    /// Fenestrated capillaries have pores known as fenestrae (windows) in the endothelial cells. They are spanned by a diaphragm of radially oriented fibrils that allows small molecules and limited amounts of protein to diffuse.
    model FenestratedCapillary
      # https://en.wikipedia.org/wiki/Capillary#Fenestrated
    ...
    /// Sinusoidal capillaries or discontinuous capillaries are a special type of open-pore capillary. These blood vessels allow red and white blood cells and various serum proteins to pass, aided by a discontinuous basal lamina.
    model SinusoidCapillary
      # https://en.wikipedia.org/wiki/Capillary#Sinusoidal
  ...
  model Metarteriole
    ...
    model CapillaryBed
      # https://en.wikipedia.org/wiki/Capillary#Structure
    ...
    model PrecapillarySphincter
      # https://en.wikipedia.org/wiki/Precapillary_sphincter
    ...
    model CirculatoryAnastomosis
      # https://en.wikipedia.org/wiki/Circulatory_anastomosis

  /// A venule is a very small blood vessel in the microcirculation that allows blood to return from the capillary beds to drain into the larger blood vessels, the veins. Many venules unite to form a vein.
  model Venule
  ...
  /// Veins are blood vessels that carry blood toward the heart. Most veins carry deoxygenated blood from the tissues back to the heart.
  model Vein
  ...
  model LymphaticCapillary
    ...
    >>>
      **Lymphatic capillaries**, also called the terminal lymphatics, are vessels where interstitial fluid enters the lymphatic system to become lymph fluid. Located in almost every tissue in the body, these vessels are interlaced among the arterioles and venules of the circulatory system in the soft connective tissues of the body ({'Figure_22_1_2 Figure 22.1.2}). Exceptions are the central nervous system, bone marrow, bones, teeth, and the cornea of the eye, which do not contain lymph vessels.
      ...
      In the small intestine, lymphatic capillaries called lacteals are critical for the transport of dietary lipids and lipid-soluble vitamins to the bloodstream. In the small intestine, dietary triglycerides combine with other lipids and proteins, and enter the lacteals to form a milky fluid called {Chyle chyle}. The chyle then travels through the lymphatic system, eventually entering the bloodstream.
  ...
  model LymphaticTrunk
    # https://en.wikipedia.org/wiki/Lymph_trunk
  ...
  model LymphaticDuct
    ...
    >>>
      The overall drainage system of the body is asymmetrical.

      {image:'Figure_22_1_3}

      The  **right lymphatic duct** receives lymph from only the upper right side of the body. The lymph from the rest of the body enters the bloodstream through the  **thoracic duct** via all the remaining lymphatic trunks.
