  ...
  * Blood
    ...
    * Functions
      ...
      * Homeostasis
        ...
        >>>
          Body temperature is regulated via a classic {*negative-feedback} loop. If you were exercising on a warm day, your rising core body temperature would trigger several {*homeostatic} mechanisms, including increased transport of blood from your core to your body periphery, which is typically cooler. As blood passes through the vessels of the skin, heat would be dissipated to the environment, and the blood returning to your body core would be cooler. In contrast, on a cold day, blood is diverted away from the skin to maintain a warmer body core. In extreme cases, this may result in frostbite.
