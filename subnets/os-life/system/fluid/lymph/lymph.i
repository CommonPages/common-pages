...
* lymph
  ...
  * Structure
    >>>
      ...
      A major distinction between the {*LymphSys lymphatic} and {*CardioSys cardiovascular systems} in humans is that {Lymph lymph} is not actively pumped by the {*Heart heart}, but is forced through the vessels by the movements of the body, the contraction of skeletal muscles during body movements, and breathing. One-way valves (semi-lunar valves) in lymphatic vessels keep the lymph moving toward the heart. Lymph flows from the {LymphaticCapillary lymphatic capillaries}, through {LymphaticVessel lymphatic vessels}, and then is dumped into the {*CardioSys.Vasc circulatory system} via the {LymphaticDuct lymphatic ducts} located at the junction of the jugular and subclavian veins in the neck.
